 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const w=function(n,e){if(!n)throw tn(e)},tn=function(n){return new Error("Firebase Database ("+ac.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fd="FirebaseError";class at extends Error{constructor(e,t,s){super(t),this.code=e,this.customData=s,this.name=fd,Object.setPrototypeOf(this,at.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Wn.prototype.create)}}class Wn{constructor(e,t,s){this.service=e,this.serviceName=t,this.errors=s}create(e,...t){const s=t[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?pd(r,s):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new at(i,a,s)}}function pd(n,e){return n.replace(md,(t,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const md=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nn(n){return JSON.parse(n)}function ee(n){return JSON.stringify(n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mc=function(n){let e={},t={},s={},i="";try{const r=n.split(".");e=Nn(vs(r[0])||""),t=Nn(vs(r[1])||""),i=r[2],s=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:s,signature:i}},gd=function(n){const e=mc(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},_d=function(n){const e=mc(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wd{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Vd(t)){const s=t.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(t=>t).join(" ")}}function Vd(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Qi="@firebase/app",Do="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Es=new Map,vh=new Map,Xi=new Map;function Lo(n,e){try{n.container.addComponent(e)}catch(t){Le.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function qt(n){const e=n.name;if(Xi.has(e))return Le.debug(`There were multiple attempts to register component ${e}.`),!1;Xi.set(e,n);for(const t of Es.values())Lo(t,n);for(const t of vh.values())Lo(t,n);return!0}function Rr(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function Ke(n){return n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sn=gh;function vc(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const s=Object.assign({name:Ji,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw Xe.create("bad-app-name",{appName:String(i)});if(t||(t=hc()),!t)throw Xe.create("no-options");const r=Es.get(i);if(r){if(ws(t,r.options)&&ws(s,r.config))return r;throw Xe.create("duplicate-app",{appName:i})}const o=new Sd(i);for(const c of Xi.values())o.addComponent(c);const a=new bh(t,s,o);return Es.set(i,a),a}function yc(n=Ji){const e=Es.get(n);if(!e&&n===Ji&&hc())return vc();if(!e)throw Xe.create("no-app",{appName:n});return e}function Ze(n,e,t){var s;let i=(s=_h[n])!==null&&s!==void 0?s:n;t&&(i+=`-${t}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${e}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Le.warn(a.join(" "));return}qt(new bt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wh="firebase-heartbeat-database",Eh=1,An="firebase-heartbeat-store";let Si=null;function bc(){return Si||(Si=Ud(wh,Eh,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(An)}catch(t){console.warn(t)}}}}).catch(n=>{throw Xe.create("idb-open",{originalErrorMessage:n.message})})),Si}async function Ih(n){try{const t=(await bc()).transaction(An),s=await t.objectStore(An).get(wc(n));return await t.done,s}catch(e){if(e instanceof at)Le.warn(e.message);else{const t=Xe.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Le.warn(t.message)}}}async function $o(n,e){try{const s=(await bc()).transaction(An,"readwrite");await s.objectStore(An).put(e,wc(n)),await s.done}catch(t){if(t instanceof at)Le.warn(t.message);else{const s=Xe.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Le.warn(s.message)}}}function wc(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nh(n){qt(new bt("platform-logger",e=>new Wd(e),"PRIVATE")),qt(new bt("heartbeat",e=>new Sh(e),"PRIVATE")),Ze(Qi,Do,n),Ze(Qi,Do,"esm2017"),Ze("fire-js","")}Nh("");var Ah="firebase",Ph="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ze(Ah,Ph,"app");function Nr(n,e){var t={};for(var s in n)Object.prototype.hasOwnProperty.call(n,s)&&e.indexOf(s)<0&&(t[s]=n[s]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,s=Object.getOwnPropertySymbols(n);i<s.length;i++)e.indexOf(s[i])<0&&Object.prototype.propertyIsEnumerable.call(n,s[i])&&(t[s[i]]=n[s[i]]);return t}function Ec(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Mh=Ec,Ic=new Wn("auth","Firebase",Ec());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Is=new Sr("@firebase/auth");function Oh(n,...e){Is.logLevel<=G.WARN&&Is.warn(`Auth (${sn}): ${n}`,...e)}function as(n,...e){Is.logLevel<=G.ERROR&&Is.error(`Auth (${sn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $e(n,...e){throw Ar(n,...e)}function Ce(n,...e){return Ar(n,...e)}function kc(n,e,t){const s=Object.assign(Object.assign({},Mh()),{[e]:t});return new Wn("auth","Firebase",s).create(e,{appName:n.name})}function gt(n){return kc(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Ar(n,...e){if(typeof n!="string"){const t=e[0],s=[...e.slice(1)];return s[0]&&(s[0].appName=n.name),n._errorFactory.create(t,...s)}return Ic.create(n,...e)}function L(n,e,...t){if(!n)throw Ar(e,...t)}function Ne(n){const e="INTERNAL ASSERTION FAILED: "+n;throw as(e),new Error(e)}function Fe(n,e){n||Ne(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zi(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function xh(){return Bo()==="http:"||Bo()==="https:"}function Bo(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dh(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(xh()||cd()||"connection"in navigator)?navigator.onLine:!0}function Lh(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vn{constructor(e,t){this.shortDelay=e,this.longDelay=t,Fe(t>e,"Short delay should be less than long delay!"),this.isMobile=Cr()||pc()}get(){return Dh()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pr(n,e){Fe(n.emulator,"Emulator should always be set here");const{url:t}=n.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fh=new Vn(3e4,6e4);function Mr(n,e){return n.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:n.tenantId}):e}async function rn(n,e,t,s,i={}){return Sc(n,i,async()=>{let r={},o={};s&&(e==="GET"?o=s:r={body:JSON.stringify(s)});const a=nn(Object.assign({key:n.config.apiKey},o)).slice(1),c=await n._getAdditionalHeaders();c["Content-Type"]="application/json",n.languageCode&&(c["X-Firebase-Locale"]=n.languageCode);const l=Object.assign({method:e,headers:c},r);return ad()||(l.referrerPolicy="no-referrer"),Cc.fetch()(Tc(n,n.config.apiHost,t,a),l)})}async function Sc(n,e,t){n._canInitEmulator=!1;const s=Object.assign(Object.assign({},$h),e);try{const i=new Bh(n),r=await Promise.race([t(),i.promise]);i.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw ts(n,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[c,l]=a.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw ts(n,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw ts(n,"email-already-in-use",o);if(c==="USER_DISABLED")throw ts(n,"user-disabled",o);const d=s[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw kc(n,d,l);$e(n,d)}}catch(i){if(i instanceof at)throw i;$e(n,"network-request-failed",{message:String(i)})}}async function Uh(n,e,t,s,i={}){const r=await rn(n,e,t,s,i);return"mfaPendingCredential"in r&&$e(n,"multi-factor-auth-required",{_serverResponse:r}),r}function Tc(n,e,t,s){const i=`${e}${t}?${s}`;return n.config.emulator?Pr(n.config,i):`${n.config.apiScheme}://${i}`}class Bh{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,s)=>{this.timer=setTimeout(()=>s(Ce(this.auth,"network-request-failed")),Fh.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function ts(n,e,t){const s={appName:n.name};t.email&&(s.email=t.email),t.phoneNumber&&(s.phoneNumber=t.phoneNumber);const i=Ce(n,e,s);return i.customData._tokenResponse=t,i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hh(n,e){return rn(n,"POST","/v1/accounts:delete",e)}async function Rc(n,e){return rn(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wn(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Wh(n,e=!1){const t=oe(n),s=await t.getIdToken(e),i=Or(s);L(i&&i.exp&&i.auth_time&&i.iat,t.auth,"internal-error");const r=typeof i.firebase=="object"?i.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:i,token:s,authTime:wn(Ti(i.auth_time)),issuedAtTime:wn(Ti(i.iat)),expirationTime:wn(Ti(i.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function Ti(n){return Number(n)*1e3}function Or(n){const[e,t,s]=n.split(".");if(e===void 0||t===void 0||s===void 0)return as("JWT malformed, contained fewer than 3 sections"),null;try{const i=vs(t);return i?JSON.parse(i):(as("Failed to decode base64 JWT payload"),null)}catch(i){return as("Caught error parsing JWT payload as JSON",i==null?void 0:i.toString()),null}}function Ho(n){const e=Or(n);return L(e,"internal-error"),L(typeof e.exp<"u","internal-error"),L(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pn(n,e,t=!1){if(t)return e;try{return await e}catch(s){throw s instanceof at&&Vh(s)&&n.auth.currentUser===n&&await n.auth.signOut(),s}}function Vh({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zh(n,e){const t=await Sc(n,{},async()=>{const s=nn({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:r}=n.config,o=Tc(n,i,"/v1/token",`key=${r}`),a=await n._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",Cc.fetch()(o,{method:"POST",headers:a,body:s})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function Kh(n,e){return rn(n,"POST","/v2/accounts:revokeToken",Mr(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $t{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){L(e.idToken,"internal-error"),L(typeof e.idToken<"u","internal-error"),L(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):Ho(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){L(e.length!==0,"internal-error");const t=Ho(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(L(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:s,refreshToken:i,expiresIn:r}=await zh(e,t);this.updateTokensAndExpiration(s,i,Number(r))}updateTokensAndExpiration(e,t,s){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+s*1e3}static fromJSON(e,t){const{refreshToken:s,accessToken:i,expirationTime:r}=t,o=new $t;return s&&(L(typeof s=="string","internal-error",{appName:e}),o.refreshToken=s),i&&(L(typeof i=="string","internal-error",{appName:e}),o.accessToken=i),r&&(L(typeof r=="number","internal-error",{appName:e}),o.expirationTime=r),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new $t,this.toJSON())}_performRefresh(){return Ne("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wo=new Map;function Pe(n){Fe(n instanceof Function,"Expected a class definition");let e=Wo.get(n);return e?(Fe(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,Wo.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jo(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(xc(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Pc(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Lc(e))return"Blackberry";if($c(e))return"Webos";if(Mc(e))return"Safari";if((e.includes("chrome/")||Oc(e))&&!e.includes("edge/"))return"Chrome";if(Dc(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=n.match(t);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function Pc(n=ue()){return/firefox\//i.test(n)}function Mc(n=ue()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Oc(n=ue()){return/crios\//i.test(n)}function xc(n=ue()){return/iemobile/i.test(n)}function Dc(n=ue()){return/android/i.test(n)}function Lc(n=ue()){return/blackberry/i.test(n)}function $c(n=ue()){return/webos/i.test(n)}function xr(n=ue()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Yh(n=ue()){var e;return xr(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Qh(){return ld()&&document.documentMode===10}function Fc(n=ue()){return xr(n)||Dc(n)||$c(n)||Lc(n)||/windows phone/i.test(n)||xc(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uc(n,e=[]){let t;switch(n){case"Browser":t=jo(ue());break;case"Worker":t=`${jo(ue())}-${n}`;break;default:t=n}const s=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${sn}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xh(n,e={}){return rn(n,"GET","/v2/passwordPolicy",Mr(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jn extends Wc{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zt{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,t,s,i=!1){const r=await Ae._fromIdTokenResponse(e,s,i),o=zo(s);return new zt({user:r,providerId:o,_tokenResponse:s,operationType:t})}static async _forOperation(e,t,s){await e._updateTokensIfNecessary(s,!0);const i=zo(s);return new zt({user:e,providerId:i,_tokenResponse:s,operationType:t})}}function zo(n){return n.providerId?n.providerId:"phoneNumber"in n?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cs extends at{constructor(e,t,s,i){var r;super(t.code,t.message),this.operationType=s,this.user=i,Object.setPrototypeOf(this,Cs.prototype),this.customData={appName:e.name,tenantId:(r=e.tenantId)!==null&&r!==void 0?r:void 0,_serverResponse:t.customData._serverResponse,operationType:s}}static _fromErrorAndOperation(e,t,s,i){return new Cs(e,t,s,i)}}function Vc(n,e,t,s){return(e==="reauthenticate"?t._getReauthenticationResolver(n):t._getIdTokenResponse(n)).catch(r=>{throw r.code==="auth/multi-factor-auth-required"?Cs._fromErrorAndOperation(n,r,e,s):r})}async function ff(n,e,t=!1){const s=await Pn(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return zt._forOperation(n,"link",s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function pf(n,e,t=!1){const{auth:s}=n;if(Ke(s.app))return Promise.reject(gt(s));const i="reauthenticate";try{const r=await Pn(n,Vc(s,i,e,n),t);L(r.idToken,s,"internal-error");const o=Or(r.idToken);L(o,s,"internal-error");const{sub:a}=o;return L(n.uid===a,s,"user-mismatch"),zt._forOperation(n,i,r)}catch(r){throw(r==null?void 0:r.code)==="auth/user-not-found"&&$e(s,"user-mismatch"),r}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mf(n,e,t=!1){if(Ke(n.app))return Promise.reject(gt(n));const s="signIn",i=await Vc(n,s,e),r=await zt._fromIdTokenResponse(n,s,i);return t||await n._updateCurrentUser(r.user),r}function gf(n,e,t,s){return oe(n).onIdTokenChanged(e,t,s)}function _f(n,e,t){return oe(n).beforeAuthStateChanged(e,t)}function vf(n,e,t,s){return oe(n).onAuthStateChanged(e,t,s)}const Ss="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jc{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(Ss,"1"),this.storage.removeItem(Ss),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xf(n,e){return e?Pe(e):(L(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xc{constructor(e,t,s,i,r=!1){this.auth=e,this.resolver=s,this.user=i,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(s){this.reject(s)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:s,postBody:i,tenantId:r,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:t,sessionId:s,tenantId:r||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Df;case"linkViaPopup":case"linkViaRedirect":return $f;case"reauthViaPopup":case"reauthViaRedirect":return Lf;default:$e(this.auth,"internal-error")}}resolve(e){Fe(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Fe(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uf="pendingRedirect",ls=new Map;class Bf extends Xc{constructor(e,t,s=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,s),this.eventId=null}async execute(){let e=ls.get(this.auth._key());if(!e){try{const s=await Hf(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(s)}catch(t){e=()=>Promise.reject(t)}ls.set(this.auth._key(),e)}return this.bypassAuthState||ls.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Hf(n,e){const t=jf(e),s=Vf(n);if(!await s._isAvailable())return!1;const i=await s._get(t)==="true";return await s._remove(t),i}function Wf(n,e){ls.set(n._key(),e)}function Vf(n){return Pe(n._redirectPersistence)}function jf(n){return cs(Uf,n.config.apiKey,n.name)}async function Gf(n,e,t=!1){if(Ke(n.app))return Promise.reject(gt(n));const s=Dr(n),i=xf(s,e),o=await new Bf(s,i,t).execute();return o&&!t&&(delete o.user._redirectEventId,await s._persistUserIfCurrent(o.user),await s._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Yf(n,e={}){return rn(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ep=new Vn(3e4,6e4);function Jo(){const n=Se().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function tp(n){return new Promise((e,t)=>{var s,i,r;function o(){Jo(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Jo(),t(Ce(n,"network-request-failed"))},timeout:ep.get()})}if(!((i=(s=Se().gapi)===null||s===void 0?void 0:s.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((r=Se().gapi)===null||r===void 0)&&r.load)o();else{const a=of("iframefcb");return Se()[a]=()=>{gapi.load?o():t(Ce(n,"network-request-failed"))},sf(`${rf()}?onload=${a}`).catch(c=>t(c))}}).catch(e=>{throw us=null,e})}let us=null;function np(n){return us=us||tp(n),us}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sp=new Vn(5e3,15e3),ip="__/auth/iframe",rp="emulator/auth/iframe",op={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},ap=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function cp(n){const e=n.config;L(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?Pr(e,rp):`https://${n.config.authDomain}/${ip}`,s={apiKey:e.apiKey,appName:n.name,v:sn},i=ap.get(n.config.apiHost);i&&(s.eid=i);const r=n._getFrameworks();return r.length&&(s.fw=r.join(",")),`${t}?${nn(s).slice(1)}`}async function lp(n){const e=await np(n),t=Se().gapi;return L(t,n,"internal-error"),e.open({where:document.body,url:cp(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:op,dontclear:!0},s=>new Promise(async(i,r)=>{await s.restyle({setHideOnLeave:!1});const o=Ce(n,"network-request-failed"),a=Se().setTimeout(()=>{r(o)},sp.get());function c(){Se().clearTimeout(a),i(s)}s.ping(c).then(c,()=>{r(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _p="__/auth/handler",vp="emulator/auth/handler",yp=encodeURIComponent("fac");async function Zo(n,e,t,s,i,r){L(n.config.authDomain,n,"auth-domain-config-required"),L(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:s,v:sn,eventId:i};if(e instanceof Wc){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",ys(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[d,u]of Object.entries({}))o[d]=u}if(e instanceof jn){const d=e.getScopes().filter(u=>u!=="");d.length>0&&(o.scopes=d.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const d of Object.keys(a))a[d]===void 0&&delete a[d];const c=await n._getAppCheckToken(),l=c?`#${yp}=${encodeURIComponent(c)}`:"";return`${bp(n)}?${nn(a).slice(1)}${l}`}function bp({config:n}){return n.emulator?Pr(n,vp):`https://${n.authDomain}/${_p}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ri="webStorageSupport";class wp{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=zc,this._completeRedirectFn=Gf,this._overrideRedirectResult=Wf}async _openPopup(e,t,s,i){var r;Fe((r=this.eventManagers[e._key()])===null||r===void 0?void 0:r.manager,"_initialize() not called before _openPopup()");const o=await Zo(e,t,s,Zi(),i);return mp(e,o,$r())}async _openRedirect(e,t,s,i){await this._originValidation(e);const r=await Zo(e,t,s,Zi(),i);return kf(r),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:i,promise:r}=this.eventManagers[t];return i?Promise.resolve(i):(Fe(r,"If manager is not set, promise should be"),r)}const s=this.initAndGetManager(e);return this.eventManagers[t]={promise:s},s.catch(()=>{delete this.eventManagers[t]}),s}async initAndGetManager(e){const t=await lp(e),s=new zf(e);return t.register("authEvent",i=>(L(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:s.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=t,s}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Ri,{type:Ri},i=>{var r;const o=(r=i==null?void 0:i[0])===null||r===void 0?void 0:r[Ri];o!==void 0&&t(!!o),$e(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Xf(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Fc()||Mc()||xr()}}const Ep=wp;var ea="@firebase/auth",ta="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kp(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Cp(n){qt(new bt("auth",(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),r=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=s.options;L(o&&!o.includes(":"),"invalid-api-key",{appName:s.name});const c={apiKey:o,authDomain:a,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Uc(n)},l=new tf(s,i,r,c);return cf(l,t),l},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,s)=>{e.getProvider("auth-internal").initialize()})),qt(new bt("auth-internal",e=>{const t=Dr(e.getProvider("auth").getImmediate());return(s=>new Ip(s))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Ze(ea,ta,kp(n)),Ze(ea,ta,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tl=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Mp(e)}}catch{}return new Op},ft=tl("localStorage"),xp=tl("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jp{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const s=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let i=0;i<s.length;++i)s[i]&&on(()=>{this.onMessage_(s[i])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lm=16384,um=45e3;let Rs=null;typeof MozWebSocket<"u"?Rs=MozWebSocket:typeof WebSocket<"u"&&(Rs=WebSocket);class ye{constructor(e,t,s,i,r,o,a){this.connId=e,this.applicationId=s,this.appCheckToken=i,this.authToken=r,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=zn(this.connId),this.stats_=Hr(t),this.connURL=ye.connectionURL_(t,o,a,i,s),this.nodeAdmin=t.nodeAdmin}static connectionURL_(e,t,s,i,r){const o={};return o[ol]=Br,typeof location<"u"&&location.hostname&&ul.test(location.hostname)&&(o[cl]=ll),t&&(o[al]=t),s&&(o[dl]=s),i&&(o[sr]=i),r&&(o[hl]=r),gl(e,fl,o)}open(e,t){this.onDisconnect=t,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,ft.set("previous_websocket_failure",!0);try{let s;ud(),this.mySock=new Rs(this.connURL,[],s)}catch(s){this.log_("Error instantiating WebSocket.");const i=s.message||s.data;i&&this.log_(i),this.onClosed_();return}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=s=>{this.handleIncomingFrame(s)},this.mySock.onerror=s=>{this.log_("WebSocket error.  Closing connection.");const i=s.message||s.data;i&&this.log_(i),this.onClosed_()}}start(){}static forceDisallow(){ye.forceDisallow_=!0}static isAvailable(){let e=!1;if(typeof navigator<"u"&&navigator.userAgent){const t=/Android ([0-9]{0,}\.[0-9]{0,})/,s=navigator.userAgent.match(t);s&&s.length>1&&parseFloat(s[1])<4.4&&(e=!0)}return!e&&Rs!==null&&!ye.forceDisallow_}static previouslyFailed(){return ft.isInMemoryStorage||ft.get("previous_websocket_failure")===!0}markConnectionHealthy(){ft.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const t=this.frames.join("");this.frames=null;const s=Nn(t);this.onMessage(s)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(w(this.frames===null,"We already have a frame buffer"),e.length<=6){const t=Number(e);if(!isNaN(t))return this.handleNewFrameCount_(t),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(this.mySock===null)return;const t=e.data;if(this.bytesReceived+=t.length,this.stats_.incrementCounter("bytes_received",t.length),this.resetKeepAlive(),this.frames!==null)this.appendFrame_(t);else{const s=this.extractFrameCount_(t);s!==null&&this.appendFrame_(s)}}send(e){this.resetKeepAlive();const t=ee(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const s=il(t,lm);s.length>1&&this.sendString_(String(s.length));for(let i=0;i<s.length;i++)this.sendString_(s[i])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval(()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()},Math.floor(um))}sendString_(e){try{this.mySock.send(e)}catch(t){this.log_("Exception thrown from WebSocket.send():",t.message||t.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}}ye.responsesRequiredToBeHealthy=2;ye.healthyTimeout=3e4;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ns extends Il{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Cr()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new Ns}getInitialEvent(e){return w(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ma=32,ga=768;class j{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let s=0;for(let i=0;i<this.pieces_.length;i++)this.pieces_[i].length>0&&(this.pieces_[s]=this.pieces_[i],s++);this.pieces_.length=s,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function W(){return new j("")}function F(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function nt(n){return n.pieces_.length-n.pieceNum_}function q(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new j(n.pieces_,e)}function Vr(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function ym(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function On(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function kl(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new j(e,0)}function X(n,e){const t=[];for(let s=n.pieceNum_;s<n.pieces_.length;s++)t.push(n.pieces_[s]);if(e instanceof j)for(let s=e.pieceNum_;s<e.pieces_.length;s++)t.push(e.pieces_[s]);else{const s=e.split("/");for(let i=0;i<s.length;i++)s[i].length>0&&t.push(s[i])}return new j(t,0)}function U(n){return n.pieceNum_>=n.pieces_.length}function ae(n,e){const t=F(n),s=F(e);if(t===null)return e;if(t===s)return ae(q(n),q(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function bm(n,e){const t=On(n,0),s=On(e,0);for(let i=0;i<t.length&&i<s.length;i++){const r=St(t[i],s[i]);if(r!==0)return r}return t.length===s.length?0:t.length<s.length?-1:1}function jr(n,e){if(nt(n)!==nt(e))return!1;for(let t=n.pieceNum_,s=e.pieceNum_;t<=n.pieces_.length;t++,s++)if(n.pieces_[t]!==e.pieces_[s])return!1;return!0}function me(n,e){let t=n.pieceNum_,s=e.pieceNum_;if(nt(n)>nt(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[s])return!1;++t,++s}return!0}class wm{constructor(e,t){this.errorPrefix_=t,this.parts_=On(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let s=0;s<this.parts_.length;s++)this.byteLength_+=Zs(this.parts_[s]);Cl(this)}}function Em(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=Zs(e),Cl(n)}function Im(n){const e=n.parts_.pop();n.byteLength_-=Zs(e),n.parts_.length>0&&(n.byteLength_-=1)}function Cl(n){if(n.byteLength_>ga)throw new Error(n.errorPrefix_+"has a key path longer than "+ga+" bytes ("+n.byteLength_+").");if(n.parts_.length>ma)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+ma+") or object contains a cycle "+dt(n))}function dt(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class si{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const s=new B(Kt,e),i=new B(Kt,t);return this.compare(s,i)!==0}minPost(){return B.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ns;class Sl extends si{static get __EMPTY_NODE(){return ns}static set __EMPTY_NODE(e){ns=e}compare(e,t){return St(e.name,t.name)}isDefinedOn(e){throw tn("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return B.MIN}maxPost(){return new B(Et,ns)}makePost(e,t){return w(typeof e=="string","KeyIndex indexValue must always be a string."),new B(e,ns)}toString(){return".key"}}const Ht=new Sl;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Mi;const At={};class Me{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return w(At&&Q,"ChildrenNode.ts has not been loaded"),Mi=Mi||new Me({".priority":At},{".priority":Q}),Mi}get(e){const t=yt(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof he?t:null}hasIndex(e){return Ee(this.indexSet_,e.toString())}addIndex(e,t){w(e!==Ht,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=t.getIterator(B.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let a;i?a=As(s,e.getCompare()):a=At;const c=e.toString(),l=Object.assign({},this.indexSet_);l[c]=e;const d=Object.assign({},this.indexes_);return d[c]=a,new Me(d,l)}addToIndexes(e,t){const s=bs(this.indexes_,(i,r)=>{const o=yt(this.indexSet_,r);if(w(o,"Missing index implementation for "+r),i===At)if(o.isDefinedOn(e.node)){const a=[],c=t.getIterator(B.Wrap);let l=c.getNext();for(;l;)l.name!==e.name&&a.push(l),l=c.getNext();return a.push(e),As(a,o.getCompare())}else return At;else{const a=t.get(e.name);let c=i;return a&&(c=c.remove(new B(e.name,a))),c.insert(e,e.node)}});return new Me(s,this.indexSet_)}removeFromIndexes(e,t){const s=bs(this.indexes_,i=>{if(i===At)return i;{const r=t.get(e.name);return r?i.remove(new B(e.name,r)):i}});return new Me(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Um extends si{compare(e,t){const s=e.node.compareTo(t.node);return s===0?St(e.name,t.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return B.MIN}maxPost(){return B.MAX}makePost(e,t){const s=J(e);return new B(t,s)}toString(){return".value"}}const Bm=new Um;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pl(n){return{type:"value",snapshotNode:n}}function Yt(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function xn(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Dn(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function Hm(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zr{constructor(e){this.index_=e}updateChild(e,t,s,i,r,o){w(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(i).equals(s.getChild(i))&&a.isEmpty()===s.isEmpty()||(o!=null&&(s.isEmpty()?e.hasChild(t)?o.trackChildChange(xn(t,a)):w(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(Yt(t,s)):o.trackChildChange(Dn(t,s,a))),e.isLeafNode()&&s.isEmpty())?e:e.updateImmediateChild(t,s).withIndex(this.index_)}updateFullNode(e,t,s){return s!=null&&(e.isLeafNode()||e.forEachChild(Q,(i,r)=>{t.hasChild(i)||s.trackChildChange(xn(i,r))}),t.isLeafNode()||t.forEachChild(Q,(i,r)=>{if(e.hasChild(i)){const o=e.getImmediateChild(i);o.equals(r)||s.trackChildChange(Dn(i,r,o))}else s.trackChildChange(Yt(i,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?P.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ps extends El{constructor(e,t,s,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=s,this.appCheckTokenProvider_=i,this.log_=zn("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(w(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,s,i){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=Ps.getListenId_(e,s),a={};this.listens_[o]=a;const c=ba(e._queryParams);this.restRequest_(r+".json",c,(l,d)=>{let u=d;if(l===404&&(u=null,l=null),l===null&&this.onDataUpdate_(r,u,!1,s),yt(this.listens_,o)===a){let h;l?l===401?h="permission_denied":h="rest_error:"+l:h="ok",i(h,null)}})}unlisten(e,t){const s=Ps.getListenId_(e,t);delete this.listens_[s]}get(e){const t=ba(e._queryParams),s=e._path.toString(),i=new ve;return this.restRequest_(s+".json",t,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(s,a,!1,null),i.resolve(a)):i.reject(new Error(a))}),i.promise}refreshAuthToken(e){}restRequest_(e,t={},s){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,r])=>{i&&i.accessToken&&(t.auth=i.accessToken),r&&r.token&&(t.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+nn(t);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(s&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let c=null;if(a.status>=200&&a.status<300){try{c=Nn(a.responseText)}catch{ce("Failed to parse JSON response for "+o+": "+a.responseText)}s(null,c)}else a.status!==401&&a.status!==404&&ce("Got unsuccessful REST response for "+o+" Status: "+a.status),s(a.status);s=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ms(){return{value:null,children:new Map}}function an(n,e,t){if(U(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const s=F(e);n.children.has(s)||n.children.set(s,Ms());const i=n.children.get(s);e=q(e),an(i,e,t)}}function rr(n,e){if(U(e))return n.value=null,n.children.clear(),!0;if(n.value!==null){if(n.value.isLeafNode())return!1;{const t=n.value;return n.value=null,t.forEachChild(Q,(s,i)=>{an(n,new j(s),i)}),rr(n,e)}}else if(n.children.size>0){const t=F(e);return e=q(e),n.children.has(t)&&rr(n.children.get(t),e)&&n.children.delete(t),n.children.size===0}else return!0}function or(n,e,t){n.value!==null?t(e,n.value):Gm(n,(s,i)=>{const r=new j(e.toString()+"/"+s);or(i,r,t)})}function Gm(n,e){n.children.forEach((t,s)=>{e(s,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ea=10*1e3,zm=30*1e3,Km=5*60*1e3;class Ym{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new qm(e);const s=Ea+(zm-Ea)*Math.random();In(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;ie(e,(i,r)=>{r>0&&Ee(this.statsToReport_,i)&&(t[i]=r,s=!0)}),s&&this.server_.reportStats(t),In(this.reportStats_.bind(this),Math.floor(Math.random()*2*Km))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Os{constructor(e,t,s){this.path=e,this.affectedTree=t,this.revert=s,this.type=be.ACK_USER_WRITE,this.source=Yr()}operationForChild(e){if(U(this.path)){if(this.affectedTree.value!=null)return w(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new j(e));return new Os(W(),t,this.revert)}}else return w(F(this.path)===e,"operationForChild called for unrelated child."),new Os(q(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $n{constructor(e,t){this.source=e,this.path=t,this.type=be.LISTEN_COMPLETE}operationForChild(e){return U(this.path)?new $n(this.source,W()):new $n(this.source,q(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qt{constructor(e,t,s){this.source=e,this.path=t,this.children=s,this.type=be.MERGE}operationForChild(e){if(U(this.path)){const t=this.children.subtree(new j(e));return t.isEmpty()?null:t.value?new It(this.source,W(),t.value):new Qt(this.source,W(),t)}else return w(F(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Qt(this.source,q(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qm{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Jm(n,e,t,s){const i=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(Hm(o.childName,o.snapshotNode))}),_n(n,i,"child_removed",e,s,t),_n(n,i,"child_added",e,s,t),_n(n,i,"child_moved",r,s,t),_n(n,i,"child_changed",e,s,t),_n(n,i,"value",e,s,t),i}function _n(n,e,t,s,i,r){const o=s.filter(a=>a.type===t);o.sort((a,c)=>Zm(n,a,c)),o.forEach(a=>{const c=Xm(n,a,r);i.forEach(l=>{l.respondsTo(a.type)&&e.push(l.createEvent(c,n.query_))})})}function Xm(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function Zm(n,e,t){if(e.childName==null||t.childName==null)throw tn("Should only compare child_ events.");const s=new B(e.childName,e.snapshotNode),i=new B(t.childName,t.snapshotNode);return n.index_.compare(s,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ii(n,e){return{eventCache:n,serverCache:e}}function kn(n,e,t,s){return ii(new st(e,t,s),n.serverCache)}function Ml(n,e,t,s){return ii(n.eventCache,new st(e,t,s))}function xs(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function kt(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ri(n,e){return $l(e,n)}function tg(n,e,t,s,i){w(s>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:s,visible:i}),i&&(n.visibleWrites=Cn(n.visibleWrites,e,t)),n.lastWriteId=s}function ng(n,e,t,s){w(s>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:s,visible:!0}),n.visibleWrites=ar(n.visibleWrites,e,t),n.lastWriteId=s}function sg(n,e){for(let t=0;t<n.allWrites.length;t++){const s=n.allWrites[t];if(s.writeId===e)return s}return null}function ig(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);w(t>=0,"removeWrite called with nonexistent writeId.");const s=n.allWrites[t];n.allWrites.splice(t,1);let i=s.visible,r=!1,o=n.allWrites.length-1;for(;i&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&rg(a,s.path)?i=!1:me(s.path,a.path)&&(r=!0)),o--}if(i){if(r)return og(n),!0;if(s.snap)n.visibleWrites=Ia(n.visibleWrites,s.path);else{const a=s.children;ie(a,c=>{n.visibleWrites=Ia(n.visibleWrites,X(s.path,c))})}return!0}else return!1}function rg(n,e){if(n.snap)return me(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&me(X(n.path,t),e))return!0;return!1}function og(n){n.visibleWrites=xl(n.allWrites,ag,W()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function ag(n){return n.visible}function xl(n,e,t){let s=we.empty();for(let i=0;i<n.length;++i){const r=n[i];if(e(r)){const o=r.path;let a;if(r.snap)me(t,o)?(a=ae(t,o),s=Cn(s,a,r.snap)):me(o,t)&&(a=ae(o,t),s=Cn(s,W(),r.snap.getChild(a)));else if(r.children){if(me(t,o))a=ae(t,o),s=ar(s,a,r.children);else if(me(o,t))if(a=ae(o,t),U(a))s=ar(s,W(),r.children);else{const c=yt(r.children,F(a));if(c){const l=c.getChild(q(a));s=Cn(s,W(),l)}}}else throw tn("WriteRecord should have .snap or .children")}}return s}function Dl(n,e,t,s,i){if(!s&&!i){const r=Tt(n.visibleWrites,e);if(r!=null)return r;{const o=et(n.visibleWrites,e);if(lr(o))return t;if(t==null&&!cr(o,W()))return null;{const a=t||P.EMPTY_NODE;return Jt(o,a)}}}else{const r=et(n.visibleWrites,e);if(!i&&lr(r))return t;if(!i&&t==null&&!cr(r,W()))return null;{const o=function(l){return(l.visible||i)&&(!s||!~s.indexOf(l.writeId))&&(me(l.path,e)||me(e,l.path))},a=xl(n.allWrites,o,e),c=t||P.EMPTY_NODE;return Jt(a,c)}}}function cg(n,e,t){let s=P.EMPTY_NODE;const i=Tt(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(Q,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(t){const r=et(n.visibleWrites,e);return t.forEachChild(Q,(o,a)=>{const c=Jt(et(r,new j(o)),a);s=s.updateImmediateChild(o,c)}),ka(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=et(n.visibleWrites,e);return ka(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function lg(n,e,t,s,i){w(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=X(e,t);if(cr(n.visibleWrites,r))return null;{const o=et(n.visibleWrites,r);return lr(o)?i.getChild(t):Jt(o,i.getChild(t))}}function ug(n,e,t,s){const i=X(e,t),r=Tt(n.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(t)){const o=et(n.visibleWrites,i);return Jt(o,s.getNode().getImmediateChild(t))}else return null}function dg(n,e){return Tt(n.visibleWrites,e)}function hg(n,e,t,s,i,r,o){let a;const c=et(n.visibleWrites,e),l=Tt(c,W());if(l!=null)a=l;else if(t!=null)a=Jt(c,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const d=[],u=o.getCompare(),h=r?a.getReverseIteratorFrom(s,o):a.getIteratorFrom(s,o);let p=h.getNext();for(;p&&d.length<i;)u(p,s)!==0&&d.push(p),p=h.getNext();return d}else return[]}function fg(){return{visibleWrites:we.empty(),allWrites:[],lastWriteId:-1}}function Ds(n,e,t,s){return Dl(n.writeTree,n.treePath,e,t,s)}function Xr(n,e){return cg(n.writeTree,n.treePath,e)}function Ca(n,e,t,s){return lg(n.writeTree,n.treePath,e,t,s)}function Ls(n,e){return dg(n.writeTree,X(n.treePath,e))}function pg(n,e,t,s,i,r){return hg(n.writeTree,n.treePath,e,t,s,i,r)}function Zr(n,e,t){return ug(n.writeTree,n.treePath,e,t)}function Ll(n,e){return $l(X(n.treePath,e),n.writeTree)}function $l(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Fs;class Hl{constructor(){this.views=new Map}}function Pg(n){w(!Fs,"__referenceConstructor has already been defined"),Fs=n}function Mg(){return w(Fs,"Reference.ts has not been loaded"),Fs}function Og(n){return n.views.size===0}function to(n,e,t,s){const i=e.source.queryId;if(i!==null){const r=n.views.get(i);return w(r!=null,"SyncTree gave us an op for an invalid query."),Aa(r,e,t,s)}else{let r=[];for(const o of n.views.values())r=r.concat(Aa(o,e,t,s));return r}}function Wl(n,e,t,s,i){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let a=Ds(t,i?s:null),c=!1;a?c=!0:s instanceof P?(a=Xr(t,s),c=!1):(a=P.EMPTY_NODE,c=!1);const l=ii(new st(a,c,!1),new st(s,i,!1));return new Cg(e,l)}return o}function xg(n,e,t,s,i,r){const o=Wl(n,e,s,i,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),Ng(o,t),Ag(o,t)}function Dg(n,e,t,s){const i=e._queryIdentifier,r=[];let o=[];const a=it(n);if(i==="default")for(const[c,l]of n.views.entries())o=o.concat(Na(l,t,s)),Ra(l)&&(n.views.delete(c),l.query._queryParams.loadsAllData()||r.push(l.query));else{const c=n.views.get(i);c&&(o=o.concat(Na(c,t,s)),Ra(c)&&(n.views.delete(i),c.query._queryParams.loadsAllData()||r.push(c.query)))}return a&&!it(n)&&r.push(new(Mg())(e._repo,e._path)),{removed:r,events:o}}function Vl(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function tt(n,e){let t=null;for(const s of n.views.values())t=t||Rg(s,e);return t}function jl(n,e){if(e._queryParams.loadsAllData())return oi(n);{const s=e._queryIdentifier;return n.views.get(s)}}function Gl(n,e){return jl(n,e)!=null}function it(n){return oi(n)!=null}function oi(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Us;function Lg(n){w(!Us,"__referenceConstructor has already been defined"),Us=n}function $g(){return w(Us,"Reference.ts has not been loaded"),Us}let Fg=1;class Pa{constructor(e){this.listenProvider_=e,this.syncPointTree_=new K(null),this.pendingWriteTree_=fg(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function no(n,e,t,s,i){return tg(n.pendingWriteTree_,e,t,s,i),i?cn(n,new It(Yr(),e,t)):[]}function Ug(n,e,t,s){ng(n.pendingWriteTree_,e,t,s);const i=K.fromObject(t);return cn(n,new Qt(Yr(),e,i))}function Ye(n,e,t=!1){const s=sg(n.pendingWriteTree_,e);if(ig(n.pendingWriteTree_,e)){let r=new K(null);return s.snap!=null?r=r.set(W(),!0):ie(s.children,o=>{r=r.set(new j(o),!0)}),cn(n,new Os(s.path,r,t))}else return[]}function Yn(n,e,t){return cn(n,new It(Qr(),e,t))}function Bg(n,e,t){const s=K.fromObject(t);return cn(n,new Qt(Qr(),e,s))}function Hg(n,e){return cn(n,new $n(Qr(),e))}function Wg(n,e,t){const s=so(n,t);if(s){const i=io(s),r=i.path,o=i.queryId,a=ae(r,e),c=new $n(Jr(o),a);return ro(n,r,c)}else return[]}function Bs(n,e,t,s,i=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||Gl(o,e))){const c=Dg(o,e,t,s);Og(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const l=c.removed;if(a=c.events,!i){const d=l.findIndex(h=>h._queryParams.loadsAllData())!==-1,u=n.syncPointTree_.findOnPath(r,(h,p)=>it(p));if(d&&!u){const h=n.syncPointTree_.subtree(r);if(!h.isEmpty()){const p=Gg(h);for(let m=0;m<p.length;++m){const v=p[m],I=v.query,E=Yl(n,v);n.listenProvider_.startListening(Sn(I),Fn(n,I),E.hashFn,E.onComplete)}}}!u&&l.length>0&&!s&&(d?n.listenProvider_.stopListening(Sn(e),null):l.forEach(h=>{const p=n.queryToTagMap.get(ci(h));n.listenProvider_.stopListening(Sn(h),p)}))}qg(n,l)}return a}function ql(n,e,t,s){const i=so(n,s);if(i!=null){const r=io(i),o=r.path,a=r.queryId,c=ae(o,e),l=new It(Jr(a),c,t);return ro(n,o,l)}else return[]}function Vg(n,e,t,s){const i=so(n,s);if(i){const r=io(i),o=r.path,a=r.queryId,c=ae(o,e),l=K.fromObject(t),d=new Qt(Jr(a),c,l);return ro(n,o,d)}else return[]}function hr(n,e,t,s=!1){const i=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(i,(h,p)=>{const m=ae(h,i);r=r||tt(p,m),o=o||it(p)});let a=n.syncPointTree_.get(i);a?(o=o||it(a),r=r||tt(a,W())):(a=new Hl,n.syncPointTree_=n.syncPointTree_.set(i,a));let c;r!=null?c=!0:(c=!1,r=P.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((p,m)=>{const v=tt(m,W());v&&(r=r.updateImmediateChild(p,v))}));const l=Gl(a,e);if(!l&&!e._queryParams.loadsAllData()){const h=ci(e);w(!n.queryToTagMap.has(h),"View does not exist, but we have a tag");const p=zg();n.queryToTagMap.set(h,p),n.tagToQueryMap.set(p,h)}const d=ri(n.pendingWriteTree_,i);let u=xg(a,e,t,d,r,c);if(!l&&!o&&!s){const h=jl(a,e);u=u.concat(Kg(n,e,h))}return u}function ai(n,e,t){const i=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const c=ae(o,e),l=tt(a,c);if(l)return l});return Dl(i,e,r,t,!0)}function jg(n,e){const t=e._path;let s=null;n.syncPointTree_.foreachOnPath(t,(l,d)=>{const u=ae(l,t);s=s||tt(d,u)});let i=n.syncPointTree_.get(t);i?s=s||tt(i,W()):(i=new Hl,n.syncPointTree_=n.syncPointTree_.set(t,i));const r=s!=null,o=r?new st(s,!0,!1):null,a=ri(n.pendingWriteTree_,e._path),c=Wl(i,e,a,r?o.getNode():P.EMPTY_NODE,r);return Tg(c)}function cn(n,e){return zl(e,n.syncPointTree_,null,ri(n.pendingWriteTree_,W()))}function zl(n,e,t,s){if(U(n.path))return Kl(n,e,t,s);{const i=e.get(W());t==null&&i!=null&&(t=tt(i,W()));let r=[];const o=F(n.path),a=n.operationForChild(o),c=e.children.get(o);if(c&&a){const l=t?t.getImmediateChild(o):null,d=Ll(s,o);r=r.concat(zl(a,c,l,d))}return i&&(r=r.concat(to(i,n,s,t))),r}}function Kl(n,e,t,s){const i=e.get(W());t==null&&i!=null&&(t=tt(i,W()));let r=[];return e.children.inorderTraversal((o,a)=>{const c=t?t.getImmediateChild(o):null,l=Ll(s,o),d=n.operationForChild(o);d&&(r=r.concat(Kl(d,a,c,l)))}),i&&(r=r.concat(to(i,n,s,t))),r}function Yl(n,e){const t=e.query,s=Fn(n,t);return{hashFn:()=>(Sg(e)||P.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?Wg(n,t._path,s):Hg(n,t._path);{const r=Hp(i,t);return Bs(n,t,null,r)}}}}function Fn(n,e){const t=ci(e);return n.queryToTagMap.get(t)}function ci(n){return n._path.toString()+"$"+n._queryIdentifier}function so(n,e){return n.tagToQueryMap.get(e)}function io(n){const e=n.indexOf("$");return w(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new j(n.substr(0,e))}}function ro(n,e,t){const s=n.syncPointTree_.get(e);w(s,"Missing sync point for query tag that we're tracking");const i=ri(n.pendingWriteTree_,e);return to(s,t,i,null)}function Gg(n){return n.fold((e,t,s)=>{if(t&&it(t))return[oi(t)];{let i=[];return t&&(i=Vl(t)),ie(s,(r,o)=>{i=i.concat(o)}),i}})}function Sn(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new($g())(n._repo,n._path):n}function qg(n,e){for(let t=0;t<e.length;++t){const s=e[t];if(!s._queryParams.loadsAllData()){const i=ci(s),r=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(r)}}}function zg(){return Fg++}function Kg(n,e,t){const s=e._path,i=Fn(n,e),r=Yl(n,t),o=n.listenProvider_.startListening(Sn(e),i,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(s);if(i)w(!it(a.value),"If we're adding a query, it shouldn't be shadowed");else{const c=a.fold((l,d,u)=>{if(!U(l)&&d&&it(d))return[oi(d).query];{let h=[];return d&&(h=h.concat(Vl(d).map(p=>p.query))),ie(u,(p,m)=>{h=h.concat(m)}),h}});for(let l=0;l<c.length;++l){const d=c[l];n.listenProvider_.stopListening(Sn(d),Fn(n,d))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uo{constructor(e="",t=null,s={children:{},childCount:0}){this.name=e,this.parent=t,this.node=s}}function li(n,e){let t=e instanceof j?e:new j(e),s=n,i=F(t);for(;i!==null;){const r=yt(s.node.children,i)||{children:{},childCount:0};s=new uo(i,s,r),t=q(t),i=F(t)}return s}function Rt(n){return n.node.value}function ho(n,e){n.node.value=e,fr(n)}function Jl(n){return n.node.childCount>0}function Xg(n){return Rt(n)===void 0&&!Jl(n)}function ui(n,e){ie(n.node.children,(t,s)=>{e(new uo(t,n,s))})}function Xl(n,e,t,s){t&&e(n),ui(n,i=>{Xl(i,e,!0)})}function Zg(n,e,t){let s=n.parent;for(;s!==null;){if(e(s))return!0;s=s.parent}return!1}function Qn(n){return new j(n.parent===null?n.name:Qn(n.parent)+"/"+n.name)}function fr(n){n.parent!==null&&e_(n.parent,n.name,n)}function e_(n,e,t){const s=Xg(t),i=Ee(n.node.children,e);s&&i?(delete n.node.children[e],n.node.childCount--,fr(n)):!s&&!i&&(n.node.children[e]=t.node,n.node.childCount++,fr(n))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const t_=/[\[\].#$\/\u0000-\u001F\u007F]/,n_=/[\[\].#$\u0000-\u001F\u007F]/,xi=10*1024*1024,fo=function(n){return typeof n=="string"&&n.length!==0&&!t_.test(n)},Zl=function(n){return typeof n=="string"&&n.length!==0&&!n_.test(n)},s_=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Zl(n)},po=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!ni(n)||n&&typeof n=="object"&&Ee(n,".sv")},Hs=function(n,e,t,s){s&&e===void 0||Jn(Gt(n,"value"),e,t)},Jn=function(n,e,t){const s=t instanceof j?new wm(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+dt(s));if(typeof e=="function")throw new Error(n+"contains a function "+dt(s)+" with contents = "+e.toString());if(ni(e))throw new Error(n+"contains "+e.toString()+" "+dt(s));if(typeof e=="string"&&e.length>xi/3&&Zs(e)>xi)throw new Error(n+"contains a string greater than "+xi+" utf8 bytes "+dt(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(ie(e,(o,a)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!fo(o)))throw new Error(n+" contains an invalid key ("+o+") "+dt(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);Em(s,o),Jn(n,a,s),Im(s)}),i&&r)throw new Error(n+' contains ".value" child '+dt(s)+" in addition to actual children.")}},i_=function(n,e){let t,s;for(t=0;t<e.length;t++){s=e[t];const r=On(s);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!fo(r[o]))throw new Error(n+"contains an invalid key ("+r[o]+") in path "+s.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(bm);let i=null;for(t=0;t<e.length;t++){if(s=e[t],i!==null&&me(i,s))throw new Error(n+"contains a path "+i.toString()+" that is ancestor of another path "+s.toString());i=s}},eu=function(n,e,t,s){const i=Gt(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const r=[];ie(e,(o,a)=>{const c=new j(o);if(Jn(i,a,X(t,c)),Vr(c)===".priority"&&!po(a))throw new Error(i+"contains an invalid value for '"+c.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(c)}),i_(i,r)},r_=function(n,e,t){if(ni(e))throw new Error(Gt(n,"priority")+"is "+e.toString()+", but must be a valid Firebase priority (a string, finite number, server value, or null).");if(!po(e))throw new Error(Gt(n,"priority")+"must be a valid Firebase priority (a string, finite number, server value, or null).")},tu=function(n,e,t,s){if(!Zl(t))throw new Error(Gt(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},o_=function(n,e,t,s){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),tu(n,e,t)},Qe=function(n,e){if(F(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},a_=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!fo(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!s_(t))throw new Error(Gt(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class c_{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function di(n,e){let t=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();t!==null&&!jr(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(i)}t&&n.eventLists_.push(t)}function nu(n,e,t){di(n,t),su(n,s=>jr(s,e))}function fe(n,e,t){di(n,t),su(n,s=>me(s,e)||me(e,s))}function su(n,e){n.recursionDepth_++;let t=!0;for(let s=0;s<n.eventLists_.length;s++){const i=n.eventLists_[s];if(i){const r=i.path;e(r)?(l_(n.eventLists_[s]),n.eventLists_[s]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function l_(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const s=t.getEventRunner();En&&se("event: "+t.toString()),on(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const u_="repo_interrupt",d_=25;class h_{constructor(e,t,s,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new c_,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Ms(),this.transactionQueueTree_=new uo,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function f_(n,e,t){if(n.stats_=Hr(n.repoInfo_),n.forceRestClient_||Gp())n.server_=new Ps(n.repoInfo_,(s,i,r,o)=>{Oa(n,s,i,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>xa(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{ee(t)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}n.persistentConnection_=new xe(n.repoInfo_,e,(s,i,r,o)=>{Oa(n,s,i,r,o)},s=>{xa(n,s)},s=>{p_(n,s)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(s=>{n.server_.refreshAuthToken(s)}),n.appCheckProvider_.addTokenChangeListener(s=>{n.server_.refreshAppCheckToken(s.token)}),n.statsReporter_=Qp(n.repoInfo_,()=>new Ym(n.stats_,n.server_)),n.infoData_=new jm,n.infoSyncTree_=new Pa({startListening:(s,i,r,o)=>{let a=[];const c=n.infoData_.getNode(s._path);return c.isEmpty()||(a=Yn(n.infoSyncTree_,s._path,c),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),mo(n,"connected",!1),n.serverSyncTree_=new Pa({startListening:(s,i,r,o)=>(n.server_.listen(s,r,i,(a,c)=>{const l=o(a,c);fe(n.eventQueue_,s._path,l)}),[]),stopListening:(s,i)=>{n.server_.unlisten(s,i)}})}function iu(n){const t=n.infoData_.getNode(new j(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Xn(n){return Yg({timestamp:iu(n)})}function Oa(n,e,t,s,i){n.dataUpdateCount++;const r=new j(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(i)if(s){const c=bs(t,l=>J(l));o=Vg(n.serverSyncTree_,r,c,i)}else{const c=J(t);o=ql(n.serverSyncTree_,r,c,i)}else if(s){const c=bs(t,l=>J(l));o=Bg(n.serverSyncTree_,r,c)}else{const c=J(t);o=Yn(n.serverSyncTree_,r,c)}let a=r;o.length>0&&(a=Xt(n,r)),fe(n.eventQueue_,a,o)}function xa(n,e){mo(n,"connected",e),e===!1&&v_(n)}function p_(n,e){ie(e,(t,s)=>{mo(n,t,s)})}function mo(n,e,t){const s=new j("/.info/"+e),i=J(t);n.infoData_.updateSnapshot(s,i);const r=Yn(n.infoSyncTree_,s,i);fe(n.eventQueue_,s,r)}function hi(n){return n.nextWriteId_++}function m_(n,e,t){const s=jg(n.serverSyncTree_,e);return s!=null?Promise.resolve(s):n.server_.get(e).then(i=>{const r=J(i).withIndex(e._queryParams.getIndex());hr(n.serverSyncTree_,e,t,!0);let o;if(e._queryParams.loadsAllData())o=Yn(n.serverSyncTree_,e._path,r);else{const a=Fn(n.serverSyncTree_,e);o=ql(n.serverSyncTree_,e._path,r,a)}return fe(n.eventQueue_,e._path,o),Bs(n.serverSyncTree_,e,t,null,!0),r},i=>(ln(n,"get for query "+ee(e)+" failed: "+i),Promise.reject(new Error(i))))}function g_(n,e,t,s,i){ln(n,"set",{path:e.toString(),value:t,priority:s});const r=Xn(n),o=J(t,s),a=ai(n.serverSyncTree_,e),c=co(o,a,r),l=hi(n),d=no(n.serverSyncTree_,e,c,l,!0);di(n.eventQueue_,d),n.server_.put(e.toString(),o.val(!0),(h,p)=>{const m=h==="ok";m||ce("set at "+e+" failed: "+h);const v=Ye(n.serverSyncTree_,l,!m);fe(n.eventQueue_,e,v),rt(n,i,h,p)});const u=_o(n,e);Xt(n,u),fe(n.eventQueue_,u,[])}function __(n,e,t,s){ln(n,"update",{path:e.toString(),value:t});let i=!0;const r=Xn(n),o={};if(ie(t,(a,c)=>{i=!1,o[a]=Ql(X(e,a),J(c),n.serverSyncTree_,r)}),i)se("update() called with empty data.  Don't do anything."),rt(n,s,"ok",void 0);else{const a=hi(n),c=Ug(n.serverSyncTree_,e,o,a);di(n.eventQueue_,c),n.server_.merge(e.toString(),t,(l,d)=>{const u=l==="ok";u||ce("update at "+e+" failed: "+l);const h=Ye(n.serverSyncTree_,a,!u),p=h.length>0?Xt(n,e):e;fe(n.eventQueue_,p,h),rt(n,s,l,d)}),ie(t,l=>{const d=_o(n,X(e,l));Xt(n,d)}),fe(n.eventQueue_,e,[])}}function v_(n){ln(n,"onDisconnectEvents");const e=Xn(n),t=Ms();or(n.onDisconnect_,W(),(i,r)=>{const o=Ql(i,r,n.serverSyncTree_,e);an(t,i,o)});let s=[];or(t,W(),(i,r)=>{s=s.concat(Yn(n.serverSyncTree_,i,r));const o=_o(n,i);Xt(n,o)}),n.onDisconnect_=Ms(),fe(n.eventQueue_,W(),s)}function y_(n,e,t){n.server_.onDisconnectCancel(e.toString(),(s,i)=>{s==="ok"&&rr(n.onDisconnect_,e),rt(n,t,s,i)})}function Da(n,e,t,s){const i=J(t);n.server_.onDisconnectPut(e.toString(),i.val(!0),(r,o)=>{r==="ok"&&an(n.onDisconnect_,e,i),rt(n,s,r,o)})}function b_(n,e,t,s,i){const r=J(t,s);n.server_.onDisconnectPut(e.toString(),r.val(!0),(o,a)=>{o==="ok"&&an(n.onDisconnect_,e,r),rt(n,i,o,a)})}function w_(n,e,t,s){if(ys(t)){se("onDisconnect().update() called with empty data.  Don't do anything."),rt(n,s,"ok",void 0);return}n.server_.onDisconnectMerge(e.toString(),t,(i,r)=>{i==="ok"&&ie(t,(o,a)=>{const c=J(a);an(n.onDisconnect_,X(e,o),c)}),rt(n,s,i,r)})}function E_(n,e,t){let s;F(e._path)===".info"?s=hr(n.infoSyncTree_,e,t):s=hr(n.serverSyncTree_,e,t),nu(n.eventQueue_,e._path,s)}function pr(n,e,t){let s;F(e._path)===".info"?s=Bs(n.infoSyncTree_,e,t):s=Bs(n.serverSyncTree_,e,t),nu(n.eventQueue_,e._path,s)}function I_(n){n.persistentConnection_&&n.persistentConnection_.interrupt(u_)}function ln(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),se(t,...e)}function rt(n,e,t,s){e&&on(()=>{if(t==="ok")e(null);else{const i=(t||"error").toUpperCase();let r=i;s&&(r+=": "+s);const o=new Error(r);o.code=i,e(o)}})}function k_(n,e,t,s,i,r){ln(n,"transaction on "+e);const o={path:e,update:t,onComplete:s,status:null,order:nl(),applyLocally:r,retryCount:0,unwatcher:i,abortReason:null,currentWriteId:null,currentInputSnapshot:null,currentOutputSnapshotRaw:null,currentOutputSnapshotResolved:null},a=go(n,e,void 0);o.currentInputSnapshot=a;const c=o.update(a.val());if(c===void 0)o.unwatcher(),o.currentOutputSnapshotRaw=null,o.currentOutputSnapshotResolved=null,o.onComplete&&o.onComplete(null,!1,o.currentInputSnapshot);else{Jn("transaction failed: Data returned ",c,o.path),o.status=0;const l=li(n.transactionQueueTree_,e),d=Rt(l)||[];d.push(o),ho(l,d);let u;typeof c=="object"&&c!==null&&Ee(c,".priority")?(u=yt(c,".priority"),w(po(u),"Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null.")):u=(ai(n.serverSyncTree_,e)||P.EMPTY_NODE).getPriority().val();const h=Xn(n),p=J(c,u),m=co(p,a,h);o.currentOutputSnapshotRaw=p,o.currentOutputSnapshotResolved=m,o.currentWriteId=hi(n);const v=no(n.serverSyncTree_,e,m,o.currentWriteId,o.applyLocally);fe(n.eventQueue_,e,v),fi(n,n.transactionQueueTree_)}}function go(n,e,t){return ai(n.serverSyncTree_,e,t)||P.EMPTY_NODE}function fi(n,e=n.transactionQueueTree_){if(e||pi(n,e),Rt(e)){const t=ou(n,e);w(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&C_(n,Qn(e),t)}else Jl(e)&&ui(e,t=>{fi(n,t)})}function C_(n,e,t){const s=t.map(l=>l.currentWriteId),i=go(n,e,s);let r=i;const o=i.hash();for(let l=0;l<t.length;l++){const d=t[l];w(d.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),d.status=1,d.retryCount++;const u=ae(e,d.path);r=r.updateChild(u,d.currentOutputSnapshotRaw)}const a=r.val(!0),c=e;n.server_.put(c.toString(),a,l=>{ln(n,"transaction put response",{path:c.toString(),status:l});let d=[];if(l==="ok"){const u=[];for(let h=0;h<t.length;h++)t[h].status=2,d=d.concat(Ye(n.serverSyncTree_,t[h].currentWriteId)),t[h].onComplete&&u.push(()=>t[h].onComplete(null,!0,t[h].currentOutputSnapshotResolved)),t[h].unwatcher();pi(n,li(n.transactionQueueTree_,e)),fi(n,n.transactionQueueTree_),fe(n.eventQueue_,e,d);for(let h=0;h<u.length;h++)on(u[h])}else{if(l==="datastale")for(let u=0;u<t.length;u++)t[u].status===3?t[u].status=4:t[u].status=0;else{ce("transaction at "+c.toString()+" failed: "+l);for(let u=0;u<t.length;u++)t[u].status=4,t[u].abortReason=l}Xt(n,e)}},o)}function Xt(n,e){const t=ru(n,e),s=Qn(t),i=ou(n,t);return S_(n,i,s),s}function S_(n,e,t){if(e.length===0)return;const s=[];let i=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const c=e[a],l=ae(t,c.path);let d=!1,u;if(w(l!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),c.status===4)d=!0,u=c.abortReason,i=i.concat(Ye(n.serverSyncTree_,c.currentWriteId,!0));else if(c.status===0)if(c.retryCount>=d_)d=!0,u="maxretry",i=i.concat(Ye(n.serverSyncTree_,c.currentWriteId,!0));else{const h=go(n,c.path,o);c.currentInputSnapshot=h;const p=e[a].update(h.val());if(p!==void 0){Jn("transaction failed: Data returned ",p,c.path);let m=J(p);typeof p=="object"&&p!=null&&Ee(p,".priority")||(m=m.updatePriority(h.getPriority()));const I=c.currentWriteId,E=Xn(n),_=co(m,h,E);c.currentOutputSnapshotRaw=m,c.currentOutputSnapshotResolved=_,c.currentWriteId=hi(n),o.splice(o.indexOf(I),1),i=i.concat(no(n.serverSyncTree_,c.path,_,c.currentWriteId,c.applyLocally)),i=i.concat(Ye(n.serverSyncTree_,I,!0))}else d=!0,u="nodata",i=i.concat(Ye(n.serverSyncTree_,c.currentWriteId,!0))}fe(n.eventQueue_,t,i),i=[],d&&(e[a].status=2,function(h){setTimeout(h,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(u==="nodata"?s.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):s.push(()=>e[a].onComplete(new Error(u),!1,null))))}pi(n,n.transactionQueueTree_);for(let a=0;a<s.length;a++)on(s[a]);fi(n,n.transactionQueueTree_)}function ru(n,e){let t,s=n.transactionQueueTree_;for(t=F(e);t!==null&&Rt(s)===void 0;)s=li(s,t),e=q(e),t=F(e);return s}function ou(n,e){const t=[];return au(n,e,t),t.sort((s,i)=>s.order-i.order),t}function au(n,e,t){const s=Rt(e);if(s)for(let i=0;i<s.length;i++)t.push(s[i]);ui(e,i=>{au(n,i,t)})}function pi(n,e){const t=Rt(e);if(t){let s=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[s]=t[i],s++);t.length=s,ho(e,t.length>0?t:void 0)}ui(e,s=>{pi(n,s)})}function _o(n,e){const t=Qn(ru(n,e)),s=li(n.transactionQueueTree_,e);return Zg(s,i=>{Di(n,i)}),Di(n,s),Xl(s,i=>{Di(n,i)}),t}function Di(n,e){const t=Rt(e);if(t){const s=[];let i=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(w(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(w(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),i=i.concat(Ye(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&s.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?ho(e,void 0):t.length=r+1,fe(n.eventQueue_,Qn(e),i);for(let o=0;o<s.length;o++)on(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class O_{constructor(e,t){this._repo=e,this._path=t}cancel(){const e=new ve;return y_(this._repo,this._path,e.wrapCallback(()=>{})),e.promise}remove(){Qe("OnDisconnect.remove",this._path);const e=new ve;return Da(this._repo,this._path,null,e.wrapCallback(()=>{})),e.promise}set(e){Qe("OnDisconnect.set",this._path),Hs("OnDisconnect.set",e,this._path,!1);const t=new ve;return Da(this._repo,this._path,e,t.wrapCallback(()=>{})),t.promise}setWithPriority(e,t){Qe("OnDisconnect.setWithPriority",this._path),Hs("OnDisconnect.setWithPriority",e,this._path,!1),r_("OnDisconnect.setWithPriority",t);const s=new ve;return b_(this._repo,this._path,e,t,s.wrapCallback(()=>{})),s.promise}update(e){Qe("OnDisconnect.update",this._path),eu("OnDisconnect.update",e,this._path);const t=new ve;return w_(this._repo,this._path,e,t.wrapCallback(()=>{})),t.promise}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo{constructor(e,t,s,i){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=i}get key(){return U(this._path)?null:Vr(this._path)}get ref(){return new Te(this._repo,this._path)}get _queryIdentifier(){const e=wa(this._queryParams),t=Ur(e);return t==="{}"?"default":t}get _queryObject(){return wa(this._queryParams)}isEqual(e){if(e=oe(e),!(e instanceof vo))return!1;const t=this._repo===e._repo,s=jr(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+ym(this._path)}}class Te extends vo{constructor(e,t){super(e,t,new Kr,!1)}get parent(){const e=kl(this._path);return e===null?null:new Te(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Zt{constructor(e,t,s){this._node=e,this.ref=t,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new j(e),s=Un(this.ref,e);return new Zt(this._node.getChild(t),s,Q)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new Zt(i,Un(this.ref,s),Q)))}hasChild(e){const t=new j(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function $(n,e){return n=oe(n),n._checkNotDeleted("ref"),e!==void 0?Un(n._root,e):n._root}function Un(n,e){return n=oe(n),F(n._path)===null?o_("child","path",e):tu("child","path",e),new Te(n._repo,X(n._path,e))}function x_(n){return n=oe(n),new O_(n._repo,n._path)}function lu(n,e){n=oe(n),Qe("push",n._path),Hs("push",e,n._path,!0);const t=iu(n._repo),s=A_(t),i=Un(n,s),r=Un(n,s);let o;return e!=null?o=un(r,e).then(()=>r):o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function vn(n){return Qe("remove",n._path),un(n,null)}function un(n,e){n=oe(n),Qe("set",n._path),Hs("set",e,n._path,!1);const t=new ve;return g_(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function ot(n,e){eu("update",e,n._path);const t=new ve;return __(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function Bn(n){n=oe(n);const e=new cu(()=>{}),t=new mi(e);return m_(n._repo,n,t).then(s=>new Zt(s,new Te(n._repo,n._path),n._queryParams.getIndex()))}class mi{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const s=t._queryParams.getIndex();return new P_("value",this,new Zt(e.snapshotNode,new Te(t._repo,t._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new M_(this,e,t):null}matches(e){return e instanceof mi?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function D_(n,e,t,s,i){let r;if(typeof s=="object"&&(r=void 0,i=s),typeof s=="function"&&(r=s),i&&i.onlyOnce){const c=t,l=(d,u)=>{pr(n._repo,n,a),c(d,u)};l.userCallback=t.userCallback,l.context=t.context,t=l}const o=new cu(t,r||void 0),a=new mi(o);return E_(n._repo,n,a),()=>pr(n._repo,n,a)}function dn(n,e,t,s){return D_(n,"value",e,t,s)}function gi(n,e,t){pr(n._repo,n,null)}Pg(Te);Lg(Te);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const L_="FIREBASE_DATABASE_EMULATOR_HOST",mr={};let $_=!1;function F_(n,e,t,s){n.repoInfo_=new ml(`${e}:${t}`,!1,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0),s&&(n.authTokenProvider_=s)}function U_(n,e,t,s,i){let r=s||n.options.databaseURL;r===void 0&&(n.options.projectId||Ue("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),se("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=La(r,i),a=o.repoInfo,c;typeof process<"u"&&sa&&(c=sa[L_]),c?(r=`http://${c}?ns=${a.namespace}`,o=La(r,i),a=o.repoInfo):o.repoInfo.secure;const l=new zp(n.name,n.options,e);a_("Invalid Firebase Database URL",o),U(o.path)||Ue("Database URL must point to the root of a Firebase Database (not including a child path).");const d=H_(a,n,l,new qp(n.name,t));return new W_(d,n)}function B_(n,e){const t=mr[e];(!t||t[n.key]!==n)&&Ue(`Database ${e}(${n.repoInfo_}) has already been deleted.`),I_(n),delete t[n.key]}function H_(n,e,t,s){let i=mr[e.name];i||(i={},mr[e.name]=i);let r=i[n.toURLString()];return r&&Ue("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new h_(n,$_,t,s),i[n.toURLString()]=r,r}class W_{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(f_(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Te(this._repo,W())),this._rootInternal}_delete(){return this._rootInternal!==null&&(B_(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&Ue("Cannot call "+e+" on a deleted database.")}}function V_(n=yc(),e){const t=Rr(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const s=rd("database");s&&j_(t,...s)}return t}function j_(n,e,t,s={}){n=oe(n),n._checkNotDeleted("useEmulator"),n._instanceStarted&&Ue("Cannot call useEmulator() after instance has already been initialized.");const i=n._repoInternal;let r;if(i.repoInfo_.nodeAdmin)s.mockUserToken&&Ue('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new ds(ds.OWNER);else if(s.mockUserToken){const o=typeof s.mockUserToken=="string"?s.mockUserToken:od(s.mockUserToken,n.app.options.projectId);r=new ds(o)}F_(i,e,t,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function G_(n){Pp(sn),qt(new bt("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return U_(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),Ze(ia,ra,n),Ze(ia,ra,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class q_{constructor(e,t){this.committed=e,this.snapshot=t}toJSON(){return{committed:this.committed,snapshot:this.snapshot.toJSON()}}}function le(n,e,t){var s;if(n=oe(n),Qe("Reference.transaction",n._path),n.key===".length"||n.key===".keys")throw"Reference.transaction failed: "+n.key+" is a read-only object.";const i=(s=void 0)!==null&&s!==void 0?s:!0,r=new ve,o=(c,l,d)=>{let u=null;c?r.reject(c):(u=new Zt(d,new Te(n._repo,n._path),Q),r.resolve(new q_(l,u)))},a=dn(n,()=>{});return k_(n._repo,n._path,e,o,a,i),r.promise}xe.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};xe.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};G_();const yn={apiKey:"AIzaSyARFa-vzKVmIdxP5xDRXVzasL2ui94eZ-w",authDomain:"market-6e66a.firebaseapp.com",databaseURL:"https://market-6e66a-default-rtdb.firebaseio.com",projectId:"market-6e66a",storageBucket:"market-6e66a.firebasestorage.app",messagingSenderId:"402312269082",appId:"1:402312269082:web:cf304afc54057ea162b0a3"},uu=!!yn.apiKey&&!yn.apiKey.startsWith("여기에")&&!!yn.databaseURL&&!yn.databaseURL.startsWith("여기에");let Li=null,yo=null,x=null;try{uu&&(Li=vc(yn),yo=Np(Li),x=V_(Li))}catch(n){console.error("[firebase] 초기화 실패:",n)}const Wt=5e6,Be=10,gr=4e3,z_=.008,Fa=3e4,K_=4e-5,Ua=.015,Y_=.55,du=15e-5,Q_=.0018,J_=3*60*1e3,X_=["달빛전자","구름소프트","번개모빌리티","바다식품","별빛바이오","한입게임즈","초록에너지","솜사탕유통","무지개항공","도토리금융","은하반도체","포근화학","두근로보틱스","새벽엔터","고래물산","민들레제약"],Z_=["떡상테크","유니콘소프트","미래모빌","첫걸음바이오","샛별에너지","루키게임즈","신화엔터","퀀텀반도체"],Ba=["개미부대","왕개미","큰손","수상한세력","외국인","기관","전설의단타","스캘퍼","장기투자자","물타기달인"];function pt(n,e){return Math.floor(Math.random()*(e-n+1))+n}function Y(n,e){return Math.random()*(e-n)+n}function _e(n,e,t){return Math.max(e,Math.min(t,n))}function ev(n){const e=[...n];for(let t=e.length-1;t>0;t--){const s=Math.floor(Math.random()*(t+1));[e[t],e[s]]=[e[s],e[t]]}return e}function tv(n,e,t={}){const s=t.type||"stock",i=t.role||null;e=ke(Math.max(Be,e));let r=1,o=1;return s==="stock"?i==="leader"?(r=Y(.8,1.4),o=Y(2,3)):i==="sub"?(r=Y(.9,1.6),o=Y(1.2,2.2)):i==="related"?(r=Y(.7,2),o=Y(.6,1.8)):(r=Y(.5,2.4),o=Y(.3,1.2)):s==="preferred"?(r=Y(.4,.8),o=Y(.5,1.1)):s==="etf"?(r=Y(.5,.8),o=Y(1.5,2.5)):s==="reit"?(r=Y(.35,.7),o=Y(.6,1.2)):s==="bond"?(r=Y(.2,.45),o=Y(.8,1.4)):s==="spac"?(r=Y(.2,.5),o=Y(.4,.9)):s==="commodity"?(r=Y(.9,1.8),o=Y(1,2)):(s==="inverse"||s==="leverage")&&(r=1,o=Y(1.5,2.5)),{name:n,type:s,role:i||"",sector:t.sector||"",link:t.link||"",price:e,previousPrice:e,basePrice:e,open:e,high:e,low:e,changeRate:0,volume:0,value:0,pressure:0,trend:0,volat:+r.toFixed(2),activ:+o.toFixed(2),heat:0,news:""}}function _i(n){return{preferred:"우선주",etf:"ETF",reit:"리츠",spac:"SPAC",inverse:"인버스",leverage:"레버리지",bond:"채권ETF",commodity:"원자재"}[n]||""}function hu(n){return{leader:"대장주",sub:"부대장주",related:"관련주",normal:"일반주"}[n]||""}function $i(n){return!n||n==="stock"}function vi(n){return Math.round(n*1.3)}function yi(n){return Math.max(Be,Math.round(n*.7))}function fu(n){return n<2e3?1:n<5e3?5:n<2e4?10:n<5e4?50:n<2e5?100:500}function ke(n){const e=fu(n);return Math.round(n/e)*e}function Fi(n){return _e((n.pressure||0)*K_/(n.activ||1),-Ua,Ua)}async function nv(n,e){const t=e.stocks||{},s=Object.keys(t);if(s.length===0)return;let i=null,r=0,o="";const a=Date.now(),c={},l=[];function d(E){const _=(E.activ||1)*(1+(E.heat||0));let y=0,T=0;const b=_e(.35+_*.2,.25,.97);if(Math.random()<b){const k=pt(1,Math.max(2,Math.round(1+_*3)));for(let M=0;M<k;M++){const N=pt(10,Math.round(60+_*220)),g=.5+_e((E.trend||0)*15,-.3,.3),C=Math.random()<g;y+=C?N:-N,T+=N,l.push({nickname:Ba[pt(0,Ba.length-1)],type:C?"buy":"sell",stockName:E.name,qty:N,price:E.price,time:a})}}return T+=Math.round(pt(300,2500)*_),{botNet:y,botVolume:T}}function u(E,_,y,T,b={}){const k=_.basePrice||_.price,M=k?(_.price-k)/k:0;y+=_e(-M*.01,-.006,.006);let N=ke(_.price*(1+y));N=_e(N,yi(k),vi(k)),N=Math.max(Be,N);const g=`stocks/${E}/`;if(c[g+"previousPrice"]=_.price,c[g+"price"]=N,c[g+"changeRate"]=+((N-k)/k*100).toFixed(2),c[g+"volume"]=(_.volume||0)+T,c[g+"value"]=(_.value||0)+T*N,N>(_.high||_.price)&&(c[g+"high"]=N),N<(_.low||_.price)&&(c[g+"low"]=N),(_.pressure||0)!==0){const C=(_.pressure||0)*Y_;c[g+"pressure"]=Math.abs(C)<1?0:+C.toFixed(2)}return b.trend!=null&&(c[g+"trend"]=+b.trend.toFixed(5)),b.heat!=null&&(b.heat>.001||(_.heat||0)>.001)&&(c[g+"heat"]=+b.heat.toFixed(3)),b.news!=null&&(c[g+"news"]=b.news),N/_.price-1}function h(E){const _=E.volat||1;let y=(E.heat||0)*.92;Math.random()<.006&&(y=_e(y+Y(.3,1),0,1.6));const T=_*(1+y*.5),b=_e((E.trend||0)*.96+(Math.random()-.5)*8e-4*T,-.0025*(1+y*.5),.0025*(1+y*.5));let k=(Math.random()-.5)*.0016*T+b;return Math.random()<.005&&(k+=(Math.random()-.5)*.012*(1+y*.4)),{own:k,trend:b,heat:y}}const p={},m={},v=[];for(const E of s){const _=t[E];if(!$i(_.type)||_.role!=="leader")continue;const{own:y,trend:T,heat:b}=h(_),{botNet:k,botVolume:M}=d({..._,heat:b});let N=y+Fi(_)+_e(k*2e-4,-.008,.008);E===i&&(N+=r);const g=u(E,_,N,M,{trend:T,heat:b,news:E===i?o:null});p[E]=g,m[_.sector]=g,v.push(g)}for(const E of s){const _=t[E];if(!$i(_.type)||_.role==="leader")continue;const y=_.role==="related"?.7:_.role==="sub"?.45:.2,T=m[_.sector]||0,{own:b,trend:k,heat:M}=h(_),{botNet:N,botVolume:g}=d({..._,heat:M});let C=T*y+b*(1-y*.5);C+=Fi(_)+_e(N*2e-4,-.008,.008),E===i&&(C+=r);const S=u(E,_,C,g,{trend:k,heat:M,news:E===i?o:null});p[E]=S,v.push(S)}const I=v.length?v.reduce((E,_)=>E+_,0)/v.length:0;for(const E of s){const _=t[E];if($i(_.type))continue;const{botNet:y,botVolume:T}=d(_),b=Math.random()-.5;let k=0;switch(_.type){case"etf":k=I+b*.0015;break;case"inverse":k=-I+b*.0015;break;case"leverage":k=2*I+b*.002;break;case"bond":k=-.25*I+2e-4+b*.0012;break;case"reit":k=.2*I+2e-4+b*.004*(_.volat||1);break;case"commodity":k=b*.011*(_.volat||1)+(Math.random()<.01?(Math.random()-.5)*.05:0);break;case"preferred":k=(m[_.sector]||p[_.link]||0)*.85+b*.002;break;case"spac":k=b*.003+(Math.random()<.008?(Math.random()<.7?1:-1)*Y(.06,.2):0);break;default:k=b*.005}k+=Fi(_)+_e(y*3e-4,-.01,.01),u(E,_,k,T,{})}c.marketTick=a,ev(l),c.botFeed=l.slice(0,4),await ot($(x,`rooms/${n}`),c)}function Ui(n){return Math.round(n||0).toLocaleString("ko-KR")}async function sv(n,e){const t=Date.now(),s=e.stocks||{},i=e.ipo;if(i&&i.status==="subscribing"){if(t<i.endsAt)return;const h=i.applies||{},p=Object.values(h).reduce((T,b)=>T+(b||0),0),m=(i.botDemand||0)+p,v=Math.max(1,m/i.totalShares),I=_e(.92+(v-1)*.1+Y(-.1,.15),.9,2.3),E=Math.max(Be,ke(i.offerPrice*I)),_=tv(i.name,E,{type:"stock",role:"normal",sector:"신규상장"});_.ipo=!0;const y=((E-i.offerPrice)/i.offerPrice*100).toFixed(1);await ot($(x,`rooms/${n}`),{[`stocks/${i.stockId}`]:_,ipo:null,latestNews:{text:`🎉 ${i.name} 상장! 공모가 ${Ui(i.offerPrice)} → 시초가 ${Ui(E)} (${y>=0?"+":""}${y}%) · 경쟁률 ${v.toFixed(1)}:1`,time:t}});for(const[T,b]of Object.entries(h)){const k=b||0,M=Math.floor(k/v),N=i.offerPrice*(k-M);await le($(x,`rooms/${n}/players/${T}`),g=>g&&(N>0&&(g.cash=(g.cash||0)+N),M>0&&(g.holdings=g.holdings||{},g.holdings[i.stockId]=(g.holdings[i.stockId]||0)+M),g))}return}if(i||Object.keys(s).length>=90||Math.random()>=z_)return;const r=Object.values(s).map(h=>h.name),o=[...X_,...Z_].filter(h=>!r.includes(h));if(!o.length)return;const a=o[pt(0,o.length-1)],c=ke(pt(5e3,6e4)),l=pt(5e4,2e5),d=Math.floor(l*Y(.4,9)),u="ipo"+t.toString(36);await ot($(x,`rooms/${n}`),{ipo:{stockId:u,name:a,offerPrice:c,totalShares:l,botDemand:d,status:"subscribing",startedAt:t,endsAt:t+Fa},latestNews:{text:`공모주 청약 시작! '${a}' 공모가 ${Ui(c)}원 · ${Math.round(Fa/1e3)}초 후 마감`,time:t}})}async function iv(n,e,t,s){const i=s.ipo;if(!i||i.status!=="subscribing")throw new Error("청약 가능한 공모주가 없습니다.");if(Date.now()>=i.endsAt)throw new Error("청약이 마감되었습니다.");if(t=Math.floor(t),!t||t<1)throw new Error("청약 수량을 확인하세요.");const r=i.offerPrice*t;if(!(await le($(x,`rooms/${n}/players/${e}/cash`),a=>{if(a==null)return a;if(!(a<r))return a-r})).committed)throw new Error("청약 증거금(현금)이 부족합니다.");await le($(x,`rooms/${n}/ipo/applies/${e}`),a=>(a||0)+t)}function rv(n){if(!n)return 0;const e=Object.values(n.applies||{}).reduce((t,s)=>t+(s||0),0);return((n.botDemand||0)+e)/n.totalShares}async function Ws(n,e,t,s,i,r,o,a){var v;const c=(v=a.stocks)==null?void 0:v[s];if(!c)throw new Error("종목을 선택하세요.");const l=i.side;if(l!=="buy"&&l!=="sell")throw new Error("주문 유형 오류");const d=i.trigger==="above"?"above":"below",u=["gtc","day","ioc"].includes(i.tif)?i.tif:"gtc";if(r=Math.floor(r),!r||r<1)throw new Error("수량을 확인하세요.");if(o=ke(Number(o)),!o||o<Be)throw new Error("주문 가격을 확인하세요.");const h=Date.now(),p={uid:e,nickname:t,stockId:s,stockName:c.name,side:l,trigger:d,tif:u,label:i.label||"지정가",qty:r,target:o,createdAt:h,expiresAt:u==="day"?h+J_:null},m=lu($(x,`rooms/${n}/orders`)).key;return await un($(x,`rooms/${n}/orders/${m}`),p),m}async function ov(n,e){await vn($(x,`rooms/${n}/orders/${e}`))}async function av(n,e){var i;const t=e.orders;if(!t)return;const s=Date.now();for(const[r,o]of Object.entries(t)){const a=(i=e.stocks)==null?void 0:i[o.stockId];if(!a){await vn($(x,`rooms/${n}/orders/${r}`));continue}const c=a.price;if((o.trigger||(o.side==="buy"?"below":"above"))==="below"?c<=o.target:c>=o.target){try{o.side==="buy"?await bo(n,o.uid,o.nickname,o.stockId,o.qty,e):await bi(n,o.uid,o.nickname,o.stockId,o.qty,e)}catch(u){console.warn("[order] 예약 체결 실패, 취소:",o,u==null?void 0:u.message)}await vn($(x,`rooms/${n}/orders/${r}`));continue}o.tif==="ioc"?await vn($(x,`rooms/${n}/orders/${r}`)):o.expiresAt&&s>o.expiresAt&&await vn($(x,`rooms/${n}/orders/${r}`))}}function cv(n,e){const t=n.orders||{};return Object.entries(t).filter(([,s])=>s.uid===e).map(([s,i])=>({id:s,...i})).sort((s,i)=>(i.createdAt||0)-(s.createdAt||0))}async function bo(n,e,t,s,i,r){var d;const o=(d=r.stocks)==null?void 0:d[s];if(!o)throw new Error("종목을 선택하세요.");if(i=Math.floor(i),!i||i<1)throw new Error("수량을 확인하세요.");const a=o.price,c=Math.ceil(a*i*(1+du));if(!(await le($(x,`rooms/${n}/players/${e}`),u=>{if(!u)return u;if((u.cash||0)<c)return;u.cash=(u.cash||0)-c,u.holdings=u.holdings||{};const h=u.holdings[s]||0;u.avgCost=u.avgCost||{};const p=u.avgCost[s]||0;return u.avgCost[s]=Math.round((h*p+i*a)/(h+i)),u.holdings[s]=h+i,u})).committed)throw new Error("현금(수수료 포함)이 부족합니다.");await mu(n,s,i,+i,{type:"buy",nickname:t,stockName:o.name,qty:i,price:a,time:Date.now()})}async function bi(n,e,t,s,i,r){var d;const o=(d=r.stocks)==null?void 0:d[s];if(!o)throw new Error("종목을 선택하세요.");if(i=Math.floor(i),!i||i<1)throw new Error("수량을 확인하세요.");const a=o.price,c=Math.floor(a*i*(1-du-Q_));if(!(await le($(x,`rooms/${n}/players/${e}`),u=>{var p;if(!u)return u;const h=((p=u.holdings)==null?void 0:p[s])||0;if(!(h<i))return u.cash=(u.cash||0)+c,u.holdings[s]=h-i,u.holdings[s]===0&&(delete u.holdings[s],u.avgCost&&delete u.avgCost[s]),u})).committed)throw new Error("보유 수량이 부족합니다.");await mu(n,s,i,-i,{type:"sell",nickname:t,stockName:o.name,qty:i,price:a,time:Date.now()})}async function pu(n,e,t,s,i){var o,a,c;const r=((c=(a=(o=i.players)==null?void 0:o[e])==null?void 0:a.holdings)==null?void 0:c[s])||0;if(r<1)throw new Error("보유 수량이 없습니다.");return bi(n,e,t,s,r,i)}async function mu(n,e,t,s,i){await Promise.all([le($(x,`rooms/${n}/stocks/${e}/volume`),r=>(r||0)+t),le($(x,`rooms/${n}/stocks/${e}/value`),r=>(r||0)+t*i.price),le($(x,`rooms/${n}/stocks/${e}/pressure`),r=>(r||0)+s),lu($(x,`rooms/${n}/logs`),i)])}function wo(n,e){var i;let t=(n==null?void 0:n.cash)||0;const s=(n==null?void 0:n.holdings)||{};for(const[r,o]of Object.entries(s)){const a=((i=e==null?void 0:e[r])==null?void 0:i.price)||0;t+=a*o}return t}function gu(n,e){return Object.entries(n||{}).map(([t,s])=>({uid:t,nickname:s.nickname&&String(s.nickname).trim()||"플레이어-"+String(t).slice(-4),connected:s.connected!==!1,total:wo(s,e)})).sort((t,s)=>s.total-t.total)}const lv=1,Vs=[{key:"candles1m",win:6e4,cap:240},{key:"candles5m",win:3e5,cap:288},{key:"candles15m",win:9e5,cap:192},{key:"candles1h",win:36e5,cap:168}],_u=2*6e4,uv=6e4,dv=4500;function _r(n,e){return Math.floor(n/e)*e}function hs(n,e,t){return Math.max(e,Math.min(t,n))}function Ha(){let n=0,e=0;for(;n===0;)n=Math.random();for(;e===0;)e=Math.random();return Math.sqrt(-2*Math.log(n))*Math.cos(2*Math.PI*e)}function Wa(n,e){const t=n&&n[e]||null;return t?Object.values(t).filter(s=>s&&typeof s.t=="number").sort((s,i)=>s.t-i.t):[]}function hv(n,e,t,s){const i=(t-e)/s,r=Math.max(1,i/4e3),o=n.volat||1,a=n.activ||1,c=n.basePrice||n.price||Be;let l=n.price||c,d=n.trend||0,u=n.heat||0;const h=!n.type||n.type==="stock",p=.0011*o*(h?1:.7),m=5,v=[];for(let I=0;I<s;I++){const E=e+i*I,_=l,y=r/m;let T=_,b=_,k=_;for(let S=0;S<m;S++){d=hs(d*Math.pow(.99,y)+Ha()*18e-5*o*Math.sqrt(y),-.0016,.0016),Math.random()<.005*y&&(u=hs(u+(.3+Math.random()*.7),0,1.6)),u*=Math.pow(.94,y);const H=p*(1+u*.5);let A=d*y+Ha()*H*Math.sqrt(y);Math.random()<.0025*y&&(A+=(Math.random()<.5?1:-1)*(.006+Math.random()*.018)*(h?1:.6)),k=k*(1+A),k=c+(k-c)*Math.exp(-.01*y),k=hs(k,yi(c),vi(c)),k=Math.max(Be,k),T=Math.max(T,k),b=Math.min(b,k)}const M=ke(k),N=_?Math.abs((M-_)/_):0,g=(400+Math.random()*1800)*a*(1+u*.8),C=Math.round(g*r*(1+N*8));v.push({t:E,o:ke(_),h:ke(T),l:ke(b),c:M,v:C}),l=M}return{candles:v,finalPrice:l,finalBase:c}}function fv(n){const e={};for(const t of Vs)e[t.key]={};for(const t of n)for(const s of Vs){const i=_r(t.t,s.win),r=e[s.key],o=r[i];o?(o.h=Math.max(o.h,t.h),o.l=Math.min(o.l,t.l),o.c=t.c,o.v+=t.v):r[i]={t:i,o:t.o,h:t.h,l:t.l,c:t.c,v:t.v}}return e}async function pv(n,e){const t=Date.now();return(await le($(x,`rooms/${n}/market/catchupLock`),i=>{if(!(i&&i.expiresAt&&i.expiresAt>t))return{by:e||"anon",at:t,expiresAt:t+uv}})).committed}async function mv(n){try{await ot($(x,`rooms/${n}/market`),{catchupLock:null})}catch{}}function gv(n){if(!n||n.status!=="playing")return!1;const e=n.market&&n.market.lastTickAt||n.marketTick||0;return e?Date.now()-e>=_u:!1}async function _v(n,e,t,s={}){if(!e||!e.stocks)return{applied:!1,reason:"no-stocks"};if(e.status!=="playing")return{applied:!1,reason:"not-playing"};const i=Date.now(),r=e.market&&e.market.lastTickAt||e.marketTick||0,o=i-r;if(!s.force&&o<_u)return{applied:!1,reason:"fresh",elapsed:o};if(!await pv(n,t)&&!s.force)return{applied:!1,reason:"locked"};try{let c=e.stocks||{};try{const v=await Bn($(x,`rooms/${n}/stocks`));v.exists()&&(c=v.val())}catch{}const l=Object.keys(c);if(!l.length)return{applied:!1,reason:"no-stocks"};const d=hs(Math.round(dv/l.length),30,480),u=Math.max(1,Math.round(o/6e4)),h=Math.min(d,u,480),p={};let m=0;for(const v of l){const I=c[v];if(!I||typeof I.price!="number")continue;const E=hv(I,r,i,h),_=fv(E.candles),y=`stocks/${v}/`,T=I.history||{};for(const N of Vs){const C={...T[N.key]||{}};for(const[A,z]of Object.entries(_[N.key])){const Z=C[A];C[A]=Z?{t:z.t,o:Z.o,h:Math.max(Z.h,z.h),l:Math.min(Z.l,z.l),c:z.c,v:(Z.v||0)+z.v}:z}const S=Object.keys(C).map(Number).sort((A,z)=>A-z),H=S.length-N.cap;if(H>0)for(let A=0;A<H;A++)p[y+`history/${N.key}/${S[A]}`]=null;for(const[A,z]of Object.entries(_[N.key]))Number(A)<S[Math.max(0,H)]||(p[y+`history/${N.key}/${A}`]=C[A],m++)}const b=E.finalBase,k=Math.max(Be,ke(E.finalPrice)),M=E.candles.reduce((N,g)=>N+(g.v||0),0);p[y+"previousPrice"]=I.price,p[y+"price"]=k,p[y+"currentPrice"]=k,p[y+"changeRate"]=+((k-b)/b*100).toFixed(2),p[y+"volume"]=(I.volume||0)+M,p[y+"value"]=(I.value||0)+M*k,k>(I.high||I.price)&&(p[y+"high"]=k),k<(I.low||I.price)&&(p[y+"low"]=k),I.heat&&(p[y+"heat"]=0),I.pressure&&(p[y+"pressure"]=0)}return p["market/tickMs"]=4e3,p["market/lastTickAt"]=i,p["market/lastHistoryAt"]=i,p["market/lastCatchupAt"]=i,p["market/catchupVersion"]=lv,p["market/catchupBy"]=t||"anon",p["market/catchupLock"]=null,p.marketTick=i,await ot($(x,`rooms/${n}`),p),{applied:!0,elapsed:o,numSteps:h,candlesWritten:m,stocks:l.length}}catch(c){return await mv(n),console.error("[catchup] 실패:",c),{applied:!1,reason:"error",error:c==null?void 0:c.message}}}function vv(){return{cur:{},lastBucket:0,seeded:!1}}async function yv(n,e,t){const s=e.stocks||{},i=Date.now(),r=_r(i,6e4);t.lastBucket||(t.lastBucket=r);for(const[d,u]of Object.entries(s)){if(!u||typeof u.price!="number")continue;let h=t.cur[d];(!h||h.t!==r)&&(h={t:r,o:u.price,h:u.price,l:u.price,c:u.price,v:0,_lastVol:u.volume||0},t.cur[d]=h),h.c=u.price,h.h=Math.max(h.h,u.price),h.l=Math.min(h.l,u.price);const p=Math.max(0,(u.volume||0)-(h._lastVol||0));h.v+=p,h._lastVol=u.volume||0}if(r===t.lastBucket)return;const o=t.lastBucket;let a=s;try{const d=await Bn($(x,`rooms/${n}/stocks`));d.exists()&&(a=d.val())}catch{}const c={};let l=!1;for(const d of Object.keys(s)){const u=t.cur[d];if(!u)continue;const h={o:u.o,h:u.h,l:u.l,c:u.c,v:u.v},p=`stocks/${d}/`,m=a[d]&&a[d].history||{};for(const v of Vs){const I=_r(o,v.win),E=m[v.key]&&m[v.key][I]||null,_=E?{t:I,o:E.o,h:Math.max(E.h,h.h),l:Math.min(E.l,h.l),c:h.c,v:(E.v||0)+h.v}:{t:I,o:h.o,h:h.h,l:h.l,c:h.c,v:h.v};c[p+`history/${v.key}/${I}`]=_;const y=m[v.key]?Object.keys(m[v.key]).map(Number).sort((T,b)=>T-b):[];y.length>v.cap&&y[0]!==I&&(c[p+`history/${v.key}/${y[0]}`]=null)}l=!0}if(t.lastBucket=r,!!l){c["market/lastTickAt"]=i,c["market/lastHistoryAt"]=i,c["market/tickMs"]=4e3;try{await ot($(x,`rooms/${n}`),c)}catch(d){console.warn("[history] 라이브 캔들 저장 실패:",d==null?void 0:d.message)}}}function vu(n,e){if(n&&String(n).startsWith("ipo"))return'<span class="tag tag-new">NEW</span>';const t=_i(e.type);return t?`<span class="tag ${e.type==="inverse"?"tag-inv":e.type==="leverage"?"tag-lev":"tag-etf"}">${t}</span>`:e.role==="leader"?'<span class="tag tag-leader">대장주</span>':e.role==="sub"?'<span class="tag tag-sub">부대장</span>':""}function R(n){return document.getElementById(n)}function Ot(n){return Math.round(n??0).toLocaleString("ko-KR")+"원"}function D(n){return Math.round(n??0).toLocaleString("ko-KR")}function Ct(n){return n=n||0,n>=1e12?(n/1e12).toFixed(2)+"조":n>=1e8?(n/1e8).toFixed(1)+"억":n>=1e4?Math.round(n/1e4).toLocaleString("ko-KR")+"만":D(n)}function bv(n){return D(n)+"주"}const wv=["screen-auth","screen-wait","screen-game","screen-result"];function Eo(n){wv.forEach(e=>{const t=R(e);t&&t.classList.toggle("hidden",e!==n)})}function Ev(n,e,t=!0){const s=R(n);s&&(s.textContent="",s.classList.toggle("error",t))}function yu(n){R("fbError").classList.remove("hidden"),n&&(R("fbErrorMsg").textContent=n)}const Iv=3,kv=120,Va=60;let Re={},Tn=[],Ve={},xt=0,Hn=null,vr={};function bu(){Re={},Tn=[],Ve={},xt=0,Hn=null,vr={},zs="";for(const n in qs)delete qs[n]}function Cv(){if(Hn)try{localStorage.setItem(Hn,JSON.stringify({candles:Re,lastVol:Ve,tick:xt}))}catch{}}function Sv(n,e){const t=n.stocks||{},s=n.marketTick||0,i=`mb_candles_${e||"x"}_${n.startedAt||0}`;if(i!==Hn){Hn=i,Re={},Ve={},xt=0;try{const r=JSON.parse(localStorage.getItem(i)||"null");r&&r.candles&&(Re=r.candles,Ve=r.lastVol||{},xt=r.tick||0)}catch{}}for(const[r,o]of Object.entries(t))Re[r]||(Re[r]=[{t:Date.now(),o:o.price,h:o.price,l:o.price,c:o.price,v:0,_n:0}]),Ve[r]==null&&(Ve[r]=o.volume||0);if(s!==xt){xt=s;for(const[o,a]of Object.entries(t)){const c=Re[o]||(Re[o]=[]);let l=c[c.length-1];(!l||l._n>=Iv)&&(l={t:Date.now(),o:a.price,h:a.price,l:a.price,c:a.price,v:0,_n:0},c.push(l)),l.c=a.price,l.h=Math.max(l.h,a.price),l.l=Math.min(l.l,a.price);const d=Math.max(0,(a.volume||0)-(Ve[o]||0));l.v+=d,Ve[o]=a.volume||0,l._n++,c.length>kv&&c.shift()}const r=n.botFeed?Object.values(n.botFeed):[];for(const o of r)Tn.unshift({...o,bot:!0});Tn.length>Va&&(Tn.length=Va),Av(t),ay(t),Cv()}}let Dt=new Set(JSON.parse(localStorage.getItem("mb_watch")||"[]")),_t=JSON.parse(localStorage.getItem("mb_alerts")||"{}");function Tv(n){Dt.has(n)?Dt.delete(n):Dt.add(n),localStorage.setItem("mb_watch",JSON.stringify([...Dt]))}function Rv(n,e){e>0?_t[n]=e:delete _t[n],localStorage.setItem("mb_alerts",JSON.stringify(_t))}function Nv(n){return _t[n]||0}function Av(n){for(const e of Object.values(n)){const t=_t[e.name],s=vr[e.name];if(t&&s!=null){const i=s<t&&e.price>=t,r=s>t&&e.price<=t;if(i||r){O(`🔔 ${e.name} 알림가 ${D(t)}원 ${i?"돌파":"하향"}!`,i?"up":"down"),delete _t[e.name],localStorage.setItem("mb_alerts",JSON.stringify(_t));try{window.Notification&&Notification.permission==="granted"&&new Notification("STONK Battle",{body:`${e.name} ${D(t)}원 도달`})}catch{}}}vr[e.name]=e.price}}function Pv(n){const{roomCode:e,roomData:t,uid:s,selectedStockId:i}=n,r=R("gameRoomCode");r&&(r.textContent=e),Sv(t,e),Mv(t,s),Jv(t,s),ey(t,s),ny(t),xv(t,s),wu(n),ty(t);const o=Fv();o==="home"?(cy(t),Hv(t)):o==="detail"?(Wv(t,i),Yv(t,i),Ov(t,s)):o==="feed"?uy(t):o==="screener"?dy(t):o==="account"&&hy(t,s)}function Mv(n,e){var o;const t=(o=n.players)==null?void 0:o[e],s=t&&t.nickname||"나",i=R("navNick");i&&(i.textContent=s);const r=R("navAvatar");r&&(r.textContent=s.slice(0,1).toUpperCase())}function wu(n){const e=n.roomData,t=R("marketStatusChip"),s=R("msDot"),i=R("msLabel"),r=R("marketStatusPanel");if(!e||!t||!s||!i||!r)return;const o=e.market||{},a=o.lastTickAt||e.marketTick||0,c=o.lastCatchupAt||0,l=a?Math.max(0,Math.round((Date.now()-a)/6e4)):null,d=e.hostId===n.uid;let u=0,h=0,p=0,m=0;for(const y of Object.values(e.stocks||{})){const T=y.history;T&&(T.candles1m&&(u+=Object.keys(T.candles1m).length),T.candles5m&&(h+=Object.keys(T.candles5m).length),T.candles15m&&(p+=Object.keys(T.candles15m).length),T.candles1h&&(m+=Object.keys(T.candles1h).length))}const v=u+h+p+m>0,I=l!=null&&l<2;if(s.className="status-dot "+(I?"ok":l==null?"muted":"warn"),i.textContent=I?"시장 최신":l==null?"대기":`${l}분 전`,r.classList.contains("hidden"))return;const E=y=>y?`${vt(new Date(y).getHours())}:${vt(new Date(y).getMinutes())}`:"-",_=(y,T,b)=>`<div class="ms-row"><span>${y}</span><b class="${b||""}">${T}</b></div>`;r.innerHTML=_("방 코드",V(n.roomCode||"-"))+_("연결","연결됨","up")+_("권한",d?"보정 주체 (방장)":"읽기 전용",d?"":"muted")+_("마지막 tick",E(a))+_("마지막 보정",c?E(c):"없음")+_("시장",I?"최신 상태":l==null?"tick 기록 없음":`${l}분 전 데이터 · ${d?"재접속 시 자동 보정":"방장/관리자가 보정"}`,I?"up":"down")+_("캔들",v?`1m ${u} · 5m ${h} · 15m ${p} · 1h ${m}`:"아직 없음")}function Ov(n,e){const t=R("orderList");if(!t)return;const s=cv(n,e);if(!s.length){t.innerHTML="";return}t.innerHTML=s.map(i=>{const r=i.side==="buy"?"up":"down",o=i.tif==="day"?" · 당일":i.tif==="ioc"?" · IOC":"",a=i.label||(i.side==="buy"?"매수":"매도");return`<li class="order-item">
      ...
      </li>`}).join("")}let js=0;function xv(n,e){var r;const t=R("ipoPanel");if(!t)return;const s=n.ipo;if(!s||s.status!=="subscribing"){t.classList.add("hidden"),js=0;return}js=s.endsAt,t.classList.remove("hidden"),R("ipoName").textContent=s.name,R("ipoPrice").textContent=D(s.offerPrice)+"원",R("ipoShares").textContent=D(s.totalShares)+"주",R("ipoRatio").textContent=rv(s).toFixed(1)+" : 1";const i=((r=s.applies)==null?void 0:r[e])||0;R("ipoMyApply").textContent=i?`내 청약 ${D(i)}주 (증거금 ${Ct(i*s.offerPrice)}원)`:"아직 청약하지 않았어요",Eu()}function Eu(n){const e=R("ipoCountdown");if(!e||!js)return;const t=Math.max(0,Math.ceil((js-Date.now())/1e3));e.textContent=t+"초",e.classList.toggle("urgent",t<=5)}function ct(n){return n>0?"up":n<0?"down":"flat"}function Zn(n){return n>0?"▲":n<0?"▼":"−"}let Gs="";function Bi(n){Gs=(n||"").trim().toLowerCase()}let Iu="all",ku="value",yr="rising",fs="asset";function Dv(n){Iu=n||"all"}function ja(n){ku=n||"value"}function Lv(n){yr=n||"rising"}function $v(n){fs=n||"asset"}function Fv(){var n;return((n=document.getElementById("screen-game"))==null?void 0:n.dataset.tab)||"home"}function Uv(n,e){return Gs?[e.name,n,e.ticker,e.sector,e.type,e.role,_i(e.type),hu(e.role),String(n).startsWith("ipo")?"신규상장 new":""].join(" ").toLowerCase().includes(Gs):!0}function Bv(n){let e=0;const t=String(n);for(let s=0;s<t.length;s++)e=e*31+t.charCodeAt(s)>>>0;return 5e6+e%60*8e6}function Cu(n){let e=0;const t=String(n||"");for(let s=0;s<t.length;s++)e=e*31+t.charCodeAt(s)>>>0;return`hsl(${e%360} 60% 47%)`}function Su(n,e){const t={value:(s,i)=>(i[1].value||0)-(s[1].value||0),volume:(s,i)=>(i[1].volume||0)-(s[1].volume||0),up:(s,i)=>(i[1].changeRate||0)-(s[1].changeRate||0),down:(s,i)=>(s[1].changeRate||0)-(i[1].changeRate||0)};return n.sort(t[e]||t.value)}function Tu(n,e,t){const s=t.changeRate>0?"+":"",i=ct(t.changeRate),r=Dt.has(t.name),o=t.price*Bv(e),a=t.sector||_i(t.type)||"종목";return`<li class="rank-item" data-id="${e}">
    ...
    <span class="rk-rate ${i}">${Zn(t.changeRate)} ${s}${(t.changeRate??0).toFixed(2)}%</span>
  ...
  `,document.body.appendChild(o),(c=o.querySelector("[data-home-go]"))==null||c.addEventListener("click",l=>{l.preventDefault(),location.href=i}),a){let l=Math.ceil(ji/1e3);const d=o.querySelector("[data-gate-count]"),u=setInterval(()=>{l-=1,d&&(d.textContent=String(Math.max(0,l))),l<=0&&clearInterval(u)},1e3);setTimeout(()=>{location.href=i},ji)}return o}function Sy(){var n;(n=document.getElementById("stonk-home-gate"))==null||n.remove()}const Ty="https://tom981105-web.github.io/STONK-Gacha/backgrounds/";let ms,Ie=null;function Ry(){return Ie||(Ie=document.createElement("div"),Ie.id="equip-bg",Object.assign(Ie.style,{position:"fixed",inset:"0",zIndex:"-1",backgroundSize:"cover",backgroundPosition:"center",backgroundRepeat:"no-repeat",pointerEvents:"none",opacity:"0",transition:"opacity 0.35s ease",transform:"translateZ(0)",backfaceVisibility:"hidden"}),document.body.appendChild(Ie),Ie)}function nc(){if(document.body.classList.remove("has-skin"),Ie){Ie.style.opacity="0";const n=Ie;setTimeout(()=>{ms===null&&n&&(n.style.backgroundImage="")},400)}}function Ny(n,e){let t=0;const s=()=>{if(t>=n.length){e(null);return}const i=n[t++],r=new Image;r.decoding="async",r.onload=()=>e(i),r.onerror=s,r.src=i};s()}function Ay(n){const e=n||null;if(e===ms)return;if(ms=e,!e){nc();return}const t=["webp","jpg","png"].map(s=>`${Ty}${e}.${s}`);Ny(t,s=>{if(ms!==e)return;if(!s){nc();return}const i=Ry();i.style.backgroundImage=`radial-gradient(120% 90% at 50% 12%, rgba(10,12,20,0.30) 0%, rgba(8,10,16,0.52) 55%, rgba(6,7,12,0.74) 100%), url("${s}")`,i.style.opacity="1",document.body.classList.add("has-skin")})}const Py="yaV8N60yIiUggaWNpNF2VhkCwxb2",My="tomem@naver.com",Oe="MAIN",f={uid:null,email:null,nickname:localStorage.getItem("mb_nickname")||localStorage.getItem("stonk:lastNickname")||"",roomCode:null,roomData:null,selectedStockId:null,tickTimer:null,isDriver:!1,tickLeaseRenewAt:0,driverWatch:null,liveState:vv(),catchupDoneFor:null,clockTimer:null,roomRef:null,lastStatus:null,histRef:null,histStockId:null,selectedHistory:null,renderQueued:!1,joinReqRef:null,joinReqId:null,isDbAdmin:!1,bank:0,bankRef:null},Ks=.05,Oy=15e3,xy=5e3,Dy=4e3;function Ly(){return f.uid===Py||(f.email||"").toLowerCase()===My}!uu||!yo||!x?yu("src/firebase.js 에 본인의 Firebase 설정(firebaseConfig)을 붙여넣은 뒤 새로고침하세요."):$y();function $y(){let n=!1;const e=setTimeout(()=>{n||yu("Firebase에 연결할 수 없습니다. 설정값과 네트워크, Database Rules를 확인하세요.")},5e3);dn($(x,".info/connected"),t=>{t.val()===!0&&(n=!0,clearTimeout(e),document.getElementById("fbError").classList.add("hidden"))}),Fy()}let rs=null;function Fy(){dn($(x,`rooms/${Oe}/broadcast/reloadAt`),n=>{const e=Number(n.val())||0;if(rs===null){rs=e;return}if(e>rs){rs=e;try{O==null||O("새 버전이 배포되어 새로고침합니다…","up")}catch{}setTimeout(()=>location.reload(),400)}}),vf(yo,n=>{if(n)Sy(),f.uid=n.uid,f.email=n.email||null,localStorage.setItem("mb_playerId",n.uid),Uy(),By();else{f.uid=null,f.email=null,f.isDbAdmin=!1;const e=document.getElementById("navAdmin");e&&(e.hidden=!0),Cy({message:"로그인은 STONK Home에서 진행합니다. Home에서 입장하면 자동으로 연결됩니다."})}})}async function Uy(){const n=document.getElementById("navAdmin");if(!n)return;let e=Ly();if(!e&&f.uid&&x)try{e=(await Bn($(x,"admins/"+f.uid))).val()===!0}catch{e=!1}f.isDbAdmin=e,n.hidden=!e}async function By(){if(!f.nickname){Eo("screen-auth");return}Gu(Oe)}let Gi=!1;async function Hy(n){var i;if(!f.uid)return!1;const e=n.players&&n.players[f.uid];if(e&&e.cash!=null)return!0;if(Gi)return!1;Gi=!0;const t=Number((i=n.settings)==null?void 0:i.initialCash)||Wt,s=Date.now();try{await ot($(x,`rooms/${Oe}/players/${f.uid}`),{nickname:f.nickname&&f.nickname.trim()||"플레이어-"+String(f.uid).slice(-4),cash:t,holdings:null,totalAsset:t,joinedAt:s,connected:!0})}catch(r){return console.warn("[join] 자동 등록 실패:",r),!1}finally{Gi=!1}return!0}function ju(){f.joinReqId=null}function Gu(n){ju(),f.roomCode=n,localStorage.setItem("mb_roomCode",n),$u(n),r0(n);const e=$(x,`rooms/${n}/players/${f.uid}/connected`);un(e,!0).catch(()=>{}),x_(e).set(!1).catch(()=>{}),f.roomRef&&gi(f.roomRef),f.roomRef=$(x,`rooms/${n}`),dn(f.roomRef,t=>Xy(qy(t)),t=>{console.error("[room] 구독 오류:",t)}),Wy()}function Wy(){f.uid&&(f.bankRef&&gi(f.bankRef),f.bankRef=$(x,`rooms/${Oe}/bank/${f.uid}/balance`),ot($(x,`rooms/${Oe}/bank/${f.uid}`),{nickname:f.nickname||"플레이어-"+String(f.uid).slice(-4)}).catch(()=>{}),dn(f.bankRef,n=>{f.bank=Number(n.val()||0),Qv(f.bank),de()},()=>{}),Bn($(x,`rooms/${Oe}/bankEvents/current`)).then(n=>{const e=n.val();e&&e.manual&&(!e.expiresAt||Number(e.expiresAt)>Date.now())&&e.title?f.bankEvent=e.title:f.bankEvent=null;const t=document.getElementById("bankBadge");if(t&&!t.hidden&&f.bankEvent&&!t.querySelector(".bb-evt")){const s=document.createElement("span");s.className="bb-vip bb-evt",s.textContent="📰 "+f.bankEvent,t.appendChild(s)}}).catch(()=>{}),Bn($(x,`rooms/${Oe}/bank/${f.uid}`)).then(n=>{const e=n.val()||{};f.bankLoanOwe=Number(e.loanPrincipal||0)+Number(e.loanInterest||0),f.bankCardOverdue=!!(e.card&&e.card.overdue),f.bankCardUsed=Number(e.card&&e.card.usedAmount||0),Gy(Number(e.creditScore),f.bankLoanOwe,e.vipTier||"NORMAL",e.card||null)}).catch(()=>{}))}function Vy(n){return n=Math.max(0,Math.min(100,Math.round(isFinite(n)?n:60))),n>=90?"S":n>=75?"A":n>=55?"B":n>=35?"C":n>=15?"D":"F"}const jy={NORMAL:"일반",SILVER:"실버",GOLD:"골드",PLATINUM:"플래티넘",BLACK:"블랙"};function Gy(n,e,t,s){const i=document.getElementById("bankBadge");if(!i)return;const r=Vy(n);e=Math.max(0,Math.round(e||0));const o=e>5e6,a=t==="BLACK",c=!!(s&&s.overdue),l=Number(s&&s.usedAmount||0);i.hidden=!1,i.className="bank-badge"+(e>0||c?" danger":"")+(o||c?" danger-strong":"")+(a?" black":""),i.innerHTML=`<span class="bb-grade g-${r}">신용 ${r}</span>`+(t!=="NORMAL"?`<span class="bb-vip v-${t}">VIP ${jy[t]||t}</span>`:"")+(e>0?`<span class="bb-loan">대출 ${e.toLocaleString("ko-KR")}원${o?" · 상환 시급!":" · 상환 필요"}</span>`:'<span class="bb-ok">대출 없음</span>')+(c?'<span class="bb-loan">💳 카드 미납!</span>':s&&s.enabled&&l>0?`<span class="bb-vip">💳 카드 사용 ${l.toLocaleString("ko-KR")}원</span>`:"")+(f.bankEvent?`<span class="bb-vip bb-evt">📰 ${String(f.bankEvent).replace(/[<>&]/g,"")}</span>`:""),i.onclick=()=>{location.href=To(Oe)}}function qy(n){if(!n||!n.exists())return null;const e={};return n.forEach(t=>{if(t.key==="stocks"){const s={};t.forEach(i=>{const r={};i.forEach(o=>{o.key!=="history"&&(r[o.key]=o.val())}),s[i.key]=r}),e.stocks=s}else e[t.key]=t.val()}),e}function zy(n){const e=f.selectedHistory;e&&e.id&&n&&n.stocks&&n.stocks[e.id]&&(n.stocks[e.id].history=e.data||null)}function Ys(n){n!==f.histStockId&&(f.histRef&&(gi(f.histRef),f.histRef=null),f.histStockId=n||null,f.selectedHistory=n?{id:n,data:null}:null,!(!n||!f.roomCode)&&(f.histRef=$(x,`rooms/${f.roomCode}/stocks/${n}/history`),dn(f.histRef,e=>{f.histStockId===n&&(f.selectedHistory={id:n,data:e.val()||null},f.roomData&&f.roomData.stocks&&f.roomData.stocks[n]&&(f.roomData.stocks[n].history=f.selectedHistory.data),de())},e=>console.error("[history] 구독 오류:",e))))}function de(){f.renderQueued||(f.renderQueued=!0,requestAnimationFrame(()=>{f.renderQueued=!1,f.roomData&&f.roomData.status==="playing"&&Pv(f)}))}function qu(n){const e=n==="dark"?"dark":"light";document.documentElement.dataset.theme=e;try{localStorage.setItem("stonk:theme",e)}catch{}const t=document.getElementById("themeToggle");t&&(t.textContent=e==="dark"?"☀️":"🌙")}function Ky(){let n="light";try{n=localStorage.getItem("stonk:theme")||"light"}catch{}qu(n)}function Yy(){qu(document.documentElement.dataset.theme==="dark"?"light":"dark")}function bn(n){const e=document.getElementById("screen-game");e&&(e.dataset.tab=n,document.querySelectorAll(".tnav-tab").forEach(t=>t.classList.toggle("is-active",t.dataset.tab===n)),document.querySelectorAll(".tab-view").forEach(t=>t.classList.toggle("hidden",t.dataset.view!==n)),n==="detail"&&Io(),f.roomData&&de())}function Qy(n){n&&(ko(),f.selectedStockId=n,Ys(n),o0(n),bn("detail"))}let qi=null,gs=null;function Jy(n){const e=document.getElementById("stockHover");if(!e)return;const t=e.offsetWidth||300,s=e.offsetHeight||240;let i=n.right+12;i+t>window.innerWidth-8&&(i=n.left-t-12),i<8&&(i=8);let r=n.top;r+s>window.innerHeight-8&&(r=window.innerHeight-s-8),r<8&&(r=8),e.style.left=i+"px",e.style.top=r+"px"}function sc(n){const e=document.getElementById(n);e&&(e.addEventListener("mouseover",t=>{const s=t.target.closest(".rank-item");if(!s||!f.roomData)return;const i=s.dataset.id;i!==gs&&(clearTimeout(qi),qi=setTimeout(()=>{gs=i,fy(f.roomData,i),Jy(s.getBoundingClientRect())},90))}),e.addEventListener("mouseleave",()=>{clearTimeout(qi),gs=null,ko()}))}function Xy(n){if(!n){De(),Er(),Js(),f.roomData=null,f.lastStatus=null,ic();return}if(f.roomData=n,zy(n),Ay(n.players&&f.uid&&n.players[f.uid]?n.players[f.uid].equippedBackground:null),n.status==="playing"){if(f.uid&&!(n.players&&n.players[f.uid])){Hy(n);return}if(f.lastStatus!=="playing"){Eo("screen-game"),bu(),i0();const e=Object.keys(n.stocks||{});!f.selectedStockId&&e.length&&(f.selectedStockId=e[0])}f.selectedStockId!==f.histStockId&&Ys(f.selectedStockId),de(),Zy(n),Ku(n),s0()}else De(),Er(),Js(),Ys(null),Io(),ic();f.lastStatus=n.status}function ic(){Eo("screen-wait");const n=document.getElementById("waitNickname");n&&(n.textContent=f.nickname?`${f.nickname} 님`:"")}async function Zy(n){if(!n||n.status!=="playing"||!f.uid||f.catchupDoneFor===f.roomCode)return;if(!wi(n)){f.catchupDoneFor=f.roomCode;return}const e=n.market&&n.market.lastTickAt||n.marketTick||0;if(e&&e<e0(n)){f.catchupDoneFor=f.roomCode;try{await un($(x,`rooms/${f.roomCode}/market/lastTickAt`),Date.now())}catch{}return}if(!gv(n)){f.catchupDoneFor=f.roomCode;return}f.catchupDoneFor=f.roomCode;try{const t=await _v(f.roomCode,n,f.uid);t.applied&&(bu(),O(`시장 경과 보정 완료 (${Math.round(t.elapsed/6e4)}분, 캔들 ${t.candlesWritten}개)`,"up"))}catch(t){console.warn("[catchup] 보정 실패:",t)}}async function zu(){if(!f.roomCode||!f.uid)return!1;const n=Date.now();try{return(await le($(x,`rooms/${f.roomCode}/market/tickLease`),t=>{if(!(t&&t.by!==f.uid&&(t.expiresAt||0)>n))return{by:f.uid,at:n,expiresAt:n+Oy}})).committed}catch{return!1}}function Qs(n){const e=n&&n.market||{};let t=Number.isFinite(e.openHour)?Math.round(e.openHour):18,s=Number.isFinite(e.closeHour)?Math.round(e.closeHour):24;return t=Math.max(0,Math.min(24,t)),s=Math.max(0,Math.min(24,s)),{oh:t,ch:s}}function wi(n){const{oh:e,ch:t}=Qs(n);if(e===t)return!0;const s=new Date().getHours();return t>e?s>=e&&s<t:s>=e||s<t}function e0(n){const{oh:e,ch:t}=Qs(n),s=new Date,i=new Date(s.getFullYear(),s.getMonth(),s.getDate(),e,0,0,0).getTime();return t>=e?i:s.getHours()<t?i-864e5:i}async function Ku(n){if(n=n||f.roomData,!n||n.status!=="playing"){De();return}if(!wi(n)){De();return}if(!f.uid)return;const e=Date.now(),t=n.market&&n.market.tickLease,s=t&&t.by!==f.uid&&(t.expiresAt||0)>e;if(f.isDriver){s&&De();return}if(s)return;await zu()&&t0()}function t0(){f.tickTimer||(f.isDriver=!0,f.tickLeaseRenewAt=Date.now(),f.tickTimer=setInterval(async()=>{const n=f.roomData;if(!n||n.status!=="playing"){De();return}if(!wi(n)){De();return}try{if(Date.now()-f.tickLeaseRenewAt>=xy){if(!await zu()){De();return}f.tickLeaseRenewAt=Date.now()}await nv(f.roomCode,n),await sv(f.roomCode,n),await av(f.roomCode,n),await yv(f.roomCode,n,f.liveState)}catch(e){console.error("[tick] 시장 틱 오류:",e)}},gr))}function De(){f.tickTimer&&(clearInterval(f.tickTimer),f.tickTimer=null),f.isDriver=!1}async function n0(){if(!f.roomCode||!f.uid)return;const n=f.roomCode;try{await le($(x,`rooms/${n}/market/tickLease`),e=>e&&e.by===f.uid?null:e)}catch{}}function s0(){f.driverWatch||(f.driverWatch=setInterval(()=>{Ku(f.roomData)},Dy))}function Er(){f.driverWatch&&(clearInterval(f.driverWatch),f.driverWatch=null)}function i0(){Js(),f.clockTimer=setInterval(()=>{const n=f.roomData;if(!n||n.status!=="playing")return;const e=!wi(n),t=document.getElementById("marketClosed");t&&(t.classList.toggle("hidden",!e),e&&(t.textContent=`🌙 장 마감 — 매일 ${String(Qs(n).oh).padStart(2,"0")}:00 개장 (${String(Qs(n).ch%24).padStart(2,"0")}:00 마감)`)),!e&&(iy(Date.now()-(n.startedAt||Date.now())),Eu(),sy(n))},250)}function Js(){f.clockTimer&&(clearInterval(f.clockTimer),f.clockTimer=null)}function os(){n0(),De(),Er(),Js(),ju(),Io(),f.roomRef&&(gi(f.roomRef),f.roomRef=null),Ys(null),location.href=So()}function r0(n){const e="",t=(s,i)=>{const r=document.getElementById(s);r&&(r.href=i)};t("navHome",So(n)),t("navBoard",Uu(n)),t("navWiki",Bu(n,e)),t("navArcade",Hu(n)),t("navGacha",Wu(n)),t("navBank",To(n)),t("navAdmin",Vu(n))}async function rc(){if(!f.roomCode||!f.roomData){O("복사할 시장 데이터가 없습니다","err");return}const n={roomCode:f.roomCode,status:f.roomData.status,startedAt:f.roomData.startedAt||null,marketTick:f.roomData.marketTick||Date.now(),latestNews:f.roomData.latestNews||null,botFeed:f.roomData.botFeed||[],stocks:f.roomData.stocks||{},players:f.roomData.players||{},logs:f.roomData.logs||{}},e=JSON.stringify(n,null,2);try{await navigator.clipboard.writeText(e),O("STONK Board에 가져올 시장 데이터를 복사했습니다")}catch{prompt("STONK Board 관리자 화면에 붙여넣을 시장 데이터입니다:",e)}}function Vt(){return Math.max(1,Math.floor(Number(document.getElementById("qtyInput").value)||1))}async function zi(n){var a,c,l,d,u,h;const{roomCode:e,roomData:t,uid:s,nickname:i,selectedStockId:r}=f;if(!t||t.status!=="playing")return;if(!r){O("종목을 먼저 선택하세요","err");return}const o=((c=(a=t.stocks)==null?void 0:a[r])==null?void 0:c.name)||"";if(n==="buy"&&(f.bankLoanOwe||0)>0){const p=Number(((d=(l=t.stocks)==null?void 0:l[r])==null?void 0:d.price)||0),m=Number(((h=(u=t.players)==null?void 0:u[s])==null?void 0:h.cash)||0),v=p*Vt();m>0&&v>=m*.3&&O("⚠️ 대출 잔액이 있는 상태에서 큰 금액을 매수합니다. 무리한 매수는 신용에 영향을 줄 수 있어요.","down")}try{n==="buy"?(await bo(e,s,i,r,Vt(),t),O(`${o} 매수 체결!`,"up")):n==="sell"?(await bi(e,s,i,r,Vt(),t),O(`${o} 매도 체결!`,"down")):n==="sellAll"&&(await pu(e,s,i,r,t),O(`${o} 전량 매도 체결!`,"down")),Ev("tradeMsg","",!1)}catch(p){O(p.message,"err")}}function Xs(n){return Math.floor(Number(document.getElementById(n).value)||0)}function o0(n){var s,i,r;const e=(r=(i=(s=f.roomData)==null?void 0:s.stocks)==null?void 0:i[n])==null?void 0:r.price;if(!e)return;const t=(o,a)=>{const c=document.getElementById(o);c&&(c.value=a)};t("limitPrice",e),t("stopLoss",Math.round(e*.95)),t("takeProfit",Math.round(e*1.1))}async function oc(n){var l,d;const{roomCode:e,roomData:t,uid:s,nickname:i,selectedStockId:r}=f;if(!t||t.status!=="playing")return;if(!r)return O("종목을 먼저 선택하세요","err");const o=Xs("limitPrice");if(!o)return O("지정가를 입력하세요","err");const a=document.getElementById("limitTif").value,c=((d=(l=t.stocks)==null?void 0:l[r])==null?void 0:d.name)||"";try{await Ws(e,s,i,r,{side:n,trigger:n==="buy"?"below":"above",tif:a,label:"지정가"},Vt(),o,t),O(`${c} 지정가 ${n==="buy"?"매수":"매도"} 등록!`,n==="buy"?"up":"down")}catch(u){O(u.message,"err")}}async function a0(){var l,d,u,h,p;const{roomCode:n,roomData:e,uid:t,nickname:s,selectedStockId:i}=f;if(!e||e.status!=="playing")return;if(!i)return O("종목을 먼저 선택하세요","err");const r=((u=(d=(l=e.players)==null?void 0:l[t])==null?void 0:d.holdings)==null?void 0:u[i])||0;if(r<1)return O("보유한 종목에만 설정할 수 있어요","err");const o=Xs("stopLoss"),a=Xs("takeProfit");if(!o&&!a)return O("손절가 또는 익절가를 입력하세요","err");const c=((p=(h=e.stocks)==null?void 0:h[i])==null?void 0:p.name)||"";try{o&&await Ws(n,t,s,i,{side:"sell",trigger:"below",tif:"gtc",label:"손절"},r,o,e),a&&await Ws(n,t,s,i,{side:"sell",trigger:"above",tif:"gtc",label:"익절"},r,a,e),O(`${c} 손절·익절 설정 완료 (보유 ${r}주)`,"down")}catch(m){O(m.message,"err")}}async function c0(){var d,u,h,p;const{roomCode:n,roomData:e,uid:t,nickname:s,selectedStockId:i}=f;if(!e||e.status!=="playing")return;if(!i)return O("종목을 먼저 선택하세요","err");const r=Vt(),o=Math.max(2,Math.min(10,Xs("splitCount")||3)),a=((u=(d=e.stocks)==null?void 0:d[i])==null?void 0:u.price)||0;if(!a)return;const c=Math.floor(r/o);if(c<1)return O(`분할하려면 수량이 최소 ${o}주 이상이어야 해요`,"err");const l=((p=(h=e.stocks)==null?void 0:h[i])==null?void 0:p.name)||"";try{for(let m=0;m<o;m++){const v=Math.round(a*(1-m*.015));await Ws(n,t,s,i,{side:"buy",trigger:"below",tif:"gtc",label:`분할${m+1}`},c,v,e)}O(`${l} ${o}회 분할매수 등록! (회당 ${c}주)`,"up")}catch(m){O(m.message,"err")}}async function l0(n){try{await ov(f.roomCode,n),O("예약 주문 취소됨")}catch(e){O(e.message,"err")}}async function u0(){const{roomCode:n,roomData:e,uid:t}=f,s=e==null?void 0:e.ipo;if(!s||s.status!=="subscribing"){O("청약 가능한 공모주가 없습니다","err");return}const i=Math.max(1,Math.floor(Number(document.getElementById("ipoQty").value)||0));try{await iv(n,t,i,e),O(`${s.name} ${i.toLocaleString("ko-KR")}주 청약 완료!`,"up")}catch(r){O(r.message,"err")}}async function d0(){const n=f.nickname||"",e=prompt("사용할 닉네임을 입력하세요 (최대 10자)",n);if(e===null)return;const t=e.trim().slice(0,10);if(!t){O("닉네임을 입력하세요","err");return}f.nickname=t;try{localStorage.setItem("mb_nickname",t),localStorage.setItem("stonk:lastNickname",t)}catch{}try{f.uid&&f.roomCode&&await un($(x,`rooms/${f.roomCode}/players/${f.uid}/nickname`),t)}catch(s){console.warn("[nickname] 저장 실패:",s)}O(`닉네임을 '${t}'(으)로 변경했습니다`,"up")}async function h0(n,e,t){var c,l;const{roomCode:s,roomData:i,uid:r,nickname:o}=f;if(!i||i.status!=="playing")return;const a=((l=(c=i.stocks)==null?void 0:c[n])==null?void 0:l.name)||"";try{e==="buy"?(await bo(s,r,o,n,t,i),O(`${a} ${t}주 매수 체결!`,"up")):e==="sell"?(await bi(s,r,o,n,t,i),O(`${a} ${t}주 매도 체결!`,"down")):e==="all"&&(await pu(s,r,o,n,i),O(`${a} 전량 매도 체결!`,"down"))}catch(d){O(d.message,"err")}}function Yu({title:n,desc:e,value:t,confirm:s="확인",icon:i}){return new Promise(r=>{const o=document.createElement("div");o.className="bt-modal",o.innerHTML=`
      ...
      </div>`,document.body.appendChild(o);const a=o.querySelector(".bt-modal-input");setTimeout(()=>{a.focus(),a.select()},30);const c=l=>{o.remove(),r(l)};o.querySelector("[data-cancel]").addEventListener("click",()=>c(null)),o.querySelector(".bt-modal-dim").addEventListener("click",()=>c(null)),o.querySelector("[data-ok]").addEventListener("click",()=>c(a.value)),o.addEventListener("keydown",l=>{l.key==="Enter"?(l.preventDefault(),c(a.value)):l.key==="Escape"&&c(null)})})}const jt=n=>Math.round(Number(n)||0).toLocaleString("ko-KR");async function f0(){var o,a;const{roomCode:n,roomData:e,uid:t}=f;if(!e||!t)return;const s=((a=(o=e.players)==null?void 0:o[t])==null?void 0:a.cash)||0;if(s<1){O("환전할 현금이 없습니다","err");return}const i=await Yu({title:"채우기 (시장 → 금고)",icon:"🏦",desc:`시장 현금을 금고에 넣습니다. 수수료 ${Ks*100}% · 보유 현금 ${jt(s)}원`,value:s,confirm:"넣기"});if(i==null)return;const r=Math.floor(Number(i)||0);if(!r||r<1){O("금액을 확인하세요","err");return}try{if(!(await le($(x,`rooms/${n}/players/${t}/cash`),d=>{if(d=Number(d)||0,!(d<r))return d-r})).committed){O("현금이 부족합니다","err");return}const l=Math.floor(r*(1-Ks));await le($(x,`rooms/${n}/bank/${t}/balance`),d=>(Number(d)||0)+l),O(`금고로 ${jt(l)}원 환전 완료 (수수료 ${jt(r-l)}원)`,"up")}catch(c){O("환전 실패: "+c.message,"err")}}async function p0(){const{roomCode:n,uid:e}=f;if(!e)return;const t=f.bank||0;if(t<1){O("금고 잔액이 없습니다. 먼저 환전(빼오기) 하세요","err");return}const s=await Yu({title:"환전 (금고 → 시장)",icon:"💵",desc:`금고에서 빼서 시장 현금으로 넣습니다. 수수료 ${Ks*100}% · 금고 잔액 ${jt(t)}원`,value:t,confirm:"빼기"});if(s==null)return;const i=Math.floor(Number(s)||0);if(!i||i<1){O("금액을 확인하세요","err");return}try{if(!(await le($(x,`rooms/${n}/bank/${e}/balance`),a=>{if(a=Number(a)||0,!(a<i))return a-i})).committed){O("금고 잔액이 부족합니다","err");return}const o=Math.floor(i*(1-Ks));await le($(x,`rooms/${n}/players/${e}/cash`),a=>(Number(a)||0)+o),O(`시장 현금 ${jt(o)}원 충전 완료 (수수료 ${jt(i-o)}원)`,"up")}catch(r){O("채우기 실패: "+r.message,"err")}}function m0(){var o,a,c,l,d,u,h,p,m,v,I,E,_,y,T,b,k,M,N;(o=document.querySelector(".tnav-acct"))==null||o.addEventListener("click",d0);const n=document.getElementById("holdingsList");n&&(n.addEventListener("click",g=>{var pe,ge,Nt,lt,hn,Ro;const C=g.target.closest("[data-holdtoggle]");if(C){Zv(C.dataset.holdtoggle),de();return}const S=g.target.closest(".hold-trade");if(!S)return;const H=S.dataset.trade,A=S.querySelector(".ht-input"),z=g.target.closest("[data-htq]");if(z){const es=z.dataset.htq;if(es==="max"){const fn=(Nt=(ge=(pe=f.roomData)==null?void 0:pe.stocks)==null?void 0:ge[H])==null?void 0:Nt.price,Qu=((Ro=(hn=(lt=f.roomData)==null?void 0:lt.players)==null?void 0:hn[f.uid])==null?void 0:Ro.cash)||0;if(fn){const No=Math.max(1,Math.floor(Qu/(fn*1.0002)));Wi(No),A&&(A.value=No)}}else{const fn=Math.max(1,Math.floor(Number(A==null?void 0:A.value)||1)+Number(es));Wi(fn),A&&(A.value=fn)}return}const Z=g.target.closest("[data-ht]");if(Z){const es=Math.max(1,Math.floor(Number(A==null?void 0:A.value)||1));h0(H,Z.dataset.ht,es)}}),n.addEventListener("input",g=>{g.target.classList.contains("ht-input")&&Wi(g.target.value)})),(a=document.getElementById("btnNickname"))==null||a.addEventListener("click",()=>{const g=document.getElementById("nicknameInput").value.trim();g&&(f.nickname=g,localStorage.setItem("mb_nickname",g),Gu(Oe))}),(c=document.getElementById("nicknameInput"))==null||c.addEventListener("keydown",g=>{g.key==="Enter"&&document.getElementById("btnNickname").click()}),(l=document.getElementById("btnWaitHome"))==null||l.addEventListener("click",os),(d=document.getElementById("btnCopyCode2"))==null||d.addEventListener("click",rc),(u=document.getElementById("btnCopyMarketBoard"))==null||u.addEventListener("click",rc),(h=document.getElementById("btnLeaveGame"))==null||h.addEventListener("click",os);const e=g=>{const C=g.target.closest("[data-star]");if(C){g.stopPropagation(),Tv(C.dataset.star),de();return}const S=g.target.closest(".rank-item");S&&Qy(S.dataset.id)};(p=document.getElementById("stockList"))==null||p.addEventListener("click",e),(m=document.getElementById("screenerList"))==null||m.addEventListener("click",e),sc("stockList"),sc("screenerList"),window.addEventListener("scroll",()=>{gs=null,ko()},!0),Ky(),(v=document.getElementById("themeToggle"))==null||v.addEventListener("click",Yy),(I=document.querySelector(".tnav-brand"))==null||I.addEventListener("click",()=>bn("home")),(E=document.getElementById("tnavTabs"))==null||E.addEventListener("click",g=>{const C=g.target.closest(".tnav-tab");C&&bn(C.dataset.tab)}),(_=document.getElementById("btnDetailBack"))==null||_.addEventListener("click",()=>bn("home"));const t=document.getElementById("globalSearch");t&&t.addEventListener("input",()=>{Bi(t.value);const g=document.getElementById("screen-game");g&&g.dataset.tab!=="home"&&bn("home"),de()}),document.addEventListener("keydown",g=>{var S;if(g.key!=="/")return;const C=document.activeElement;C&&/^(input|textarea|select)$/i.test(C.tagName)||(S=document.getElementById("screen-game"))!=null&&S.classList.contains("hidden")||(g.preventDefault(),t==null||t.focus())}),(y=document.getElementById("homeSeg"))==null||y.addEventListener("click",g=>{const C=g.target.closest(".seg-btn");C&&(document.querySelectorAll("#homeSeg .seg-btn").forEach(S=>S.classList.toggle("is-active",S===C)),ja(C.dataset.home==="sectors"?"up":"value"),de())}),(T=document.getElementById("homeFilters"))==null||T.addEventListener("click",g=>{const C=g.target.closest(".fchip");C&&(C.dataset.filter&&(document.querySelectorAll("#homeFilters [data-filter]").forEach(S=>S.classList.toggle("is-active",S===C)),Dv(C.dataset.filter)),C.dataset.sort&&(document.querySelectorAll("#homeFilters [data-sort]").forEach(S=>S.classList.toggle("is-active",S===C)),ja(C.dataset.sort)),de())}),(b=document.getElementById("screenerPresets"))==null||b.addEventListener("click",g=>{const C=g.target.closest("[data-preset]");C&&(Lv(C.dataset.preset),de())}),(k=document.getElementById("accountView"))==null||k.addEventListener("click",g=>{const C=g.target.closest("[data-acctact]");if(C){const H=C.dataset.acctact;H==="tobank"?f0():H==="tomarket"?p0():H==="send"&&os();return}const S=g.target.closest("[data-acct]");S&&($v(S.dataset.acct),de())}),(M=document.getElementById("feedView"))==null||M.addEventListener("click",g=>{if(g.target.closest("#feedBoardLink")){const C=document.getElementById("navBoard");C&&C.href&&window.open(C.href,"_blank","noopener")}}),document.querySelectorAll(".qty-btn[data-qty]").forEach(g=>{g.addEventListener("click",()=>{const C=document.getElementById("qtyInput");C.value=Math.max(1,Vt()+Number(g.dataset.qty))})}),document.getElementById("btnMaxQty").addEventListener("click",()=>{var z,Z,pe,ge;const{roomData:g,uid:C,selectedStockId:S}=f,H=(Z=(z=g==null?void 0:g.stocks)==null?void 0:z[S])==null?void 0:Z.price,A=((ge=(pe=g==null?void 0:g.players)==null?void 0:pe[C])==null?void 0:ge.cash)||0;H&&(document.getElementById("qtyInput").value=Math.max(1,Math.floor(A/(H*1.0002))))}),document.getElementById("btnBuy").addEventListener("click",()=>zi("buy")),document.getElementById("btnSell").addEventListener("click",()=>zi("sell")),document.getElementById("btnSellAll").addEventListener("click",()=>zi("sellAll")),document.getElementById("orderTabs").addEventListener("click",g=>{const C=g.target.closest(".order-tab");if(!C)return;const S=C.dataset.tab;document.querySelectorAll(".order-tab").forEach(H=>H.classList.toggle("is-active",H===C)),document.querySelectorAll(".order-pane").forEach(H=>H.classList.toggle("hidden",H.dataset.pane!==S))}),document.getElementById("btnLimitBuy").addEventListener("click",()=>oc("buy")),document.getElementById("btnLimitSell").addEventListener("click",()=>oc("sell")),document.getElementById("btnSetStop").addEventListener("click",a0),document.getElementById("btnSplitBuy").addEventListener("click",c0),document.getElementById("orderList").addEventListener("click",g=>{const C=g.target.closest("[data-cancel]");C&&l0(C.dataset.cancel)}),document.getElementById("btnAlert").addEventListener("click",()=>{var Z;const{roomData:g,selectedStockId:C}=f,S=(Z=g==null?void 0:g.stocks)==null?void 0:Z[C];if(!S)return O("종목을 먼저 선택하세요","err");try{window.Notification&&Notification.permission==="default"&&Notification.requestPermission()}catch{}const H=Nv(S.name),A=prompt(`${S.name} 가격 알림 설정
현재가 ${S.price.toLocaleString("ko-KR")}원
알림받을 가격을 입력하세요 (0 또는 빈칸 = 해제):`,H||S.price);if(A===null)return;const z=Math.floor(Number(A)||0);Rv(S.name,z),O(z?`${S.name} ${z.toLocaleString("ko-KR")}원 알림 설정됨`:`${S.name} 알림 해제됨`),de()}),document.getElementById("btnApplyIpo").addEventListener("click",u0);const s=document.getElementById("stockSearch"),i=document.getElementById("stockSearchClear");s&&s.addEventListener("input",()=>{Bi(s.value),i&&(i.hidden=!s.value),de()}),i&&i.addEventListener("click",()=>{s.value="",Bi(""),i.hidden=!0,s.focus(),de()});const r=document.getElementById("marketStatusChip");r&&r.addEventListener("click",()=>{const g=document.getElementById("marketStatusPanel");if(!g)return;const C=g.classList.toggle("hidden");r.setAttribute("aria-expanded",C?"false":"true"),!C&&f.roomData&&wu(f)}),(N=document.getElementById("btnBackHome"))==null||N.addEventListener("click",os)}m0();
