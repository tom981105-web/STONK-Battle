 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const b=function(n,e){if(!n)throw Zt(e)},Zt=function(n){return new Error("Firebase Database ("+rc.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ld="FirebaseError";class it extends Error{constructor(e,t,s){super(t),this.code=e,this.customData=s,this.name=ld,Object.setPrototypeOf(this,it.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Bn.prototype.create)}}class Bn{constructor(e,t,s){this.service=e,this.serviceName=t,this.errors=s}create(e,...t){const s=t[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?ud(r,s):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new it(i,a,s)}}function ud(n,e){return n.replace(dd,(t,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const dd=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tn(n){return JSON.parse(n)}function ee(n){return JSON.stringify(n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fc=function(n){let e={},t={},s={},i="";try{const r=n.split(".");e=Tn(gs(r[0])||""),t=Tn(gs(r[1])||""),i=r[2],s=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:s,signature:i}},hd=function(n){const e=fc(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},fd=function(n){const e=fc(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tn=hh;function gc(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const s=Object.assign({name:Qi,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw Qe.create("bad-app-name",{appName:String(i)});if(t||(t=uc()),!t)throw Qe.create("no-options");const r=ws.get(i);if(r){if(ys(t,r.options)&&ys(s,r.config))return r;throw Qe.create("duplicate-app",{appName:i})}const o=new Ed(i);for(const c of Ji.values())o.addComponent(c);const a=new gh(t,s,o);return ws.set(i,a),a}function _c(n=Qi){const e=ws.get(n);if(!e&&n===Qi&&uc())return gc();if(!e)throw Qe.create("no-app",{appName:n});return e}function Je(n,e,t){var s;let i=(s=fh[n])!==null&&s!==void 0?s:n;t&&(i+=`-${t}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${e}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),De.warn(a.join(" "));return}jt(new vt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kh(n){jt(new vt("platform-logger",e=>new Fd(e),"PRIVATE")),jt(new vt("heartbeat",e=>new Eh(e),"PRIVATE")),Je(Yi,Oo,n),Je(Yi,Oo,"esm2017"),Je("fire-js","")}kh("");var Sh="firebase",Th="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bs=new kr("@firebase/auth");function Nh(n,...e){bs.logLevel<=G.WARN&&bs.warn(`Auth (${tn}): ${n}`,...e)}function rs(n,...e){bs.logLevel<=G.ERROR&&bs.error(`Auth (${tn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hn{constructor(e,t){this.shortDelay=e,this.longDelay=t,$e(t>e,"Short delay should be less than long delay!"),this.isMobile=Cr()||hc()}get(){return Ph()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xh=new Hn(3e4,6e4);function Pr(n,e){return n.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:n.tenantId}):e}async function nn(n,e,t,s,i={}){return Cc(n,i,async()=>{let r={},o={};s&&(e==="GET"?o=s:r={body:JSON.stringify(s)});const a=en(Object.assign({key:n.config.apiKey},o)).slice(1),c=await n._getAdditionalHeaders();c["Content-Type"]="application/json",n.languageCode&&(c["X-Firebase-Locale"]=n.languageCode);const l=Object.assign({method:e,headers:c},r);return sd()||(l.referrerPolicy="no-referrer"),Ic.fetch()(kc(n,n.config.apiHost,t,a),l)})}async function Cc(n,e,t){n._canInitEmulator=!1;const s=Object.assign(Object.assign({},Oh),e);try{const i=new Lh(n),r=await Promise.race([t(),i.promise]);i.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw Zn(n,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[c,l]=a.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw Zn(n,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw Zn(n,"email-already-in-use",o);if(c==="USER_DISABLED")throw Zn(n,"user-disabled",o);const d=s[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw Ec(n,d,l);Le(n,d)}}catch(i){if(i instanceof it)throw i;Le(n,"network-request-failed",{message:String(i)})}}async function Dh(n,e,t,s,i={}){const r=await nn(n,e,t,s,i);return"mfaPendingCredential"in r&&Le(n,"multi-factor-auth-required",{_serverResponse:r}),r}function kc(n,e,t,s){const i=`${e}${t}?${s}`;return n.config.emulator?Ar(n.config,i):`${n.config.apiScheme}://${i}`}class Lh{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,s)=>{this.timer=setTimeout(()=>s(ke(this.auth,"network-request-failed")),xh.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function Zn(n,e,t){const s={appName:n.name};t.email&&(s.email=t.email),t.phoneNumber&&(s.phoneNumber=t.phoneNumber);const i=ke(n,e,s);return i.customData._tokenResponse=t,i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $h(n,e){return nn(n,"POST","/v1/accounts:delete",e)}async function Sc(n,e){return nn(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yn(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Fh(n,e=!1){const t=oe(n),s=await t.getIdToken(e),i=Mr(s);D(i&&i.exp&&i.auth_time&&i.iat,t.auth,"internal-error");const r=typeof i.firebase=="object"?i.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:i,token:s,authTime:yn(Si(i.auth_time)),issuedAtTime:yn(Si(i.iat)),expirationTime:yn(Si(i.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function Si(n){return Number(n)*1e3}function Mr(n){const[e,t,s]=n.split(".");if(e===void 0||t===void 0||s===void 0)return rs("JWT malformed, contained fewer than 3 sections"),null;try{const i=gs(t);return i?JSON.parse(i):(rs("Failed to decode base64 JWT payload"),null)}catch(i){return rs("Caught error parsing JWT payload as JSON",i==null?void 0:i.toString()),null}}function Uo(n){const e=Mr(n);return D(e,"internal-error"),D(typeof e.exp<"u","internal-error"),D(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Nn(n,e,t=!1){if(t)return e;try{return await e}catch(s){throw s instanceof it&&Uh(s)&&n.auth.currentUser===n&&await n.auth.signOut(),s}}function Uh({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Es(n){var e;const t=n.auth,s=await n.getIdToken(),i=await Nn(n,Sc(t,{idToken:s}));D(i==null?void 0:i.users.length,t,"internal-error");const r=i.users[0];n._notifyReloadListener(r);const o=!((e=r.providerUserInfo)===null||e===void 0)&&e.length?Tc(r.providerUserInfo):[],a=Wh(n.providerData,o),c=n.isAnonymous,l=!(n.email&&r.passwordHash)&&!(a!=null&&a.length),d=c?l:!1,u={uid:r.localId,displayName:r.displayName||null,photoURL:r.photoUrl||null,email:r.email||null,emailVerified:r.emailVerified||!1,phoneNumber:r.phoneNumber||null,tenantId:r.tenantId||null,providerData:a,metadata:new Zi(r.createdAt,r.lastLoginAt),isAnonymous:d};Object.assign(n,u)}async function Hh(n){const e=oe(n);await Es(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Wh(n,e){return[...n.filter(s=>!e.some(i=>i.providerId===s.providerId)),...e]}function Tc(n){return n.map(e=>{var{providerId:t}=e,s=Rr(e,["providerId"]);return{providerId:t,uid:s.rawId||"",displayName:s.displayName||null,email:s.email||null,phoneNumber:s.phoneNumber||null,photoURL:s.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vh(n,e){const t=await Cc(n,{},async()=>{const s=en({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:r}=n.config,o=kc(n,i,"/v1/token",`key=${r}`),a=await n._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",Ic.fetch()(o,{method:"POST",headers:a,body:s})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function jh(n,e){return nn(n,"POST","/v2/accounts:revokeToken",Pr(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $c(n,e=[]){let t;switch(n){case"Browser":t=Wo(ue());break;case"Worker":t=`${Wo(ue())}-${n}`;break;default:t=n}const s=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${tn}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kh(n,e={}){return nn(n,"GET","/v2/passwordPolicy",Pr(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nf(n,e){const t=Tr(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),r=t.getOptions();if(ys(r,e??{}))return i;Le(i,"already-initialized")}return t.initialize({options:e})}function sf(n,e){const t=(e==null?void 0:e.persistence)||[],s=(Array.isArray(t)?t:[t]).map(Pe);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function rf(n,e,t){const s=xr(n);D(s._canInitEmulator,s,"emulator-config-failed"),D(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const i=!1,r=Fc(e),{host:o,port:a}=of(e),c=a===null?"":`:${a}`;s.config.emulator={url:`${r}//${o}${c}/`},s.settings.appVerificationDisabledForTesting=!0,s.emulatorConfig=Object.freeze({host:o,port:a,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:i})}),af()}function Fc(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function of(n){const e=Fc(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(s);if(i){const r=i[1];return{host:r,port:jo(s.substr(r.length+1))}}else{const[r,o]=s.split(":");return{host:r,port:jo(o)}}}function jo(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function af(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wn extends Bc{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ve extends Wn{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return yt._fromParams({providerId:Ve.PROVIDER_ID,signInMethod:Ve.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return Ve.credentialFromTaggedObject(e)}static credentialFromError(e){return Ve.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:s}=e;if(!t&&!s)return null;try{return Ve.credential(t,s)}catch{return null}}}Ve.GOOGLE_SIGN_IN_METHOD="google.com";Ve.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Is extends it{constructor(e,t,s,i){var r;super(t.code,t.message),this.operationType=s,this.user=i,Object.setPrototypeOf(this,Is.prototype),this.customData={appName:e.name,tenantId:(r=e.tenantId)!==null&&r!==void 0?r:void 0,_serverResponse:t.customData._serverResponse,operationType:s}}static _fromErrorAndOperation(e,t,s,i){return new Is(e,t,s,i)}}function Hc(n,e,t,s){return(e==="reauthenticate"?t._getReauthenticationResolver(n):t._getIdTokenResponse(n)).catch(r=>{throw r.code==="auth/multi-factor-auth-required"?Is._fromErrorAndOperation(n,r,e,s):r})}async function lf(n,e,t=!1){const s=await Nn(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return Gt._forOperation(n,"link",s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function df(n,e,t=!1){if(ze(n.app))return Promise.reject(pt(n));const s="signIn",i=await Hc(n,s,e),r=await Gt._fromIdTokenResponse(n,s,i);return t||await n._updateCurrentUser(r.user),r}function hf(n,e,t,s){return oe(n).onIdTokenChanged(e,t,s)}function ff(n,e,t){return oe(n).beforeAuthStateChanged(e,t)}function pf(n,e,t,s){return oe(n).onAuthStateChanged(e,t,s)}const Cs="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Df="pendingRedirect",as=new Map;class Lf extends Qc{constructor(e,t,s=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,s),this.eventId=null}async execute(){let e=as.get(this.auth._key());if(!e){try{const s=await $f(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(s)}catch(t){e=()=>Promise.reject(t)}as.set(this.auth._key(),e)}return this.bypassAuthState||as.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function $f(n,e){const t=Bf(e),s=Uf(n);if(!await s._isAvailable())return!1;const i=await s._get(t)==="true";return await s._remove(t),i}function Ff(n,e){as.set(n._key(),e)}function Uf(n){return Pe(n._redirectPersistence)}function Bf(n){return os(Df,n.config.apiKey,n.name)}async function Hf(n,e,t=!1){if(ze(n.app))return Promise.reject(pt(n));const s=xr(n),i=Af(s,e),o=await new Lf(s,i,t).execute();return o&&!t&&(delete o.user._redirectEventId,await s._persistUserIfCurrent(o.user),await s._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gf(n,e={}){return nn(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qf=new Hn(3e4,6e4);function Yo(){const n=Se().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Jf(n){return new Promise((e,t)=>{var s,i,r;function o(){Yo(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Yo(),t(ke(n,"network-request-failed"))},timeout:Qf.get()})}if(!((i=(s=Se().gapi)===null||s===void 0?void 0:s.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((r=Se().gapi)===null||r===void 0)&&r.load)o();else{const a=tf("iframefcb");return Se()[a]=()=>{gapi.load?o():t(ke(n,"network-request-failed"))},Zh(`${ef()}?onload=${a}`).catch(c=>t(c))}}).catch(e=>{throw cs=null,e})}let cs=null;function Xf(n){return cs=cs||Jf(n),cs}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zf=new Hn(5e3,15e3),ep="__/auth/iframe",tp="emulator/auth/iframe",np={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},sp=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function ip(n){const e=n.config;D(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?Ar(e,tp):`https://${n.config.authDomain}/${ep}`,s={apiKey:e.apiKey,appName:n.name,v:tn},i=sp.get(n.config.apiHost);i&&(s.eid=i);const r=n._getFrameworks();return r.length&&(s.fw=r.join(",")),`${t}?${en(s).slice(1)}`}async function rp(n){const e=await Xf(n),t=Se().gapi;return D(t,n,"internal-error"),e.open({where:document.body,url:ip(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:np,dontclear:!0},s=>new Promise(async(i,r)=>{await s.restyle({setHideOnLeave:!1});const o=ke(n,"network-request-failed"),a=Se().setTimeout(()=>{r(o)},Zf.get());function c(){Se().clearTimeout(a),i(s)}s.ping(c).then(c,()=>{r(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fp="__/auth/handler",pp="emulator/auth/handler",mp=encodeURIComponent("fac");async function Jo(n,e,t,s,i,r){D(n.config.authDomain,n,"auth-domain-config-required"),D(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:s,v:tn,eventId:i};if(e instanceof Bc){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",_s(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[d,u]of Object.entries({}))o[d]=u}if(e instanceof Wn){const d=e.getScopes().filter(u=>u!=="");d.length>0&&(o.scopes=d.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const d of Object.keys(a))a[d]===void 0&&delete a[d];const c=await n._getAppCheckToken(),l=c?`#${mp}=${encodeURIComponent(c)}`:"";return`${gp(n)}?${en(a).slice(1)}${l}`}function gp({config:n}){return n.emulator?Ar(n,pp):`https://${n.authDomain}/${fp}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wp(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function bp(n){jt(new vt("auth",(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),r=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=s.options;D(o&&!o.includes(":"),"invalid-api-key",{appName:s.name});const c={apiKey:o,authDomain:a,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:$c(n)},l=new Jh(s,i,r,c);return sf(l,t),l},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,s)=>{e.getProvider("auth-internal").initialize()})),jt(new vt("auth-internal",e=>{const t=xr(e.getProvider("auth").getImmediate());return(s=>new yp(s))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Je(Xo,Zo,wp(n)),Je(Xo,Zo,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zc=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Rp(e)}}catch{}return new Np},dt=Zc("localStorage"),Ap=Zc("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ut=new kr("@firebase/database"),el=function(){let n=1;return function(){return n++}}(),tl=function(n){const e=vd(n),t=new pd;t.update(e);const s=t.digest();return Er.encodeByteArray(s)},jn=function(...n){let e="";for(let t=0;t<n.length;t++){const s=n[t];Array.isArray(s)||s&&typeof s=="object"&&typeof s.length=="number"?e+=jn.apply(null,s):typeof s=="object"?e+=ee(s):e+=s,e+=" "}return e};let wn=null,ia=!0;const Pp=function(n,e){b(!0,"Can't turn on custom loggers persistently."),Ut.logLevel=G.VERBOSE,wn=Ut.log.bind(Ut)},se=function(...n){if(ia===!0&&(ia=!1,wn===null&&Ap.get("logging_enabled")===!0&&Pp()),wn){const e=jn.apply(null,n);wn(e)}},Gn=function(n){return function(...e){se(n,...e)}},tr=function(...n){const e="FIREBASE INTERNAL ERROR: "+jn(...n);Ut.error(e)},Fe=function(...n){const e=`FIREBASE FATAL ERROR: ${jn(...n)}`;throw Ut.error(e),new Error(e)},ce=function(...n){const e="FIREBASE WARNING: "+jn(...n);Ut.warn(e)},Mp=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&ce("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},ei=function(n){return typeof n=="number"&&(n!==n||n===Number.POSITIVE_INFINITY||n===Number.NEGATIVE_INFINITY)},Op=function(n){if(document.readyState==="complete")n();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,n())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},zt="[MIN_NAME]",wt="[MAX_NAME]",kt=function(n,e){if(n===e)return 0;if(n===zt||e===wt)return-1;if(e===zt||n===wt)return 1;{const t=ra(n),s=ra(e);return t!==null?s!==null?t-s===0?n.length-e.length:t-s:-1:s!==null?1:n<e?-1:1}},xp=function(n,e){return n===e?0:n<e?-1:1},hn=function(n,e){if(e&&n in e)return e[n];throw new Error("Missing required key ("+n+") in object: "+ee(e))},Fr=function(n){if(typeof n!="object"||n===null)return ee(n);const e=[];for(const s in n)e.push(s);e.sort();let t="{";for(let s=0;s<e.length;s++)s!==0&&(t+=","),t+=ee(e[s]),t+=":",t+=Fr(n[e[s]]);return t+="}",t},nl=function(n,e){const t=n.length;if(t<=e)return[n];const s=[];for(let i=0;i<t;i+=e)i+e>t?s.push(n.substring(i,t)):s.push(n.substring(i,i+e));return s};function ie(n,e){for(const t in n)n.hasOwnProperty(t)&&e(t,n[t])}const sl=function(n){b(!ei(n),"Invalid JSON number");const e=11,t=52,s=(1<<e-1)-1;let i,r,o,a,c;n===0?(r=0,o=0,i=1/n===-1/0?1:0):(i=n<0,n=Math.abs(n),n>=Math.pow(2,1-s)?(a=Math.min(Math.floor(Math.log(n)/Math.LN2),s),r=a+s,o=Math.round(n*Math.pow(2,t-a)-Math.pow(2,t))):(r=0,o=Math.round(n/Math.pow(2,1-s-t))));const l=[];for(c=t;c;c-=1)l.push(o%2?1:0),o=Math.floor(o/2);for(c=e;c;c-=1)l.push(r%2?1:0),r=Math.floor(r/2);l.push(i?1:0),l.reverse();const d=l.join("");let u="";for(c=0;c<64;c+=8){let h=parseInt(d.substr(c,8),2).toString(16);h.length===1&&(h="0"+h),u=u+h}return u.toLowerCase()},Dp=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},Lp=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function $p(n,e){let t="Unknown Error";n==="too_big"?t="The data requested exceeds the maximum size that can be accessed with a single request.":n==="permission_denied"?t="Client doesn't have permission to access the desired data.":n==="unavailable"&&(t="The service is unavailable");const s=new Error(n+" at "+e._path.toString()+": "+t);return s.code=n.toUpperCase(),s}const Fp=new RegExp("^-?(0*)\\d{1,10}$"),Up=-2147483648,Bp=2147483647,ra=function(n){if(Fp.test(n)){const e=Number(n);if(e>=Up&&e<=Bp)return e}return null},sn=function(n){try{n()}catch(e){setTimeout(()=>{const t=e.stack||"";throw ce("Exception was thrown by user callback.",t),e},Math.floor(0))}},Hp=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},bn=function(n,e){const t=setTimeout(n,e);return typeof t=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qp{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const s=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let i=0;i<s.length;++i)s[i]&&sn(()=>{this.onMessage_(s[i])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rm=16384,om=45e3;let Ss=null;typeof MozWebSocket<"u"?Ss=MozWebSocket:typeof WebSocket<"u"&&(Ss=WebSocket);class ye{constructor(e,t,s,i,r,o,a){this.connId=e,this.applicationId=s,this.appCheckToken=i,this.authToken=r,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=Gn(this.connId),this.stats_=Br(t),this.connURL=ye.connectionURL_(t,o,a,i,s),this.nodeAdmin=t.nodeAdmin}static connectionURL_(e,t,s,i,r){const o={};return o[il]=Ur,typeof location<"u"&&location.hostname&&cl.test(location.hostname)&&(o[ol]=al),t&&(o[rl]=t),s&&(o[ll]=s),i&&(o[nr]=i),r&&(o[ul]=r),pl(e,dl,o)}open(e,t){this.onDisconnect=t,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,dt.set("previous_websocket_failure",!0);try{let s;od(),this.mySock=new Ss(this.connURL,[],s)}catch(s){this.log_("Error instantiating WebSocket.");const i=s.message||s.data;i&&this.log_(i),this.onClosed_();return}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=s=>{this.handleIncomingFrame(s)},this.mySock.onerror=s=>{this.log_("WebSocket error.  Closing connection.");const i=s.message||s.data;i&&this.log_(i),this.onClosed_()}}start(){}static forceDisallow(){ye.forceDisallow_=!0}static isAvailable(){let e=!1;if(typeof navigator<"u"&&navigator.userAgent){const t=/Android ([0-9]{0,}\.[0-9]{0,})/,s=navigator.userAgent.match(t);s&&s.length>1&&parseFloat(s[1])<4.4&&(e=!0)}return!e&&Ss!==null&&!ye.forceDisallow_}static previouslyFailed(){return dt.isInMemoryStorage||dt.get("previous_websocket_failure")===!0}markConnectionHealthy(){dt.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const t=this.frames.join("");this.frames=null;const s=Tn(t);this.onMessage(s)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(b(this.frames===null,"We already have a frame buffer"),e.length<=6){const t=Number(e);if(!isNaN(t))return this.handleNewFrameCount_(t),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(this.mySock===null)return;const t=e.data;if(this.bytesReceived+=t.length,this.stats_.incrementCounter("bytes_received",t.length),this.resetKeepAlive(),this.frames!==null)this.appendFrame_(t);else{const s=this.extractFrameCount_(t);s!==null&&this.appendFrame_(s)}}send(e){this.resetKeepAlive();const t=ee(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const s=nl(t,rm);s.length>1&&this.sendString_(String(s.length));for(let i=0;i<s.length;i++)this.sendString_(s[i])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval(()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()},Math.floor(om))}sendString_(e){try{this.mySock.send(e)}catch(t){this.log_("Exception thrown from WebSocket.send():",t.message||t.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}}ye.responsesRequiredToBeHealthy=2;ye.healthyTimeout=3e4;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ts extends bl{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Cr()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new Ts}getInitialEvent(e){return b(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fa=32,pa=768;class j{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let s=0;for(let i=0;i<this.pieces_.length;i++)this.pieces_[i].length>0&&(this.pieces_[s]=this.pieces_[i],s++);this.pieces_.length=s,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function W(){return new j("")}function F(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function et(n){return n.pieces_.length-n.pieceNum_}function z(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new j(n.pieces_,e)}function Wr(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function mm(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function Pn(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function El(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new j(e,0)}function X(n,e){const t=[];for(let s=n.pieceNum_;s<n.pieces_.length;s++)t.push(n.pieces_[s]);if(e instanceof j)for(let s=e.pieceNum_;s<e.pieces_.length;s++)t.push(e.pieces_[s]);else{const s=e.split("/");for(let i=0;i<s.length;i++)s[i].length>0&&t.push(s[i])}return new j(t,0)}function U(n){return n.pieceNum_>=n.pieces_.length}function ae(n,e){const t=F(n),s=F(e);if(t===null)return e;if(t===s)return ae(z(n),z(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function gm(n,e){const t=Pn(n,0),s=Pn(e,0);for(let i=0;i<t.length&&i<s.length;i++){const r=kt(t[i],s[i]);if(r!==0)return r}return t.length===s.length?0:t.length<s.length?-1:1}function Vr(n,e){if(et(n)!==et(e))return!1;for(let t=n.pieceNum_,s=e.pieceNum_;t<=n.pieces_.length;t++,s++)if(n.pieces_[t]!==e.pieces_[s])return!1;return!0}function me(n,e){let t=n.pieceNum_,s=e.pieceNum_;if(et(n)>et(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[s])return!1;++t,++s}return!0}class _m{constructor(e,t){this.errorPrefix_=t,this.parts_=Pn(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let s=0;s<this.parts_.length;s++)this.byteLength_+=Js(this.parts_[s]);Il(this)}}function vm(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=Js(e),Il(n)}function ym(n){const e=n.parts_.pop();n.byteLength_-=Js(e),n.parts_.length>0&&(n.byteLength_-=1)}function Il(n){if(n.byteLength_>pa)throw new Error(n.errorPrefix_+"has a key path longer than "+pa+" bytes ("+n.byteLength_+").");if(n.parts_.length>fa)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+fa+") or object contains a cycle "+lt(n))}function lt(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ti{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const s=new B(zt,e),i=new B(zt,t);return this.compare(s,i)!==0}minPost(){return B.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let es;class Cl extends ti{static get __EMPTY_NODE(){return es}static set __EMPTY_NODE(e){es=e}compare(e,t){return kt(e.name,t.name)}isDefinedOn(e){throw Zt("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return B.MIN}maxPost(){return new B(wt,es)}makePost(e,t){return b(typeof e=="string","KeyIndex indexValue must always be a string."),new B(e,es)}toString(){return".key"}}const Bt=new Cl;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Tl,Rl;function Tm(n){Tl=n}function Rm(n){Rl=n}class Nm extends ti{compare(e,t){const s=e.node.getPriority(),i=t.node.getPriority(),r=s.compareTo(i);return r===0?kt(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return B.MIN}maxPost(){return new B(wt,new te("[PRIORITY-POST]",Rl))}makePost(e,t){const s=Tl(e);return new B(t,new te("[PRIORITY-POST]",s))}toString(){return".priority"}}const Q=new Nm;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Pi;const Nt={};class Me{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return b(Nt&&Q,"ChildrenNode.ts has not been loaded"),Pi=Pi||new Me({".priority":Nt},{".priority":Q}),Pi}get(e){const t=_t(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof he?t:null}hasIndex(e){return Ee(this.indexSet_,e.toString())}addIndex(e,t){b(e!==Bt,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=t.getIterator(B.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let a;i?a=Rs(s,e.getCompare()):a=Nt;const c=e.toString(),l=Object.assign({},this.indexSet_);l[c]=e;const d=Object.assign({},this.indexes_);return d[c]=a,new Me(d,l)}addToIndexes(e,t){const s=vs(this.indexes_,(i,r)=>{const o=_t(this.indexSet_,r);if(b(o,"Missing index implementation for "+r),i===Nt)if(o.isDefinedOn(e.node)){const a=[],c=t.getIterator(B.Wrap);let l=c.getNext();for(;l;)l.name!==e.name&&a.push(l),l=c.getNext();return a.push(e),Rs(a,o.getCompare())}else return Nt;else{const a=t.get(e.name);let c=i;return a&&(c=c.remove(new B(e.name,a))),c.insert(e,e.node)}});return new Me(s,this.indexSet_)}removeFromIndexes(e,t){const s=vs(this.indexes_,i=>{if(i===Nt)return i;{const r=t.get(e.name);return r?i.remove(new B(e.name,r)):i}});return new Me(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xm extends ti{constructor(e){super(),this.indexPath_=e,b(!U(e)&&F(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const s=this.extractChild(e.node),i=this.extractChild(t.node),r=s.compareTo(i);return r===0?kt(e.name,t.name):r}makePost(e,t){const s=J(e),i=P.EMPTY_NODE.updateChild(this.indexPath_,s);return new B(t,i)}maxPost(){const e=P.EMPTY_NODE.updateChild(this.indexPath_,zn);return new B(wt,e)}toString(){return Pn(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dm extends ti{compare(e,t){const s=e.node.compareTo(t.node);return s===0?kt(e.name,t.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return B.MIN}maxPost(){return B.MAX}makePost(e,t){const s=J(e);return new B(t,s)}toString(){return".value"}}const Lm=new Dm;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nl(n){return{type:"value",snapshotNode:n}}function qt(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function Mn(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function On(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function $m(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zr{constructor(e){this.index_=e}updateChild(e,t,s,i,r,o){b(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(i).equals(s.getChild(i))&&a.isEmpty()===s.isEmpty()||(o!=null&&(s.isEmpty()?e.hasChild(t)?o.trackChildChange(Mn(t,a)):b(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(qt(t,s)):o.trackChildChange(On(t,s,a))),e.isLeafNode()&&s.isEmpty())?e:e.updateImmediateChild(t,s).withIndex(this.index_)}updateFullNode(e,t,s){return s!=null&&(e.isLeafNode()||e.forEachChild(Q,(i,r)=>{t.hasChild(i)||s.trackChildChange(Mn(i,r))}),t.isLeafNode()||t.forEachChild(Q,(i,r)=>{if(e.hasChild(i)){const o=e.getImmediateChild(i);o.equals(r)||s.trackChildChange(On(i,r,o))}else s.trackChildChange(qt(i,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?P.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ns extends wl{constructor(e,t,s,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=s,this.appCheckTokenProvider_=i,this.log_=Gn("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(b(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,s,i){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=Ns.getListenId_(e,s),a={};this.listens_[o]=a;const c=va(e._queryParams);this.restRequest_(r+".json",c,(l,d)=>{let u=d;if(l===404&&(u=null,l=null),l===null&&this.onDataUpdate_(r,u,!1,s),_t(this.listens_,o)===a){let h;l?l===401?h="permission_denied":h="rest_error:"+l:h="ok",i(h,null)}})}unlisten(e,t){const s=Ns.getListenId_(e,t);delete this.listens_[s]}get(e){const t=va(e._queryParams),s=e._path.toString(),i=new ve;return this.restRequest_(s+".json",t,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(s,a,!1,null),i.resolve(a)):i.reject(new Error(a))}),i.promise}refreshAuthToken(e){}restRequest_(e,t={},s){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,r])=>{i&&i.accessToken&&(t.auth=i.accessToken),r&&r.token&&(t.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+en(t);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(s&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let c=null;if(a.status>=200&&a.status<300){try{c=Tn(a.responseText)}catch{ce("Failed to parse JSON response for "+o+": "+a.responseText)}s(null,c)}else a.status!==401&&a.status!==404&&ce("Got unsuccessful REST response for "+o+" Status: "+a.status),s(a.status);s=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function As(){return{value:null,children:new Map}}function rn(n,e,t){if(U(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const s=F(e);n.children.has(s)||n.children.set(s,As());const i=n.children.get(s);e=z(e),rn(i,e,t)}}function ir(n,e){if(U(e))return n.value=null,n.children.clear(),!0;if(n.value!==null){if(n.value.isLeafNode())return!1;{const t=n.value;return n.value=null,t.forEachChild(Q,(s,i)=>{rn(n,new j(s),i)}),ir(n,e)}}else if(n.children.size>0){const t=F(e);return e=z(e),n.children.has(t)&&ir(n.children.get(t),e)&&n.children.delete(t),n.children.size===0}else return!0}function rr(n,e,t){n.value!==null?t(e,n.value):Hm(n,(s,i)=>{const r=new j(e.toString()+"/"+s);rr(i,r,t)})}function Hm(n,e){n.children.forEach((t,s)=>{e(s,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wa=10*1e3,Vm=30*1e3,jm=5*60*1e3;class Gm{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Wm(e);const s=wa+(Vm-wa)*Math.random();bn(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;ie(e,(i,r)=>{r>0&&Ee(this.statsToReport_,i)&&(t[i]=r,s=!0)}),s&&this.server_.reportStats(t),bn(this.reportStats_.bind(this),Math.floor(Math.random()*2*jm))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dn{constructor(e,t){this.source=e,this.path=t,this.type=we.LISTEN_COMPLETE}operationForChild(e){return U(this.path)?new Dn(this.source,W()):new Dn(this.source,z(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bt{constructor(e,t,s){this.source=e,this.path=t,this.snap=s,this.type=we.OVERWRITE}operationForChild(e){return U(this.path)?new bt(this.source,W(),this.snap.getImmediateChild(e)):new bt(this.source,z(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kt{constructor(e,t,s){this.source=e,this.path=t,this.children=s,this.type=we.MERGE}operationForChild(e){if(U(this.path)){const t=this.children.subtree(new j(e));return t.isEmpty()?null:t.value?new bt(this.source,W(),t.value):new Kt(this.source,W(),t)}else return b(F(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Kt(this.source,z(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zm{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function qm(n,e,t,s){const i=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push($m(o.childName,o.snapshotNode))}),mn(n,i,"child_removed",e,s,t),mn(n,i,"child_added",e,s,t),mn(n,i,"child_moved",r,s,t),mn(n,i,"child_changed",e,s,t),mn(n,i,"value",e,s,t),i}function mn(n,e,t,s,i,r){const o=s.filter(a=>a.type===t);o.sort((a,c)=>Ym(n,a,c)),o.forEach(a=>{const c=Km(n,a,r);i.forEach(l=>{l.respondsTo(a.type)&&e.push(l.createEvent(c,n.query_))})})}function Km(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function Ym(n,e,t){if(e.childName==null||t.childName==null)throw Zt("Should only compare child_ events.");const s=new B(e.childName,e.snapshotNode),i=new B(t.childName,t.snapshotNode);return n.index_.compare(s,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ni(n,e){return{eventCache:n,serverCache:e}}function En(n,e,t,s){return ni(new tt(e,t,s),n.serverCache)}function Al(n,e,t,s){return ni(n.eventCache,new tt(e,t,s))}function Ms(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Et(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function si(n,e){return Dl(e,n)}function Jm(n,e,t,s,i){b(s>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:s,visible:i}),i&&(n.visibleWrites=In(n.visibleWrites,e,t)),n.lastWriteId=s}function Xm(n,e,t,s){b(s>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:s,visible:!0}),n.visibleWrites=or(n.visibleWrites,e,t),n.lastWriteId=s}function Zm(n,e){for(let t=0;t<n.allWrites.length;t++){const s=n.allWrites[t];if(s.writeId===e)return s}return null}function eg(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);b(t>=0,"removeWrite called with nonexistent writeId.");const s=n.allWrites[t];n.allWrites.splice(t,1);let i=s.visible,r=!1,o=n.allWrites.length-1;for(;i&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&tg(a,s.path)?i=!1:me(s.path,a.path)&&(r=!0)),o--}if(i){if(r)return ng(n),!0;if(s.snap)n.visibleWrites=ba(n.visibleWrites,s.path);else{const a=s.children;ie(a,c=>{n.visibleWrites=ba(n.visibleWrites,X(s.path,c))})}return!0}else return!1}function tg(n,e){if(n.snap)return me(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&me(X(n.path,t),e))return!0;return!1}function ng(n){n.visibleWrites=Ml(n.allWrites,sg,W()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function sg(n){return n.visible}function Ml(n,e,t){let s=be.empty();for(let i=0;i<n.length;++i){const r=n[i];if(e(r)){const o=r.path;let a;if(r.snap)me(t,o)?(a=ae(t,o),s=In(s,a,r.snap)):me(o,t)&&(a=ae(o,t),s=In(s,W(),r.snap.getChild(a)));else if(r.children){if(me(t,o))a=ae(t,o),s=or(s,a,r.children);else if(me(o,t))if(a=ae(o,t),U(a))s=or(s,W(),r.children);else{const c=_t(r.children,F(a));if(c){const l=c.getChild(z(a));s=In(s,W(),l)}}}else throw Zt("WriteRecord should have .snap or .children")}}return s}function Ol(n,e,t,s,i){if(!s&&!i){const r=St(n.visibleWrites,e);if(r!=null)return r;{const o=Xe(n.visibleWrites,e);if(cr(o))return t;if(t==null&&!ar(o,W()))return null;{const a=t||P.EMPTY_NODE;return Yt(o,a)}}}else{const r=Xe(n.visibleWrites,e);if(!i&&cr(r))return t;if(!i&&t==null&&!ar(r,W()))return null;{const o=function(l){return(l.visible||i)&&(!s||!~s.indexOf(l.writeId))&&(me(l.path,e)||me(e,l.path))},a=Ml(n.allWrites,o,e),c=t||P.EMPTY_NODE;return Yt(a,c)}}}function ig(n,e,t){let s=P.EMPTY_NODE;const i=St(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(Q,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(t){const r=Xe(n.visibleWrites,e);return t.forEachChild(Q,(o,a)=>{const c=Yt(Xe(r,new j(o)),a);s=s.updateImmediateChild(o,c)}),Ea(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=Xe(n.visibleWrites,e);return Ea(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function rg(n,e,t,s,i){b(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=X(e,t);if(ar(n.visibleWrites,r))return null;{const o=Xe(n.visibleWrites,r);return cr(o)?i.getChild(t):Yt(o,i.getChild(t))}}function og(n,e,t,s){const i=X(e,t),r=St(n.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(t)){const o=Xe(n.visibleWrites,i);return Yt(o,s.getNode().getImmediateChild(t))}else return null}function ag(n,e){return St(n.visibleWrites,e)}function cg(n,e,t,s,i,r,o){let a;const c=Xe(n.visibleWrites,e),l=St(c,W());if(l!=null)a=l;else if(t!=null)a=Yt(c,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const d=[],u=o.getCompare(),h=r?a.getReverseIteratorFrom(s,o):a.getIteratorFrom(s,o);let p=h.getNext();for(;p&&d.length<i;)u(p,s)!==0&&d.push(p),p=h.getNext();return d}else return[]}function lg(){return{visibleWrites:be.empty(),allWrites:[],lastWriteId:-1}}function Os(n,e,t,s){return Ol(n.writeTree,n.treePath,e,t,s)}function Jr(n,e){return ig(n.writeTree,n.treePath,e)}function Ia(n,e,t,s){return rg(n.writeTree,n.treePath,e,t,s)}function xs(n,e){return ag(n.writeTree,X(n.treePath,e))}function ug(n,e,t,s,i,r){return cg(n.writeTree,n.treePath,e,t,s,i,r)}function Xr(n,e,t){return og(n.writeTree,n.treePath,e,t)}function xl(n,e){return Dl(X(n.treePath,e),n.writeTree)}function Dl(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dg{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,s=e.childName;b(t==="child_added"||t==="child_changed"||t==="child_removed","Only child changes supported for tracking"),b(s!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(s);if(i){const r=i.type;if(t==="child_added"&&r==="child_removed")this.changeMap.set(s,On(s,e.snapshotNode,i.snapshotNode));else if(t==="child_removed"&&r==="child_added")this.changeMap.delete(s);else if(t==="child_removed"&&r==="child_changed")this.changeMap.set(s,Mn(s,i.oldSnap));else if(t==="child_changed"&&r==="child_added")this.changeMap.set(s,qt(s,e.snapshotNode));else if(t==="child_changed"&&r==="child_changed")this.changeMap.set(s,On(s,e.snapshotNode,i.oldSnap));else throw Zt("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(s,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hg{getCompleteChild(e){return null}getChildAfterChild(e,t,s){return null}}const Ll=new hg;class Zr{constructor(e,t,s=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=s}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new tt(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Xr(this.writes_,e,s)}}getChildAfterChild(e,t,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Et(this.viewCache_),r=ug(this.writes_,i,t,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ls;class Ul{constructor(){this.views=new Map}}function Tg(n){b(!Ls,"__referenceConstructor has already been defined"),Ls=n}function Rg(){return b(Ls,"Reference.ts has not been loaded"),Ls}function Ng(n){return n.views.size===0}function eo(n,e,t,s){const i=e.source.queryId;if(i!==null){const r=n.views.get(i);return b(r!=null,"SyncTree gave us an op for an invalid query."),Ra(r,e,t,s)}else{let r=[];for(const o of n.views.values())r=r.concat(Ra(o,e,t,s));return r}}function Bl(n,e,t,s,i){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let a=Os(t,i?s:null),c=!1;a?c=!0:s instanceof P?(a=Jr(t,s),c=!1):(a=P.EMPTY_NODE,c=!1);const l=ni(new tt(a,c,!1),new tt(s,i,!1));return new bg(e,l)}return o}function Ag(n,e,t,s,i,r){const o=Bl(n,e,s,i,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),kg(o,t),Sg(o,t)}function Pg(n,e,t,s){const i=e._queryIdentifier,r=[];let o=[];const a=nt(n);if(i==="default")for(const[c,l]of n.views.entries())o=o.concat(Ta(l,t,s)),Sa(l)&&(n.views.delete(c),l.query._queryParams.loadsAllData()||r.push(l.query));else{const c=n.views.get(i);c&&(o=o.concat(Ta(c,t,s)),Sa(c)&&(n.views.delete(i),c.query._queryParams.loadsAllData()||r.push(c.query)))}return a&&!nt(n)&&r.push(new(Rg())(e._repo,e._path)),{removed:r,events:o}}function Hl(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function Ze(n,e){let t=null;for(const s of n.views.values())t=t||Cg(s,e);return t}function Wl(n,e){if(e._queryParams.loadsAllData())return ii(n);{const s=e._queryIdentifier;return n.views.get(s)}}function Vl(n,e){return Wl(n,e)!=null}function nt(n){return ii(n)!=null}function ii(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $s;function Mg(n){b(!$s,"__referenceConstructor has already been defined"),$s=n}function Og(){return b($s,"Reference.ts has not been loaded"),$s}let xg=1;class Na{constructor(e){this.listenProvider_=e,this.syncPointTree_=new K(null),this.pendingWriteTree_=lg(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function to(n,e,t,s,i){return Jm(n.pendingWriteTree_,e,t,s,i),i?on(n,new bt(Kr(),e,t)):[]}function Dg(n,e,t,s){Xm(n.pendingWriteTree_,e,t,s);const i=K.fromObject(t);return on(n,new Kt(Kr(),e,i))}function qe(n,e,t=!1){const s=Zm(n.pendingWriteTree_,e);if(eg(n.pendingWriteTree_,e)){let r=new K(null);return s.snap!=null?r=r.set(W(),!0):ie(s.children,o=>{r=r.set(new j(o),!0)}),on(n,new Ps(s.path,r,t))}else return[]}function qn(n,e,t){return on(n,new bt(Yr(),e,t))}function Lg(n,e,t){const s=K.fromObject(t);return on(n,new Kt(Yr(),e,s))}function $g(n,e){return on(n,new Dn(Yr(),e))}function Fg(n,e,t){const s=no(n,t);if(s){const i=so(s),r=i.path,o=i.queryId,a=ae(r,e),c=new Dn(Qr(o),a);return io(n,r,c)}else return[]}function Fs(n,e,t,s,i=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||Vl(o,e))){const c=Pg(o,e,t,s);Ng(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const l=c.removed;if(a=c.events,!i){const d=l.findIndex(h=>h._queryParams.loadsAllData())!==-1,u=n.syncPointTree_.findOnPath(r,(h,p)=>nt(p));if(d&&!u){const h=n.syncPointTree_.subtree(r);if(!h.isEmpty()){const p=Hg(h);for(let m=0;m<p.length;++m){const v=p[m],I=v.query,E=ql(n,v);n.listenProvider_.startListening(Cn(I),Ln(n,I),E.hashFn,E.onComplete)}}}!u&&l.length>0&&!s&&(d?n.listenProvider_.stopListening(Cn(e),null):l.forEach(h=>{const p=n.queryToTagMap.get(oi(h));n.listenProvider_.stopListening(Cn(h),p)}))}Wg(n,l)}return a}function jl(n,e,t,s){const i=no(n,s);if(i!=null){const r=so(i),o=r.path,a=r.queryId,c=ae(o,e),l=new bt(Qr(a),c,t);return io(n,o,l)}else return[]}function Ug(n,e,t,s){const i=no(n,s);if(i){const r=so(i),o=r.path,a=r.queryId,c=ae(o,e),l=K.fromObject(t),d=new Kt(Qr(a),c,l);return io(n,o,d)}else return[]}function dr(n,e,t,s=!1){const i=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(i,(h,p)=>{const m=ae(h,i);r=r||Ze(p,m),o=o||nt(p)});let a=n.syncPointTree_.get(i);a?(o=o||nt(a),r=r||Ze(a,W())):(a=new Ul,n.syncPointTree_=n.syncPointTree_.set(i,a));let c;r!=null?c=!0:(c=!1,r=P.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((p,m)=>{const v=Ze(m,W());v&&(r=r.updateImmediateChild(p,v))}));const l=Vl(a,e);if(!l&&!e._queryParams.loadsAllData()){const h=oi(e);b(!n.queryToTagMap.has(h),"View does not exist, but we have a tag");const p=Vg();n.queryToTagMap.set(h,p),n.tagToQueryMap.set(p,h)}const d=si(n.pendingWriteTree_,i);let u=Ag(a,e,t,d,r,c);if(!l&&!o&&!s){const h=Wl(a,e);u=u.concat(jg(n,e,h))}return u}function ri(n,e,t){const i=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const c=ae(o,e),l=Ze(a,c);if(l)return l});return Ol(i,e,r,t,!0)}function Bg(n,e){const t=e._path;let s=null;n.syncPointTree_.foreachOnPath(t,(l,d)=>{const u=ae(l,t);s=s||Ze(d,u)});let i=n.syncPointTree_.get(t);i?s=s||Ze(i,W()):(i=new Ul,n.syncPointTree_=n.syncPointTree_.set(t,i));const r=s!=null,o=r?new tt(s,!0,!1):null,a=si(n.pendingWriteTree_,e._path),c=Bl(i,e,a,r?o.getNode():P.EMPTY_NODE,r);return Ig(c)}function on(n,e){return Gl(e,n.syncPointTree_,null,si(n.pendingWriteTree_,W()))}function Gl(n,e,t,s){if(U(n.path))return zl(n,e,t,s);{const i=e.get(W());t==null&&i!=null&&(t=Ze(i,W()));let r=[];const o=F(n.path),a=n.operationForChild(o),c=e.children.get(o);if(c&&a){const l=t?t.getImmediateChild(o):null,d=xl(s,o);r=r.concat(Gl(a,c,l,d))}return i&&(r=r.concat(eo(i,n,s,t))),r}}function zl(n,e,t,s){const i=e.get(W());t==null&&i!=null&&(t=Ze(i,W()));let r=[];return e.children.inorderTraversal((o,a)=>{const c=t?t.getImmediateChild(o):null,l=xl(s,o),d=n.operationForChild(o);d&&(r=r.concat(zl(d,a,c,l)))}),i&&(r=r.concat(eo(i,n,s,t))),r}function ql(n,e){const t=e.query,s=Ln(n,t);return{hashFn:()=>(Eg(e)||P.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?Fg(n,t._path,s):$g(n,t._path);{const r=$p(i,t);return Fs(n,t,null,r)}}}}function Ln(n,e){const t=oi(e);return n.queryToTagMap.get(t)}function oi(n){return n._path.toString()+"$"+n._queryIdentifier}function no(n,e){return n.tagToQueryMap.get(e)}function so(n){const e=n.indexOf("$");return b(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new j(n.substr(0,e))}}function io(n,e,t){const s=n.syncPointTree_.get(e);b(s,"Missing sync point for query tag that we're tracking");const i=si(n.pendingWriteTree_,e);return eo(s,t,i,null)}function Hg(n){return n.fold((e,t,s)=>{if(t&&nt(t))return[ii(t)];{let i=[];return t&&(i=Hl(t)),ie(s,(r,o)=>{i=i.concat(o)}),i}})}function Cn(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Og())(n._repo,n._path):n}function Wg(n,e){for(let t=0;t<e.length;++t){const s=e[t];if(!s._queryParams.loadsAllData()){const i=oi(s),r=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(r)}}}function Vg(){return xg++}function jg(n,e,t){const s=e._path,i=Ln(n,e),r=ql(n,t),o=n.listenProvider_.startListening(Cn(e),i,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(s);if(i)b(!nt(a.value),"If we're adding a query, it shouldn't be shadowed");else{const c=a.fold((l,d,u)=>{if(!U(l)&&d&&nt(d))return[ii(d).query];{let h=[];return d&&(h=h.concat(Hl(d).map(p=>p.query))),ie(u,(p,m)=>{h=h.concat(m)}),h}});for(let l=0;l<c.length;++l){const d=c[l];n.listenProvider_.stopListening(Cn(d),Ln(n,d))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lo{constructor(e="",t=null,s={children:{},childCount:0}){this.name=e,this.parent=t,this.node=s}}function ai(n,e){let t=e instanceof j?e:new j(e),s=n,i=F(t);for(;i!==null;){const r=_t(s.node.children,i)||{children:{},childCount:0};s=new lo(i,s,r),t=z(t),i=F(t)}return s}function Tt(n){return n.node.value}function uo(n,e){n.node.value=e,hr(n)}function Yl(n){return n.node.childCount>0}function Kg(n){return Tt(n)===void 0&&!Yl(n)}function ci(n,e){ie(n.node.children,(t,s)=>{e(new lo(t,n,s))})}function Ql(n,e,t,s){t&&e(n),ci(n,i=>{Ql(i,e,!0)})}function Yg(n,e,t){let s=n.parent;for(;s!==null;){if(e(s))return!0;s=s.parent}return!1}function Kn(n){return new j(n.parent===null?n.name:Kn(n.parent)+"/"+n.name)}function hr(n){n.parent!==null&&Qg(n.parent,n.name,n)}function Qg(n,e,t){const s=Kg(t),i=Ee(n.node.children,e);s&&i?(delete n.node.children[e],n.node.childCount--,hr(n)):!s&&!i&&(n.node.children[e]=t.node,n.node.childCount++,hr(n))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jg=/[\[\].#$\/\u0000-\u001F\u007F]/,Xg=/[\[\].#$\u0000-\u001F\u007F]/,Oi=10*1024*1024,ho=function(n){return typeof n=="string"&&n.length!==0&&!Jg.test(n)},Jl=function(n){return typeof n=="string"&&n.length!==0&&!Xg.test(n)},Zg=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Jl(n)},fo=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!ei(n)||n&&typeof n=="object"&&Ee(n,".sv")},Us=function(n,e,t,s){s&&e===void 0||Yn(Vt(n,"value"),e,t)},Yn=function(n,e,t){const s=t instanceof j?new _m(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+lt(s));if(typeof e=="function")throw new Error(n+"contains a function "+lt(s)+" with contents = "+e.toString());if(ei(e))throw new Error(n+"contains "+e.toString()+" "+lt(s));if(typeof e=="string"&&e.length>Oi/3&&Js(e)>Oi)throw new Error(n+"contains a string greater than "+Oi+" utf8 bytes "+lt(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(ie(e,(o,a)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!ho(o)))throw new Error(n+" contains an invalid key ("+o+") "+lt(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);vm(s,o),Yn(n,a,s),ym(s)}),i&&r)throw new Error(n+' contains ".value" child '+lt(s)+" in addition to actual children.")}},e_=function(n,e){let t,s;for(t=0;t<e.length;t++){s=e[t];const r=Pn(s);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!ho(r[o]))throw new Error(n+"contains an invalid key ("+r[o]+") in path "+s.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(gm);let i=null;for(t=0;t<e.length;t++){if(s=e[t],i!==null&&me(i,s))throw new Error(n+"contains a path "+i.toString()+" that is ancestor of another path "+s.toString());i=s}},Xl=function(n,e,t,s){const i=Vt(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const r=[];ie(e,(o,a)=>{const c=new j(o);if(Yn(i,a,X(t,c)),Wr(c)===".priority"&&!fo(a))throw new Error(i+"contains an invalid value for '"+c.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(c)}),e_(i,r)},t_=function(n,e,t){if(ei(e))throw new Error(Vt(n,"priority")+"is "+e.toString()+", but must be a valid Firebase priority (a string, finite number, server value, or null).");if(!fo(e))throw new Error(Vt(n,"priority")+"must be a valid Firebase priority (a string, finite number, server value, or null).")},Zl=function(n,e,t,s){if(!Jl(t))throw new Error(Vt(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},n_=function(n,e,t,s){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Zl(n,e,t)},Ke=function(n,e){if(F(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},s_=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!ho(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!Zg(t))throw new Error(Vt(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class i_{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function li(n,e){let t=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();t!==null&&!Vr(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(i)}t&&n.eventLists_.push(t)}function eu(n,e,t){li(n,t),tu(n,s=>Vr(s,e))}function fe(n,e,t){li(n,t),tu(n,s=>me(s,e)||me(e,s))}function tu(n,e){n.recursionDepth_++;let t=!0;for(let s=0;s<n.eventLists_.length;s++){const i=n.eventLists_[s];if(i){const r=i.path;e(r)?(r_(n.eventLists_[s]),n.eventLists_[s]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function r_(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const s=t.getEventRunner();wn&&se("event: "+t.toString()),sn(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const o_="repo_interrupt",a_=25;class c_{constructor(e,t,s,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new i_,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=As(),this.transactionQueueTree_=new lo,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function l_(n,e,t){if(n.stats_=Br(n.repoInfo_),n.forceRestClient_||Hp())n.server_=new Ns(n.repoInfo_,(s,i,r,o)=>{Pa(n,s,i,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>Ma(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{ee(t)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}n.persistentConnection_=new Oe(n.repoInfo_,e,(s,i,r,o)=>{Pa(n,s,i,r,o)},s=>{Ma(n,s)},s=>{u_(n,s)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(s=>{n.server_.refreshAuthToken(s)}),n.appCheckProvider_.addTokenChangeListener(s=>{n.server_.refreshAppCheckToken(s.token)}),n.statsReporter_=zp(n.repoInfo_,()=>new Gm(n.stats_,n.server_)),n.infoData_=new Bm,n.infoSyncTree_=new Na({startListening:(s,i,r,o)=>{let a=[];const c=n.infoData_.getNode(s._path);return c.isEmpty()||(a=qn(n.infoSyncTree_,s._path,c),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),po(n,"connected",!1),n.serverSyncTree_=new Na({startListening:(s,i,r,o)=>(n.server_.listen(s,r,i,(a,c)=>{const l=o(a,c);fe(n.eventQueue_,s._path,l)}),[]),stopListening:(s,i)=>{n.server_.unlisten(s,i)}})}function nu(n){const t=n.infoData_.getNode(new j(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Qn(n){return Gg({timestamp:nu(n)})}function Pa(n,e,t,s,i){n.dataUpdateCount++;const r=new j(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(i)if(s){const c=vs(t,l=>J(l));o=Ug(n.serverSyncTree_,r,c,i)}else{const c=J(t);o=jl(n.serverSyncTree_,r,c,i)}else if(s){const c=vs(t,l=>J(l));o=Lg(n.serverSyncTree_,r,c)}else{const c=J(t);o=qn(n.serverSyncTree_,r,c)}let a=r;o.length>0&&(a=Qt(n,r)),fe(n.eventQueue_,a,o)}function Ma(n,e){po(n,"connected",e),e===!1&&p_(n)}function u_(n,e){ie(e,(t,s)=>{po(n,t,s)})}function po(n,e,t){const s=new j("/.info/"+e),i=J(t);n.infoData_.updateSnapshot(s,i);const r=qn(n.infoSyncTree_,s,i);fe(n.eventQueue_,s,r)}function ui(n){return n.nextWriteId_++}function d_(n,e,t){const s=Bg(n.serverSyncTree_,e);return s!=null?Promise.resolve(s):n.server_.get(e).then(i=>{const r=J(i).withIndex(e._queryParams.getIndex());dr(n.serverSyncTree_,e,t,!0);let o;if(e._queryParams.loadsAllData())o=qn(n.serverSyncTree_,e._path,r);else{const a=Ln(n.serverSyncTree_,e);o=jl(n.serverSyncTree_,e._path,r,a)}return fe(n.eventQueue_,e._path,o),Fs(n.serverSyncTree_,e,t,null,!0),r},i=>(an(n,"get for query "+ee(e)+" failed: "+i),Promise.reject(new Error(i))))}function h_(n,e,t,s,i){an(n,"set",{path:e.toString(),value:t,priority:s});const r=Qn(n),o=J(t,s),a=ri(n.serverSyncTree_,e),c=ao(o,a,r),l=ui(n),d=to(n.serverSyncTree_,e,c,l,!0);li(n.eventQueue_,d),n.server_.put(e.toString(),o.val(!0),(h,p)=>{const m=h==="ok";m||ce("set at "+e+" failed: "+h);const v=qe(n.serverSyncTree_,l,!m);fe(n.eventQueue_,e,v),st(n,i,h,p)});const u=go(n,e);Qt(n,u),fe(n.eventQueue_,u,[])}function f_(n,e,t,s){an(n,"update",{path:e.toString(),value:t});let i=!0;const r=Qn(n),o={};if(ie(t,(a,c)=>{i=!1,o[a]=Kl(X(e,a),J(c),n.serverSyncTree_,r)}),i)se("update() called with empty data.  Don't do anything."),st(n,s,"ok",void 0);else{const a=ui(n),c=Dg(n.serverSyncTree_,e,o,a);li(n.eventQueue_,c),n.server_.merge(e.toString(),t,(l,d)=>{const u=l==="ok";u||ce("update at "+e+" failed: "+l);const h=qe(n.serverSyncTree_,a,!u),p=h.length>0?Qt(n,e):e;fe(n.eventQueue_,p,h),st(n,s,l,d)}),ie(t,l=>{const d=go(n,X(e,l));Qt(n,d)}),fe(n.eventQueue_,e,[])}}function p_(n){an(n,"onDisconnectEvents");const e=Qn(n),t=As();rr(n.onDisconnect_,W(),(i,r)=>{const o=Kl(i,r,n.serverSyncTree_,e);rn(t,i,o)});let s=[];rr(t,W(),(i,r)=>{s=s.concat(qn(n.serverSyncTree_,i,r));const o=go(n,i);Qt(n,o)}),n.onDisconnect_=As(),fe(n.eventQueue_,W(),s)}function m_(n,e,t){n.server_.onDisconnectCancel(e.toString(),(s,i)=>{s==="ok"&&ir(n.onDisconnect_,e),st(n,t,s,i)})}function Oa(n,e,t,s){const i=J(t);n.server_.onDisconnectPut(e.toString(),i.val(!0),(r,o)=>{r==="ok"&&rn(n.onDisconnect_,e,i),st(n,s,r,o)})}function g_(n,e,t,s,i){const r=J(t,s);n.server_.onDisconnectPut(e.toString(),r.val(!0),(o,a)=>{o==="ok"&&rn(n.onDisconnect_,e,r),st(n,i,o,a)})}function __(n,e,t,s){if(_s(t)){se("onDisconnect().update() called with empty data.  Don't do anything."),st(n,s,"ok",void 0);return}n.server_.onDisconnectMerge(e.toString(),t,(i,r)=>{i==="ok"&&ie(t,(o,a)=>{const c=J(a);rn(n.onDisconnect_,X(e,o),c)}),st(n,s,i,r)})}function v_(n,e,t){let s;F(e._path)===".info"?s=dr(n.infoSyncTree_,e,t):s=dr(n.serverSyncTree_,e,t),eu(n.eventQueue_,e._path,s)}function fr(n,e,t){let s;F(e._path)===".info"?s=Fs(n.infoSyncTree_,e,t):s=Fs(n.serverSyncTree_,e,t),eu(n.eventQueue_,e._path,s)}function y_(n){n.persistentConnection_&&n.persistentConnection_.interrupt(o_)}function an(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),se(t,...e)}function st(n,e,t,s){e&&sn(()=>{if(t==="ok")e(null);else{const i=(t||"error").toUpperCase();let r=i;s&&(r+=": "+s);const o=new Error(r);o.code=i,e(o)}})}function w_(n,e,t,s,i,r){an(n,"transaction on "+e);const o={path:e,update:t,onComplete:s,status:null,order:el(),applyLocally:r,retryCount:0,unwatcher:i,abortReason:null,currentWriteId:null,currentInputSnapshot:null,currentOutputSnapshotRaw:null,currentOutputSnapshotResolved:null},a=mo(n,e,void 0);o.currentInputSnapshot=a;const c=o.update(a.val());if(c===void 0)o.unwatcher(),o.currentOutputSnapshotRaw=null,o.currentOutputSnapshotResolved=null,o.onComplete&&o.onComplete(null,!1,o.currentInputSnapshot);else{Yn("transaction failed: Data returned ",c,o.path),o.status=0;const l=ai(n.transactionQueueTree_,e),d=Tt(l)||[];d.push(o),uo(l,d);let u;typeof c=="object"&&c!==null&&Ee(c,".priority")?(u=_t(c,".priority"),b(fo(u),"Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null.")):u=(ri(n.serverSyncTree_,e)||P.EMPTY_NODE).getPriority().val();const h=Qn(n),p=J(c,u),m=ao(p,a,h);o.currentOutputSnapshotRaw=p,o.currentOutputSnapshotResolved=m,o.currentWriteId=ui(n);const v=to(n.serverSyncTree_,e,m,o.currentWriteId,o.applyLocally);fe(n.eventQueue_,e,v),di(n,n.transactionQueueTree_)}}function mo(n,e,t){return ri(n.serverSyncTree_,e,t)||P.EMPTY_NODE}function di(n,e=n.transactionQueueTree_){if(e||hi(n,e),Tt(e)){const t=iu(n,e);b(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&b_(n,Kn(e),t)}else Yl(e)&&ci(e,t=>{di(n,t)})}function b_(n,e,t){const s=t.map(l=>l.currentWriteId),i=mo(n,e,s);let r=i;const o=i.hash();for(let l=0;l<t.length;l++){const d=t[l];b(d.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),d.status=1,d.retryCount++;const u=ae(e,d.path);r=r.updateChild(u,d.currentOutputSnapshotRaw)}const a=r.val(!0),c=e;n.server_.put(c.toString(),a,l=>{an(n,"transaction put response",{path:c.toString(),status:l});let d=[];if(l==="ok"){const u=[];for(let h=0;h<t.length;h++)t[h].status=2,d=d.concat(qe(n.serverSyncTree_,t[h].currentWriteId)),t[h].onComplete&&u.push(()=>t[h].onComplete(null,!0,t[h].currentOutputSnapshotResolved)),t[h].unwatcher();hi(n,ai(n.transactionQueueTree_,e)),di(n,n.transactionQueueTree_),fe(n.eventQueue_,e,d);for(let h=0;h<u.length;h++)sn(u[h])}else{if(l==="datastale")for(let u=0;u<t.length;u++)t[u].status===3?t[u].status=4:t[u].status=0;else{ce("transaction at "+c.toString()+" failed: "+l);for(let u=0;u<t.length;u++)t[u].status=4,t[u].abortReason=l}Qt(n,e)}},o)}function Qt(n,e){const t=su(n,e),s=Kn(t),i=iu(n,t);return E_(n,i,s),s}function E_(n,e,t){if(e.length===0)return;const s=[];let i=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const c=e[a],l=ae(t,c.path);let d=!1,u;if(b(l!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),c.status===4)d=!0,u=c.abortReason,i=i.concat(qe(n.serverSyncTree_,c.currentWriteId,!0));else if(c.status===0)if(c.retryCount>=a_)d=!0,u="maxretry",i=i.concat(qe(n.serverSyncTree_,c.currentWriteId,!0));else{const h=mo(n,c.path,o);c.currentInputSnapshot=h;const p=e[a].update(h.val());if(p!==void 0){Yn("transaction failed: Data returned ",p,c.path);let m=J(p);typeof p=="object"&&p!=null&&Ee(p,".priority")||(m=m.updatePriority(h.getPriority()));const I=c.currentWriteId,E=Qn(n),_=ao(m,h,E);c.currentOutputSnapshotRaw=m,c.currentOutputSnapshotResolved=_,c.currentWriteId=ui(n),o.splice(o.indexOf(I),1),i=i.concat(to(n.serverSyncTree_,c.path,_,c.currentWriteId,c.applyLocally)),i=i.concat(qe(n.serverSyncTree_,I,!0))}else d=!0,u="nodata",i=i.concat(qe(n.serverSyncTree_,c.currentWriteId,!0))}fe(n.eventQueue_,t,i),i=[],d&&(e[a].status=2,function(h){setTimeout(h,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(u==="nodata"?s.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):s.push(()=>e[a].onComplete(new Error(u),!1,null))))}hi(n,n.transactionQueueTree_);for(let a=0;a<s.length;a++)sn(s[a]);di(n,n.transactionQueueTree_)}function su(n,e){let t,s=n.transactionQueueTree_;for(t=F(e);t!==null&&Tt(s)===void 0;)s=ai(s,t),e=z(e),t=F(e);return s}function iu(n,e){const t=[];return ru(n,e,t),t.sort((s,i)=>s.order-i.order),t}function ru(n,e,t){const s=Tt(e);if(s)for(let i=0;i<s.length;i++)t.push(s[i]);ci(e,i=>{ru(n,i,t)})}function hi(n,e){const t=Tt(e);if(t){let s=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[s]=t[i],s++);t.length=s,uo(e,t.length>0?t:void 0)}ci(e,s=>{hi(n,s)})}function go(n,e){const t=Kn(su(n,e)),s=ai(n.transactionQueueTree_,e);return Yg(s,i=>{xi(n,i)}),xi(n,s),Ql(s,i=>{xi(n,i)}),t}function xi(n,e){const t=Tt(e);if(t){const s=[];let i=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(b(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(b(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),i=i.concat(qe(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&s.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?uo(e,void 0):t.length=r+1,fe(n.eventQueue_,Kn(e),i);for(let o=0;o<s.length;o++)sn(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class N_{constructor(e,t){this._repo=e,this._path=t}cancel(){const e=new ve;return m_(this._repo,this._path,e.wrapCallback(()=>{})),e.promise}remove(){Ke("OnDisconnect.remove",this._path);const e=new ve;return Oa(this._repo,this._path,null,e.wrapCallback(()=>{})),e.promise}set(e){Ke("OnDisconnect.set",this._path),Us("OnDisconnect.set",e,this._path,!1);const t=new ve;return Oa(this._repo,this._path,e,t.wrapCallback(()=>{})),t.promise}setWithPriority(e,t){Ke("OnDisconnect.setWithPriority",this._path),Us("OnDisconnect.setWithPriority",e,this._path,!1),t_("OnDisconnect.setWithPriority",t);const s=new ve;return g_(this._repo,this._path,e,t,s.wrapCallback(()=>{})),s.promise}update(e){Ke("OnDisconnect.update",this._path),Xl("OnDisconnect.update",e,this._path);const t=new ve;return __(this._repo,this._path,e,t.wrapCallback(()=>{})),t.promise}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _o{constructor(e,t,s,i){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=i}get key(){return U(this._path)?null:Wr(this._path)}get ref(){return new Te(this._repo,this._path)}get _queryIdentifier(){const e=ya(this._queryParams),t=Fr(e);return t==="{}"?"default":t}get _queryObject(){return ya(this._queryParams)}isEqual(e){if(e=oe(e),!(e instanceof _o))return!1;const t=this._repo===e._repo,s=Vr(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+mm(this._path)}}class Te extends _o{constructor(e,t){super(e,t,new qr,!1)}get parent(){const e=El(this._path);return e===null?null:new Te(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Jt{constructor(e,t,s){this._node=e,this.ref=t,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new j(e),s=$n(this.ref,e);return new Jt(this._node.getChild(t),s,Q)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new Jt(i,$n(this.ref,s),Q)))}hasChild(e){const t=new j(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function $(n,e){return n=oe(n),n._checkNotDeleted("ref"),e!==void 0?$n(n._root,e):n._root}function $n(n,e){return n=oe(n),F(n._path)===null?n_("child","path",e):Zl("child","path",e),new Te(n._repo,X(n._path,e))}function A_(n){return n=oe(n),new N_(n._repo,n._path)}function au(n,e){n=oe(n),Ke("push",n._path),Us("push",e,n._path,!0);const t=nu(n._repo),s=S_(t),i=$n(n,s),r=$n(n,s);let o;return e!=null?o=cn(r,e).then(()=>r):o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function gn(n){return Ke("remove",n._path),cn(n,null)}function cn(n,e){n=oe(n),Ke("set",n._path),Us("set",e,n._path,!1);const t=new ve;return h_(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function It(n,e){Xl("update",e,n._path);const t=new ve;return f_(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function vo(n){n=oe(n);const e=new ou(()=>{}),t=new fi(e);return d_(n._repo,n,t).then(s=>new Jt(s,new Te(n._repo,n._path),n._queryParams.getIndex()))}class fi{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const s=t._queryParams.getIndex();return new T_("value",this,new Jt(e.snapshotNode,new Te(t._repo,t._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new R_(this,e,t):null}matches(e){return e instanceof fi?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function P_(n,e,t,s,i){let r;if(typeof s=="object"&&(r=void 0,i=s),typeof s=="function"&&(r=s),i&&i.onlyOnce){const c=t,l=(d,u)=>{fr(n._repo,n,a),c(d,u)};l.userCallback=t.userCallback,l.context=t.context,t=l}const o=new ou(t,r||void 0),a=new fi(o);return v_(n._repo,n,a),()=>fr(n._repo,n,a)}function ln(n,e,t,s){return P_(n,"value",e,t,s)}function pi(n,e,t){fr(n._repo,n,null)}Tg(Te);Mg(Te);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function H_(n){Tp(tn),jt(new vt("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return D_(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),Je(na,sa,n),Je(na,sa,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class W_{constructor(e,t){this.committed=e,this.snapshot=t}toJSON(){return{committed:this.committed,snapshot:this.snapshot.toJSON()}}}function le(n,e,t){var s;if(n=oe(n),Ke("Reference.transaction",n._path),n.key===".length"||n.key===".keys")throw"Reference.transaction failed: "+n.key+" is a read-only object.";const i=(s=void 0)!==null&&s!==void 0?s:!0,r=new ve,o=(c,l,d)=>{let u=null;c?r.reject(c):(u=new Jt(d,new Te(n._repo,n._path),Q),r.resolve(new W_(l,u)))},a=ln(n,()=>{});return w_(n._repo,n._path,e,o,a,i),r.promise}Oe.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};Oe.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};H_();const _n={apiKey:"AIzaSyARFa-vzKVmIdxP5xDRXVzasL2ui94eZ-w",authDomain:"market-6e66a.firebaseapp.com",databaseURL:"https://market-6e66a-default-rtdb.firebaseio.com",projectId:"market-6e66a",storageBucket:"market-6e66a.firebasestorage.app",messagingSenderId:"402312269082",appId:"1:402312269082:web:cf304afc54057ea162b0a3"},cu=!!_n.apiKey&&!_n.apiKey.startsWith("여기에")&&!!_n.databaseURL&&!_n.databaseURL.startsWith("여기에");let Di=null,yo=null,L=null;try{cu&&(Di=gc(_n),yo=kp(Di),L=U_(Di))}catch(n){console.error("[firebase] 초기화 실패:",n)}const Ht=1e7,Ue=10,mr=4e3,V_=.008,La=3e4,j_=4e-5,$a=.015,G_=.55,lu=15e-5,z_=.0018,q_=3*60*1e3,K_=["달빛전자","구름소프트","번개모빌리티","바다식품","별빛바이오","한입게임즈","초록에너지","솜사탕유통","무지개항공","도토리금융","은하반도체","포근화학","두근로보틱스","새벽엔터","고래물산","민들레제약"],Y_=["떡상테크","유니콘소프트","미래모빌","첫걸음바이오","샛별에너지","루키게임즈","신화엔터","퀀텀반도체"],Fa=["개미부대","왕개미","큰손","수상한세력","외국인","기관","전설의단타","스캘퍼","장기투자자","물타기달인"];function ht(n,e){return Math.floor(Math.random()*(e-n+1))+n}function Y(n,e){return Math.random()*(e-n)+n}function _e(n,e,t){return Math.max(e,Math.min(t,n))}function Q_(n){const e=[...n];for(let t=e.length-1;t>0;t--){const s=Math.floor(Math.random()*(t+1));[e[t],e[s]]=[e[s],e[t]]}return e}function J_(n,e,t={}){const s=t.type||"stock",i=t.role||null;e=Ce(Math.max(Ue,e));let r=1,o=1;return s==="stock"?i==="leader"?(r=Y(.8,1.4),o=Y(2,3)):i==="sub"?(r=Y(.9,1.6),o=Y(1.2,2.2)):i==="related"?(r=Y(.7,2),o=Y(.6,1.8)):(r=Y(.5,2.4),o=Y(.3,1.2)):s==="preferred"?(r=Y(.4,.8),o=Y(.5,1.1)):s==="etf"?(r=Y(.5,.8),o=Y(1.5,2.5)):s==="reit"?(r=Y(.35,.7),o=Y(.6,1.2)):s==="bond"?(r=Y(.2,.45),o=Y(.8,1.4)):s==="spac"?(r=Y(.2,.5),o=Y(.4,.9)):s==="commodity"?(r=Y(.9,1.8),o=Y(1,2)):(s==="inverse"||s==="leverage")&&(r=1,o=Y(1.5,2.5)),{name:n,type:s,role:i||"",sector:t.sector||"",link:t.link||"",price:e,previousPrice:e,basePrice:e,open:e,high:e,low:e,changeRate:0,volume:0,value:0,pressure:0,trend:0,volat:+r.toFixed(2),activ:+o.toFixed(2),heat:0,news:""}}function mi(n){return{preferred:"우선주",etf:"ETF",reit:"리츠",spac:"SPAC",inverse:"인버스",leverage:"레버리지",bond:"채권ETF",commodity:"원자재"}[n]||""}function uu(n){return{leader:"대장주",sub:"부대장주",related:"관련주",normal:"일반주"}[n]||""}function Li(n){return!n||n==="stock"}function gi(n){return Math.round(n*1.3)}function _i(n){return Math.max(Ue,Math.round(n*.7))}function du(n){return n<2e3?1:n<5e3?5:n<2e4?10:n<5e4?50:n<2e5?100:500}function Ce(n){const e=du(n);return Math.round(n/e)*e}function $i(n){return _e((n.pressure||0)*j_/(n.activ||1),-$a,$a)}async function X_(n,e){const t=e.stocks||{},s=Object.keys(t);if(s.length===0)return;let i=null,r=0,o="";const a=Date.now(),c={},l=[];function d(E){const _=(E.activ||1)*(1+(E.heat||0));let y=0,T=0;const w=_e(.35+_*.2,.25,.97);if(Math.random()<w){const C=ht(1,Math.max(2,Math.round(1+_*3)));for(let M=0;M<C;M++){const N=ht(10,Math.round(60+_*220)),g=.5+_e((E.trend||0)*15,-.3,.3),k=Math.random()<g;y+=k?N:-N,T+=N,l.push({nickname:Fa[ht(0,Fa.length-1)],type:k?"buy":"sell",stockName:E.name,qty:N,price:E.price,time:a})}}return T+=Math.round(ht(300,2500)*_),{botNet:y,botVolume:T}}function u(E,_,y,T,w={}){const C=_.basePrice||_.price,M=C?(_.price-C)/C:0;y+=_e(-M*.01,-.006,.006);let N=Ce(_.price*(1+y));N=_e(N,_i(C),gi(C)),N=Math.max(Ue,N);const g=`stocks/${E}/`;if(c[g+"previousPrice"]=_.price,c[g+"price"]=N,c[g+"changeRate"]=+((N-C)/C*100).toFixed(2),c[g+"volume"]=(_.volume||0)+T,c[g+"value"]=(_.value||0)+T*N,N>(_.high||_.price)&&(c[g+"high"]=N),N<(_.low||_.price)&&(c[g+"low"]=N),(_.pressure||0)!==0){const k=(_.pressure||0)*G_;c[g+"pressure"]=Math.abs(k)<1?0:+k.toFixed(2)}return w.trend!=null&&(c[g+"trend"]=+w.trend.toFixed(5)),w.heat!=null&&(w.heat>.001||(_.heat||0)>.001)&&(c[g+"heat"]=+w.heat.toFixed(3)),w.news!=null&&(c[g+"news"]=w.news),N/_.price-1}function h(E){const _=E.volat||1;let y=(E.heat||0)*.92;Math.random()<.006&&(y=_e(y+Y(.3,1),0,1.6));const T=_*(1+y*.5),w=_e((E.trend||0)*.96+(Math.random()-.5)*8e-4*T,-.0025*(1+y*.5),.0025*(1+y*.5));let C=(Math.random()-.5)*.0016*T+w;return Math.random()<.005&&(C+=(Math.random()-.5)*.012*(1+y*.4)),{own:C,trend:w,heat:y}}const p={},m={},v=[];for(const E of s){const _=t[E];if(!Li(_.type)||_.role!=="leader")continue;const{own:y,trend:T,heat:w}=h(_),{botNet:C,botVolume:M}=d({..._,heat:w});let N=y+$i(_)+_e(C*2e-4,-.008,.008);E===i&&(N+=r);const g=u(E,_,N,M,{trend:T,heat:w,news:E===i?o:null});p[E]=g,m[_.sector]=g,v.push(g)}for(const E of s){const _=t[E];if(!Li(_.type)||_.role==="leader")continue;const y=_.role==="related"?.7:_.role==="sub"?.45:.2,T=m[_.sector]||0,{own:w,trend:C,heat:M}=h(_),{botNet:N,botVolume:g}=d({..._,heat:M});let k=T*y+w*(1-y*.5);k+=$i(_)+_e(N*2e-4,-.008,.008),E===i&&(k+=r);const S=u(E,_,k,g,{trend:C,heat:M,news:E===i?o:null});p[E]=S,v.push(S)}const I=v.length?v.reduce((E,_)=>E+_,0)/v.length:0;for(const E of s){const _=t[E];if(Li(_.type))continue;const{botNet:y,botVolume:T}=d(_),w=Math.random()-.5;let C=0;switch(_.type){case"etf":C=I+w*.0015;break;case"inverse":C=-I+w*.0015;break;case"leverage":C=2*I+w*.002;break;case"bond":C=-.25*I+2e-4+w*.0012;break;case"reit":C=.2*I+2e-4+w*.004*(_.volat||1);break;case"commodity":C=w*.011*(_.volat||1)+(Math.random()<.01?(Math.random()-.5)*.05:0);break;case"preferred":C=(m[_.sector]||p[_.link]||0)*.85+w*.002;break;case"spac":C=w*.003+(Math.random()<.008?(Math.random()<.7?1:-1)*Y(.06,.2):0);break;default:C=w*.005}C+=$i(_)+_e(y*3e-4,-.01,.01),u(E,_,C,T,{})}c.marketTick=a,Q_(l),c.botFeed=l.slice(0,4),await It($(L,`rooms/${n}`),c)}function Fi(n){return Math.round(n||0).toLocaleString("ko-KR")}async function Z_(n,e){const t=Date.now(),s=e.stocks||{},i=e.ipo;if(i&&i.status==="subscribing"){if(t<i.endsAt)return;const h=i.applies||{},p=Object.values(h).reduce((T,w)=>T+(w||0),0),m=(i.botDemand||0)+p,v=Math.max(1,m/i.totalShares),I=_e(.92+(v-1)*.1+Y(-.1,.15),.9,2.3),E=Math.max(Ue,Ce(i.offerPrice*I)),_=J_(i.name,E,{type:"stock",role:"normal",sector:"신규상장"});_.ipo=!0;const y=((E-i.offerPrice)/i.offerPrice*100).toFixed(1);await It($(L,`rooms/${n}`),{[`stocks/${i.stockId}`]:_,ipo:null,latestNews:{text:`🎉 ${i.name} 상장! 공모가 ${Fi(i.offerPrice)} → 시초가 ${Fi(E)} (${y>=0?"+":""}${y}%) · 경쟁률 ${v.toFixed(1)}:1`,time:t}});for(const[T,w]of Object.entries(h)){const C=w||0,M=Math.floor(C/v),N=i.offerPrice*(C-M);await le($(L,`rooms/${n}/players/${T}`),g=>g&&(N>0&&(g.cash=(g.cash||0)+N),M>0&&(g.holdings=g.holdings||{},g.holdings[i.stockId]=(g.holdings[i.stockId]||0)+M),g))}return}if(i||Object.keys(s).length>=90||Math.random()>=V_)return;const r=Object.values(s).map(h=>h.name),o=[...K_,...Y_].filter(h=>!r.includes(h));if(!o.length)return;const a=o[ht(0,o.length-1)],c=Ce(ht(5e3,6e4)),l=ht(5e4,2e5),d=Math.floor(l*Y(.4,9)),u="ipo"+t.toString(36);await It($(L,`rooms/${n}`),{ipo:{stockId:u,name:a,offerPrice:c,totalShares:l,botDemand:d,status:"subscribing",startedAt:t,endsAt:t+La},latestNews:{text:`공모주 청약 시작! '${a}' 공모가 ${Fi(c)}원 · ${Math.round(La/1e3)}초 후 마감`,time:t}})}async function ev(n,e,t,s){const i=s.ipo;if(!i||i.status!=="subscribing")throw new Error("청약 가능한 공모주가 없습니다.");if(Date.now()>=i.endsAt)throw new Error("청약이 마감되었습니다.");if(t=Math.floor(t),!t||t<1)throw new Error("청약 수량을 확인하세요.");const r=i.offerPrice*t;if(!(await le($(L,`rooms/${n}/players/${e}/cash`),a=>{if(a==null)return a;if(!(a<r))return a-r})).committed)throw new Error("청약 증거금(현금)이 부족합니다.");await le($(L,`rooms/${n}/ipo/applies/${e}`),a=>(a||0)+t)}function tv(n){if(!n)return 0;const e=Object.values(n.applies||{}).reduce((t,s)=>t+(s||0),0);return((n.botDemand||0)+e)/n.totalShares}async function Bs(n,e,t,s,i,r,o,a){var v;const c=(v=a.stocks)==null?void 0:v[s];if(!c)throw new Error("종목을 선택하세요.");const l=i.side;if(l!=="buy"&&l!=="sell")throw new Error("주문 유형 오류");const d=i.trigger==="above"?"above":"below",u=["gtc","day","ioc"].includes(i.tif)?i.tif:"gtc";if(r=Math.floor(r),!r||r<1)throw new Error("수량을 확인하세요.");if(o=Ce(Number(o)),!o||o<Ue)throw new Error("주문 가격을 확인하세요.");const h=Date.now(),p={uid:e,nickname:t,stockId:s,stockName:c.name,side:l,trigger:d,tif:u,label:i.label||"지정가",qty:r,target:o,createdAt:h,expiresAt:u==="day"?h+q_:null},m=au($(L,`rooms/${n}/orders`)).key;return await cn($(L,`rooms/${n}/orders/${m}`),p),m}async function nv(n,e){await gn($(L,`rooms/${n}/orders/${e}`))}async function sv(n,e){var i;const t=e.orders;if(!t)return;const s=Date.now();for(const[r,o]of Object.entries(t)){const a=(i=e.stocks)==null?void 0:i[o.stockId];if(!a){await gn($(L,`rooms/${n}/orders/${r}`));continue}const c=a.price;if((o.trigger||(o.side==="buy"?"below":"above"))==="below"?c<=o.target:c>=o.target){try{o.side==="buy"?await wo(n,o.uid,o.nickname,o.stockId,o.qty,e):await vi(n,o.uid,o.nickname,o.stockId,o.qty,e)}catch(u){console.warn("[order] 예약 체결 실패, 취소:",o,u==null?void 0:u.message)}await gn($(L,`rooms/${n}/orders/${r}`));continue}o.tif==="ioc"?await gn($(L,`rooms/${n}/orders/${r}`)):o.expiresAt&&s>o.expiresAt&&await gn($(L,`rooms/${n}/orders/${r}`))}}function iv(n,e){const t=n.orders||{};return Object.entries(t).filter(([,s])=>s.uid===e).map(([s,i])=>({id:s,...i})).sort((s,i)=>(i.createdAt||0)-(s.createdAt||0))}async function wo(n,e,t,s,i,r){var d;const o=(d=r.stocks)==null?void 0:d[s];if(!o)throw new Error("종목을 선택하세요.");if(i=Math.floor(i),!i||i<1)throw new Error("수량을 확인하세요.");const a=o.price,c=Math.ceil(a*i*(1+lu));if(!(await le($(L,`rooms/${n}/players/${e}`),u=>{if(!u)return u;if((u.cash||0)<c)return;u.cash=(u.cash||0)-c,u.holdings=u.holdings||{};const h=u.holdings[s]||0;u.avgCost=u.avgCost||{};const p=u.avgCost[s]||0;return u.avgCost[s]=Math.round((h*p+i*a)/(h+i)),u.holdings[s]=h+i,u})).committed)throw new Error("현금(수수료 포함)이 부족합니다.");await fu(n,s,i,+i,{type:"buy",nickname:t,stockName:o.name,qty:i,price:a,time:Date.now()})}async function vi(n,e,t,s,i,r){var d;const o=(d=r.stocks)==null?void 0:d[s];if(!o)throw new Error("종목을 선택하세요.");if(i=Math.floor(i),!i||i<1)throw new Error("수량을 확인하세요.");const a=o.price,c=Math.floor(a*i*(1-lu-z_));if(!(await le($(L,`rooms/${n}/players/${e}`),u=>{var p;if(!u)return u;const h=((p=u.holdings)==null?void 0:p[s])||0;if(!(h<i))return u.cash=(u.cash||0)+c,u.holdings[s]=h-i,u.holdings[s]===0&&(delete u.holdings[s],u.avgCost&&delete u.avgCost[s]),u})).committed)throw new Error("보유 수량이 부족합니다.");await fu(n,s,i,-i,{type:"sell",nickname:t,stockName:o.name,qty:i,price:a,time:Date.now()})}async function hu(n,e,t,s,i){var o,a,c;const r=((c=(a=(o=i.players)==null?void 0:o[e])==null?void 0:a.holdings)==null?void 0:c[s])||0;if(r<1)throw new Error("보유 수량이 없습니다.");return vi(n,e,t,s,r,i)}async function fu(n,e,t,s,i){await Promise.all([le($(L,`rooms/${n}/stocks/${e}/volume`),r=>(r||0)+t),le($(L,`rooms/${n}/stocks/${e}/value`),r=>(r||0)+t*i.price),le($(L,`rooms/${n}/stocks/${e}/pressure`),r=>(r||0)+s),au($(L,`rooms/${n}/logs`),i)])}function bo(n,e){var i;let t=(n==null?void 0:n.cash)||0;const s=(n==null?void 0:n.holdings)||{};for(const[r,o]of Object.entries(s)){const a=((i=e==null?void 0:e[r])==null?void 0:i.price)||0;t+=a*o}return t}function pu(n,e){return Object.entries(n||{}).map(([t,s])=>({uid:t,nickname:s.nickname&&String(s.nickname).trim()||"플레이어-"+String(t).slice(-4),connected:s.connected!==!1,total:bo(s,e)})).sort((t,s)=>s.total-t.total)}const rv=1,Hs=[{key:"candles1m",win:6e4,cap:240},{key:"candles5m",win:3e5,cap:288},{key:"candles15m",win:9e5,cap:192},{key:"candles1h",win:36e5,cap:168}],mu=2*6e4,ov=6e4,av=4500;function gr(n,e){return Math.floor(n/e)*e}function us(n,e,t){return Math.max(e,Math.min(t,n))}function Ua(){let n=0,e=0;for(;n===0;)n=Math.random();for(;e===0;)e=Math.random();return Math.sqrt(-2*Math.log(n))*Math.cos(2*Math.PI*e)}function Ba(n,e){const t=n&&n[e]||null;return t?Object.values(t).filter(s=>s&&typeof s.t=="number").sort((s,i)=>s.t-i.t):[]}function cv(n,e,t,s){const i=(t-e)/s,r=Math.max(1,i/4e3),o=n.volat||1,a=n.activ||1,c=n.basePrice||n.price||Ue;let l=n.price||c,d=n.trend||0,u=n.heat||0;const h=!n.type||n.type==="stock",p=.0011*o*(h?1:.7),m=5,v=[];for(let I=0;I<s;I++){const E=e+i*I,_=l,y=r/m;let T=_,w=_,C=_;for(let S=0;S<m;S++){d=us(d*Math.pow(.99,y)+Ua()*18e-5*o*Math.sqrt(y),-.0016,.0016),Math.random()<.005*y&&(u=us(u+(.3+Math.random()*.7),0,1.6)),u*=Math.pow(.94,y);const H=p*(1+u*.5);let A=d*y+Ua()*H*Math.sqrt(y);Math.random()<.0025*y&&(A+=(Math.random()<.5?1:-1)*(.006+Math.random()*.018)*(h?1:.6)),C=C*(1+A),C=c+(C-c)*Math.exp(-.01*y),C=us(C,_i(c),gi(c)),C=Math.max(Ue,C),T=Math.max(T,C),w=Math.min(w,C)}const M=Ce(C),N=_?Math.abs((M-_)/_):0,g=(400+Math.random()*1800)*a*(1+u*.8),k=Math.round(g*r*(1+N*8));v.push({t:E,o:Ce(_),h:Ce(T),l:Ce(w),c:M,v:k}),l=M}return{candles:v,finalPrice:l,finalBase:c}}function lv(n){const e={};for(const t of Hs)e[t.key]={};for(const t of n)for(const s of Hs){const i=gr(t.t,s.win),r=e[s.key],o=r[i];o?(o.h=Math.max(o.h,t.h),o.l=Math.min(o.l,t.l),o.c=t.c,o.v+=t.v):r[i]={t:i,o:t.o,h:t.h,l:t.l,c:t.c,v:t.v}}return e}async function uv(n,e){const t=Date.now();return(await le($(L,`rooms/${n}/market/catchupLock`),i=>{if(!(i&&i.expiresAt&&i.expiresAt>t))return{by:e||"anon",at:t,expiresAt:t+ov}})).committed}async function dv(n){try{await It($(L,`rooms/${n}/market`),{catchupLock:null})}catch{}}function hv(n){if(!n||n.status!=="playing")return!1;const e=n.market&&n.market.lastTickAt||n.marketTick||0;return e?Date.now()-e>=mu:!1}async function fv(n,e,t,s={}){if(!e||!e.stocks)return{applied:!1,reason:"no-stocks"};if(e.status!=="playing")return{applied:!1,reason:"not-playing"};const i=Date.now(),r=e.market&&e.market.lastTickAt||e.marketTick||0,o=i-r;if(!s.force&&o<mu)return{applied:!1,reason:"fresh",elapsed:o};if(!await uv(n,t)&&!s.force)return{applied:!1,reason:"locked"};try{let c=e.stocks||{};try{const v=await vo($(L,`rooms/${n}/stocks`));v.exists()&&(c=v.val())}catch{}const l=Object.keys(c);if(!l.length)return{applied:!1,reason:"no-stocks"};const d=us(Math.round(av/l.length),30,480),u=Math.max(1,Math.round(o/6e4)),h=Math.min(d,u,480),p={};let m=0;for(const v of l){const I=c[v];if(!I||typeof I.price!="number")continue;const E=cv(I,r,i,h),_=lv(E.candles),y=`stocks/${v}/`,T=I.history||{};for(const N of Hs){const k={...T[N.key]||{}};for(const[A,q]of Object.entries(_[N.key])){const Z=k[A];k[A]=Z?{t:q.t,o:Z.o,h:Math.max(Z.h,q.h),l:Math.min(Z.l,q.l),c:q.c,v:(Z.v||0)+q.v}:q}const S=Object.keys(k).map(Number).sort((A,q)=>A-q),H=S.length-N.cap;if(H>0)for(let A=0;A<H;A++)p[y+`history/${N.key}/${S[A]}`]=null;for(const[A,q]of Object.entries(_[N.key]))Number(A)<S[Math.max(0,H)]||(p[y+`history/${N.key}/${A}`]=k[A],m++)}const w=E.finalBase,C=Math.max(Ue,Ce(E.finalPrice)),M=E.candles.reduce((N,g)=>N+(g.v||0),0);p[y+"previousPrice"]=I.price,p[y+"price"]=C,p[y+"currentPrice"]=C,p[y+"changeRate"]=+((C-w)/w*100).toFixed(2),p[y+"volume"]=(I.volume||0)+M,p[y+"value"]=(I.value||0)+M*C,C>(I.high||I.price)&&(p[y+"high"]=C),C<(I.low||I.price)&&(p[y+"low"]=C),I.heat&&(p[y+"heat"]=0),I.pressure&&(p[y+"pressure"]=0)}return p["market/tickMs"]=4e3,p["market/lastTickAt"]=i,p["market/lastHistoryAt"]=i,p["market/lastCatchupAt"]=i,p["market/catchupVersion"]=rv,p["market/catchupBy"]=t||"anon",p["market/catchupLock"]=null,p.marketTick=i,await It($(L,`rooms/${n}`),p),{applied:!0,elapsed:o,numSteps:h,candlesWritten:m,stocks:l.length}}catch(c){return await dv(n),console.error("[catchup] 실패:",c),{applied:!1,reason:"error",error:c==null?void 0:c.message}}}function pv(){return{cur:{},lastBucket:0,seeded:!1}}async function mv(n,e,t){const s=e.stocks||{},i=Date.now(),r=gr(i,6e4);t.lastBucket||(t.lastBucket=r);for(const[d,u]of Object.entries(s)){if(!u||typeof u.price!="number")continue;let h=t.cur[d];(!h||h.t!==r)&&(h={t:r,o:u.price,h:u.price,l:u.price,c:u.price,v:0,_lastVol:u.volume||0},t.cur[d]=h),h.c=u.price,h.h=Math.max(h.h,u.price),h.l=Math.min(h.l,u.price);const p=Math.max(0,(u.volume||0)-(h._lastVol||0));h.v+=p,h._lastVol=u.volume||0}if(r===t.lastBucket)return;const o=t.lastBucket;let a=s;try{const d=await vo($(L,`rooms/${n}/stocks`));d.exists()&&(a=d.val())}catch{}const c={};let l=!1;for(const d of Object.keys(s)){const u=t.cur[d];if(!u)continue;const h={o:u.o,h:u.h,l:u.l,c:u.c,v:u.v},p=`stocks/${d}/`,m=a[d]&&a[d].history||{};for(const v of Hs){const I=gr(o,v.win),E=m[v.key]&&m[v.key][I]||null,_=E?{t:I,o:E.o,h:Math.max(E.h,h.h),l:Math.min(E.l,h.l),c:h.c,v:(E.v||0)+h.v}:{t:I,o:h.o,h:h.h,l:h.l,c:h.c,v:h.v};c[p+`history/${v.key}/${I}`]=_;const y=m[v.key]?Object.keys(m[v.key]).map(Number).sort((T,w)=>T-w):[];y.length>v.cap&&y[0]!==I&&(c[p+`history/${v.key}/${y[0]}`]=null)}l=!0}if(t.lastBucket=r,!!l){c["market/lastTickAt"]=i,c["market/lastHistoryAt"]=i,c["market/tickMs"]=4e3;try{await It($(L,`rooms/${n}`),c)}catch(d){console.warn("[history] 라이브 캔들 저장 실패:",d==null?void 0:d.message)}}}function gu(n,e){if(n&&String(n).startsWith("ipo"))return'<span class="tag tag-new">NEW</span>';const t=mi(e.type);return t?`<span class="tag ${e.type==="inverse"?"tag-inv":e.type==="leverage"?"tag-lev":"tag-etf"}">${t}</span>`:e.role==="leader"?'<span class="tag tag-leader">대장주</span>':e.role==="sub"?'<span class="tag tag-sub">부대장</span>':""}function R(n){return document.getElementById(n)}function Mt(n){return Math.round(n??0).toLocaleString("ko-KR")+"원"}function x(n){return Math.round(n??0).toLocaleString("ko-KR")}function Ct(n){return n=n||0,n>=1e12?(n/1e12).toFixed(2)+"조":n>=1e8?(n/1e8).toFixed(1)+"억":n>=1e4?Math.round(n/1e4).toLocaleString("ko-KR")+"만":x(n)}function gv(n){return x(n)+"주"}const _v=["screen-auth","screen-wait","screen-game","screen-result"];function Eo(n){_v.forEach(e=>{const t=R(e);t&&t.classList.toggle("hidden",e!==n)})}function vv(n,e,t=!0){const s=R(n);s&&(s.textContent="",s.classList.toggle("error",t))}function _u(n){R("fbError").classList.remove("hidden"),n&&(R("fbErrorMsg").textContent=n)}const yv=3,wv=120,Ha=60;let Re={},kn=[],He={},Ot=0,Fn=null,_r={};function vu(){Re={},kn=[],He={},Ot=0,Fn=null,_r={},Gs="";for(const n in js)delete js[n]}function bv(){if(Fn)try{localStorage.setItem(Fn,JSON.stringify({candles:Re,lastVol:He,tick:Ot}))}catch{}}function Ev(n,e){const t=n.stocks||{},s=n.marketTick||0,i=`mb_candles_${e||"x"}_${n.startedAt||0}`;if(i!==Fn){Fn=i,Re={},He={},Ot=0;try{const r=JSON.parse(localStorage.getItem(i)||"null");r&&r.candles&&(Re=r.candles,He=r.lastVol||{},Ot=r.tick||0)}catch{}}for(const[r,o]of Object.entries(t))Re[r]||(Re[r]=[{t:Date.now(),o:o.price,h:o.price,l:o.price,c:o.price,v:0,_n:0}]),He[r]==null&&(He[r]=o.volume||0);if(s!==Ot){Ot=s;for(const[o,a]of Object.entries(t)){const c=Re[o]||(Re[o]=[]);let l=c[c.length-1];(!l||l._n>=yv)&&(l={t:Date.now(),o:a.price,h:a.price,l:a.price,c:a.price,v:0,_n:0},c.push(l)),l.c=a.price,l.h=Math.max(l.h,a.price),l.l=Math.min(l.l,a.price);const d=Math.max(0,(a.volume||0)-(He[o]||0));l.v+=d,He[o]=a.volume||0,l._n++,c.length>wv&&c.shift()}const r=n.botFeed?Object.values(n.botFeed):[];for(const o of r)kn.unshift({...o,bot:!0});kn.length>Ha&&(kn.length=Ha),Sv(t),sy(t),bv()}}let xt=new Set(JSON.parse(localStorage.getItem("mb_watch")||"[]")),mt=JSON.parse(localStorage.getItem("mb_alerts")||"{}");function Iv(n){xt.has(n)?xt.delete(n):xt.add(n),localStorage.setItem("mb_watch",JSON.stringify([...xt]))}function Cv(n,e){e>0?mt[n]=e:delete mt[n],localStorage.setItem("mb_alerts",JSON.stringify(mt))}function kv(n){return mt[n]||0}function Sv(n){for(const e of Object.values(n)){const t=mt[e.name],s=_r[e.name];if(t&&s!=null){const i=s<t&&e.price>=t,r=s>t&&e.price<=t;if(i||r){O(`🔔 ${e.name} 알림가 ${x(t)}원 ${i?"돌파":"하향"}!`,i?"up":"down"),delete mt[e.name],localStorage.setItem("mb_alerts",JSON.stringify(mt));try{window.Notification&&Notification.permission==="granted"&&new Notification("STONK Battle",{body:`${e.name} ${x(t)}원 도달`})}catch{}}}_r[e.name]=e.price}}function Tv(n){const{roomCode:e,roomData:t,uid:s,selectedStockId:i}=n,r=R("gameRoomCode");r&&(r.textContent=e),Ev(t,e),Rv(t,s),qv(t,s),Qv(t,s),Xv(t),Av(t,s),yu(n),Jv(t);const o=xv();o==="home"?(iy(t),$v(t)):o==="detail"?(Fv(t,i),Gv(t,i),Nv(t,s)):o==="feed"?oy(t):o==="screener"?ay(t):o==="account"&&cy(t,s)}function Rv(n,e){var o;const t=(o=n.players)==null?void 0:o[e],s=t&&t.nickname||"나",i=R("navNick");i&&(i.textContent=s);const r=R("navAvatar");r&&(r.textContent=s.slice(0,1).toUpperCase())}function yu(n){const e=n.roomData,t=R("marketStatusChip"),s=R("msDot"),i=R("msLabel"),r=R("marketStatusPanel");if(!e||!t||!s||!i||!r)return;const o=e.market||{},a=o.lastTickAt||e.marketTick||0,c=o.lastCatchupAt||0,l=a?Math.max(0,Math.round((Date.now()-a)/6e4)):null,d=e.hostId===n.uid;let u=0,h=0,p=0,m=0;for(const y of Object.values(e.stocks||{})){const T=y.history;T&&(T.candles1m&&(u+=Object.keys(T.candles1m).length),T.candles5m&&(h+=Object.keys(T.candles5m).length),T.candles15m&&(p+=Object.keys(T.candles15m).length),T.candles1h&&(m+=Object.keys(T.candles1h).length))}const v=u+h+p+m>0,I=l!=null&&l<2;if(s.className="status-dot "+(I?"ok":l==null?"muted":"warn"),i.textContent=I?"시장 최신":l==null?"대기":`${l}분 전`,r.classList.contains("hidden"))return;const E=y=>y?`${gt(new Date(y).getHours())}:${gt(new Date(y).getMinutes())}`:"-",_=(y,T,w)=>`<div class="ms-row"><span>${y}</span><b class="${w||""}">${T}</b></div>`;r.innerHTML=_("방 코드",V(n.roomCode||"-"))+_("연결","연결됨","up")+_("권한",d?"보정 주체 (방장)":"읽기 전용",d?"":"muted")+_("마지막 tick",E(a))+_("마지막 보정",c?E(c):"없음")+_("시장",I?"최신 상태":l==null?"tick 기록 없음":`${l}분 전 데이터 · ${d?"재접속 시 자동 보정":"방장/관리자가 보정"}`,I?"up":"down")+_("캔들",v?`1m ${u} · 5m ${h} · 15m ${p} · 1h ${m}`:"아직 없음")}function Nv(n,e){const t=R("orderList");if(!t)return;const s=iv(n,e);if(!s.length){t.innerHTML="";return}t.innerHTML=s.map(i=>{const r=i.side==="buy"?"up":"down",o=i.tif==="day"?" · 당일":i.tif==="ioc"?" · IOC":"",a=i.label||(i.side==="buy"?"매수":"매도");return`<li class="order-item">
      ...
      </li>`}).join("")}let Ws=0;function Av(n,e){var r;const t=R("ipoPanel");if(!t)return;const s=n.ipo;if(!s||s.status!=="subscribing"){t.classList.add("hidden"),Ws=0;return}Ws=s.endsAt,t.classList.remove("hidden"),R("ipoName").textContent=s.name,R("ipoPrice").textContent=x(s.offerPrice)+"원",R("ipoShares").textContent=x(s.totalShares)+"주",R("ipoRatio").textContent=tv(s).toFixed(1)+" : 1";const i=((r=s.applies)==null?void 0:r[e])||0;R("ipoMyApply").textContent=i?`내 청약 ${x(i)}주 (증거금 ${Ct(i*s.offerPrice)}원)`:"아직 청약하지 않았어요",wu()}function wu(n){const e=R("ipoCountdown");if(!e||!Ws)return;const t=Math.max(0,Math.ceil((Ws-Date.now())/1e3));e.textContent=t+"초",e.classList.toggle("urgent",t<=5)}function rt(n){return n>0?"up":n<0?"down":"flat"}function Jn(n){return n>0?"▲":n<0?"▼":"−"}let Vs="";function Ui(n){Vs=(n||"").trim().toLowerCase()}let bu="all",Eu="value",vr="rising",ds="asset";function Pv(n){bu=n||"all"}function Wa(n){Eu=n||"value"}function Mv(n){vr=n||"rising"}function Ov(n){ds=n||"asset"}function xv(){var n;return((n=document.getElementById("screen-game"))==null?void 0:n.dataset.tab)||"home"}function Dv(n,e){return Vs?[e.name,n,e.ticker,e.sector,e.type,e.role,mi(e.type),uu(e.role),String(n).startsWith("ipo")?"신규상장 new":""].join(" ").toLowerCase().includes(Vs):!0}function Lv(n){let e=0;const t=String(n);for(let s=0;s<t.length;s++)e=e*31+t.charCodeAt(s)>>>0;return 5e6+e%60*8e6}function Iu(n){let e=0;const t=String(n||"");for(let s=0;s<t.length;s++)e=e*31+t.charCodeAt(s)>>>0;return`hsl(${e%360} 60% 47%)`}function Cu(n,e){const t={value:(s,i)=>(i[1].value||0)-(s[1].value||0),volume:(s,i)=>(i[1].volume||0)-(s[1].volume||0),up:(s,i)=>(i[1].changeRate||0)-(s[1].changeRate||0),down:(s,i)=>(s[1].changeRate||0)-(i[1].changeRate||0)};return n.sort(t[e]||t.value)}function ku(n,e,t){const s=t.changeRate>0?"+":"",i=rt(t.changeRate),r=xt.has(t.name),o=t.price*Lv(e),a=t.sector||mi(t.type)||"종목";return`<li class="rank-item" data-id="${e}">
    ...
    <span class="rk-rate ${i}">${Jn(t.changeRate)} ${s}${(t.changeRate??0).toFixed(2)}%</span>
  ...
  </li>`}function $v(n){const e=R("stockList");if(!e)return;const t=e.scrollTop,s=n.stocks||{};let i=Object.entries(s).filter(([r,o])=>Dv(r,o));if(bu==="watch"&&(i=i.filter(([,r])=>xt.has(r.name))),i=Cu(i,Eu),!i.length){e.innerHTML=`<li class="stock-empty">${Vs?"검색 결과 없음":"종목이 없습니다"}</li>`;return}e.innerHTML=i.map(([r,o],a)=>ku(a+1,r,o)).join(""),e.scrollTop=t}function Fv(n,e){const s=(n.stocks||{})[e];if(!s){R("chartStockName").textContent="-",R("selStockPrice").textContent="-",R("selStockChange").textContent="";return}const i=s.basePrice||s.price,r=s.price-i,o=rt(s.changeRate),a=s.changeRate>0?"+":"";R("chartStockName").textContent=s.name;const c=R("detailTag");if(c){const h=mi(s.type),p=uu(s.role);let m,v="virtual-tag";h?(m=h,v+=s.type==="inverse"?" tag-inv":s.type==="leverage"?" tag-lev":" tag-etf"):String(e).startsWith("ipo")?(m="신규상장",v+=" tag-new"):s.sector?(m=p?`${s.sector}·${p}`:s.sector,s.role==="leader"&&(v+=" tag-leader")):m="가상",c.textContent=m,c.className=v}const l=R("selStockPrice"),d=js[e];if(l.textContent=x(s.price),l.className="big-price "+o,d!=null&&s.price!==d){const h=s.price>d?"flash-up":"flash-down";l.classList.remove("flash-up","flash-down"),l.offsetWidth,l.classList.add(h)}js[e]=s.price,R("selStockChange").className="change "+o,R("selStockChange").textContent=`${Jn(s.changeRate)} ${a}${x(r)} (${a}${(s.changeRate??0).toFixed(2)}%)`,Bi("ohlcOpen",s.open,i),Bi("ohlcHigh",s.high,i),Bi("ohlcLow",s.low,i),R("ohlcUpper").textContent=x(gi(i)),R("ohlcLower").textContent=x(_i(i)),R("ohlcVol").textContent=gv(s.volume),R("ohlcValue").textContent=Ct(s.value)+"원";const u=R("selStockNews");u.textContent=s.news?`📰 ${s.news}`:"",u.className="news-line"+(s.news?" "+o:" muted"),Tu(n,e,i,s)}const js={};function Bi(n,e,t){const s=R(n);s.textContent=x(e),s.className="ohlc-v "+rt((e||0)-t)}function ft(n){return getComputedStyle(document.body).getPropertyValue(n).trim()||"#000"}const yr={tick:{win:30*6e4,tiers:["candles1m","candles5m"],count:16},"1d":{win:864e5,tiers:["candles5m","candles1m"],count:288},"3d":{win:2592e5,tiers:["candles1h","candles15m","candles5m"],count:216},"1w":{win:6048e5,tiers:["candles1h","candles15m"],count:224},"1m":{win:2592e6,tiers:["candles1h","candles15m","candles5m","candles1m"],count:360},all:{win:1/0,tiers:["candles1h","candles15m","candles5m","candles1m"],count:500}},Uv={tick:"1틱","1d":"1일","3d":"3일","1w":"1주","1m":"1달",all:"전체"};function Va(n){if(n<=0)return"0분";const e=Math.round(n/6e4);if(e<60)return e+"분";const t=Math.floor(e/60),s=e%60;if(t<24)return s?`${t}시간 ${s}분`:`${t}시간`;const i=Math.floor(t/24),r=t%24;return r?`${i}일 ${r}시간`:`${i}일`}function Bv(n,e){const t=Uv[n]||n;if(!e||!e.length)return t+" · 데이터 없음";if(n==="tick")return"1틱 · 최근 흐름";const s=e[0].t,i=e[e.length-1].t;if(!(s>1e11)||!(i>1e11))return t+" · 최근 흐름";const r=i-s,o=(yr[n]||{}).win;return o&&o!==1/0&&r<o*.9?`${t} · 아직 ${Va(r)} 데이터만 있음`:`${t} · 누적 ${Va(r)} 데이터`}function gt(n){return(n<10?"0":"")+n}function Hv(n,e){if(!(n>1e11))return"";const t=new Date(n),s=gt(t.getHours())+":"+gt(t.getMinutes()),i=t.getMonth()+1+"/"+t.getDate();return e==="tick"||e==="1d"?s:e==="3d"||e==="1w"?i+" "+s:i}function Wv(n){if(!(n>1e11))return"";const e=new Date(n);return e.getMonth()+1+"/"+gt(e.getDate())+" "+gt(e.getHours())+":"+gt(e.getMinutes())}let Sn="1d",hs=-1,re=null,ut=null,ja=!1,Gs="";function Ga(n,e){if(n.length&&e.price!=null&&n[n.length-1].c!==e.price){const t=n[n.length-1],s=t.t>1e11?t.t+1e3:t.t+1;n.push({t:s,o:t.c,h:Math.max(t.c,e.price),l:Math.min(t.c,e.price),c:e.price,v:0,_live:!0})}return n}function Su(n,e,t){const s=yr[t]||yr["1d"],i=n.history||null,r=Re[e]||[],o=Date.now(),a=s.win===1/0?-1/0:o-s.win;if(t==="tick"){let l=r.slice(-12).map((d,u)=>({t:d.t||o-(12-u)*6e3,o:d.o,h:d.h,l:d.l,c:d.c,v:d.v||0}));if(l.length<2&&i){const d=Ba(i,"candles1m");d.length&&(l=d.slice(-s.count).map(u=>({...u})))}return Ga(l,n)}let c=[];if(i)for(const l of s.tiers){let d=Ba(i,l);if(d.length){if(d=d.filter(u=>u.t>=a),d.length>=2){c=d.map(u=>({...u}));break}!c.length&&d.length&&(c=d.map(u=>({...u})))}}return!c.length&&r.length&&(c=r.map((l,d)=>({t:l.t||o-(r.length-d)*6e3,o:l.o,h:l.h,l:l.l,c:l.c,v:l.v||0})).filter(l=>l.t>=a)),c=Ga(c,n),c.length>s.count&&(c=c.slice(c.length-s.count)),c}function Tu(n,e,t,s){ut={room:n,id:e,base:t};const i=Su(s,e,Sn),r=i.length?i[i.length-1]:null,o=`${e}|${Sn}|${i.length}|${r?r.c+":"+r.v:""}|${t}`;if(o===Gs){za();return}Gs=o,hs=-1,Ru(),wr(R("priceChart"),i,t,-1);const a=R("chartRangeNote");a&&(a.textContent=Bv(Sn,i)),za()}function za(){if(ja)return;ja=!0;const n=R("chartPeriods");n&&n.addEventListener("click",t=>{var i;const s=t.target.closest(".cp-btn");if(s&&(Sn=s.dataset.period,n.querySelectorAll(".cp-btn").forEach(r=>r.classList.toggle("is-active",r===s)),ut)){const r=(i=ut.room.stocks)==null?void 0:i[ut.id];r&&Tu(ut.room,ut.id,ut.base,r)}});const e=R("priceChart");if(e){const t=i=>{if(!re)return;const r=e.getBoundingClientRect(),o=(i.touches?i.touches[0].clientX:i.clientX)-r.left,a=Math.max(0,Math.min(re.candles.length-1,Math.floor(o/re.cw)));a!==hs&&(hs=a,wr(e,re.candles,re.base,a),Vv(a))},s=()=>{hs=-1,re&&wr(e,re.candles,re.base,-1),Ru()};e.addEventListener("mousemove",t),e.addEventListener("mouseleave",s),e.addEventListener("touchstart",t,{passive:!0}),e.addEventListener("touchmove",t,{passive:!0}),e.addEventListener("touchend",s)}}function Vv(n){const e=R("chartTip");if(!e||!re)return;const t=re.candles[n];if(!t)return;const s=t.o?(t.c-t.o)/t.o*100:0,i=s>0?"up":s<0?"down":"flat",r=Wv(t.t)||`구간 ${n+1}`;e.innerHTML=`
    ...
    <div class="tip-row"><span>등락률</span><b class="${i}">${s>=0?"+":""}${s.toFixed(2)}%</b></div>`,e.classList.remove("hidden");const o=n*re.cw+re.cw/2,a=o>re.plotW*.6?"left":"right";e.style.left=a==="right"?`${o+10}px`:"",e.style.right=a==="left"?`${re.cssW-o+10}px`:"",e.style.top="8px"}function Ru(){const n=R("chartTip");n&&n.classList.add("hidden")}function wr(n,e,t,s){if(!n)return;const i=window.devicePixelRatio||1,r=n.clientWidth||600,o=n.clientHeight||260;n.width=Math.round(r*i),n.height=Math.round(o*i);const a=n.getContext("2d");if(a.setTransform(i,0,0,i,0,0),a.clearRect(0,0,r,o),!e.length){re=null;return}const c=56,l=r-c,d=o*.18,u=o*.06,h=o-d-u;let p=-1/0,m=1/0,v=0;for(const S of e)p=Math.max(p,S.h),m=Math.min(m,S.l),v=Math.max(v,S.v||0);p===m&&(p+=1,m-=1);const I=(p-m)*.14;p+=I,m-=I;const E=ft("--up"),_=ft("--down"),y="rgba(255,255,255,0.07)",T=ft("--muted"),w=S=>h*(1-(S-m)/(p-m)),C=Math.max(e.length,14),M=l/C,N=Math.max(2.5,Math.min(14,M*.64));re={cw:M,plotW:l,priceH:h,volH:d,cssW:r,cssH:o,candles:e,base:t,lo:m,hi:p},a.font="11px Pretendard, sans-serif",a.textBaseline="middle";const g=4;for(let S=0;S<=g;S++){const H=h/g*S,A=p-(p-m)/g*S;a.strokeStyle=y,a.lineWidth=1,a.beginPath(),a.moveTo(0,Math.round(H)+.5),a.lineTo(l,Math.round(H)+.5),a.stroke(),a.fillStyle=T,a.textAlign="left",a.fillText(x(A),l+6,Math.min(h-6,Math.max(8,H)))}if(s>=0&&s<e.length){const S=s*M+M/2;a.strokeStyle="rgba(120,140,180,0.55)",a.lineWidth=1,a.setLineDash([3,3]),a.beginPath(),a.moveTo(Math.round(S)+.5,0),a.lineTo(Math.round(S)+.5,o),a.stroke(),a.setLineDash([])}e.forEach((S,H)=>{const A=H*M+M/2,Z=S.c>=S.o?E:_;a.strokeStyle=Z,a.fillStyle=Z,a.lineWidth=1,a.beginPath(),a.moveTo(Math.round(A)+.5,w(S.h)),a.lineTo(Math.round(A)+.5,w(S.l)),a.stroke();const pe=w(S.o),ge=w(S.c),Rt=Math.min(pe,ge),at=Math.max(1.5,Math.abs(ge-pe));if(a.fillRect(A-N/2,Rt,N,at),v>0){const un=(d-4)*((S.v||0)/v);a.globalAlpha=.4,a.fillRect(A-N/2,o-un,N,un),a.globalAlpha=1}});const k=e[e.length-1].c;if(k<=p&&k>=m){const S=w(k),A=k>=(t||k)?E:_;a.strokeStyle=A,a.lineWidth=1,a.setLineDash([4,3]),a.beginPath(),a.moveTo(0,Math.round(S)+.5),a.lineTo(l,Math.round(S)+.5),a.stroke(),a.setLineDash([]);const q=x(k);a.font="bold 11px Pretendard, sans-serif";const Z=a.measureText(q).width,pe=Math.min(h-9,Math.max(9,S));a.fillStyle=A,a.beginPath();const ge=l+2,Rt=Math.min(c-4,Z+10),at=17;jv(a,ge,pe-at/2,Rt,at,4),a.fill(),a.fillStyle="#fff",a.textAlign="left",a.fillText(q,ge+5,pe)}if(e.length>=2){a.font="10px Pretendard, sans-serif",a.fillStyle=T;const S=[0,Math.floor((e.length-1)/2),e.length-1],H={};S.forEach(A=>{if(H[A])return;H[A]=1;const q=Hv(e[A].t,Sn);if(!q)return;a.textAlign=A===0?"left":A===e.length-1?"right":"center";const Z=A===0?2:A===e.length-1?l-2:A*M+M/2;a.fillText(q,Z,o-2)})}}function jv(n,e,t,s,i,r){n.beginPath(),n.moveTo(e+r,t),n.arcTo(e+s,t,e+s,t+i,r),n.arcTo(e+s,t+i,e,t+i,r),n.arcTo(e,t+i,e,t,r),n.arcTo(e,t,e+s,t,r),n.closePath()}function Io(){Gs="";const n=R("priceChart");if(n){const e=n.getContext("2d");e&&e.clearRect(0,0,n.width,n.height)}}function Gv(n,e){var l;const t=R("orderbook");if(!t)return;const s=(l=n.stocks)==null?void 0:l[e];if(!s){t.innerHTML="";return}const i=du(s.price),r=s.basePrice||s.price,o=5e4,a=()=>Math.floor((Math.random()*.9+.1)*12e3),c=[];for(let d=5;d>=1;d--){const u=qa(s.price+d*i,r);c.push(Ka(u,a(),"ask",o,r))}c.push(`<div class="ob-current ${rt(s.changeRate)}">${x(s.price)}</div>`);for(let d=1;d<=5;d++){const u=qa(s.price-d*i,r);c.push(Ka(u,a(),"bid",o,r))}t.innerHTML=c.join("")}function qa(n,e){return Math.max(_i(e),Math.min(gi(e),Math.max(Ue,n)))}function Ka(n,e,t,s,i){const r=rt(n-i),o=Math.min(100,e/s*100);return t==="ask"?`<div class="ob-row ask">
  ...
  `,document.body.appendChild(o),(c=o.querySelector("[data-home-go]"))==null||c.addEventListener("click",l=>{l.preventDefault(),location.href=i}),a){let l=Math.ceil(Vi/1e3);const d=o.querySelector("[data-gate-count]"),u=setInterval(()=>{l-=1,d&&(d.textContent=String(Math.max(0,l))),l<=0&&clearInterval(u)},1e3);setTimeout(()=>{location.href=i},Vi)}return o}function Cy(){var n;(n=document.getElementById("stonk-home-gate"))==null||n.remove()}const ky="https://tom981105-web.github.io/STONK-Gacha/backgrounds/";let fs,Ie=null;function Sy(){return Ie||(Ie=document.createElement("div"),Ie.id="equip-bg",Object.assign(Ie.style,{position:"fixed",inset:"0",zIndex:"-1",backgroundSize:"cover",backgroundPosition:"center",backgroundRepeat:"no-repeat",pointerEvents:"none",opacity:"0",transition:"opacity 0.35s ease",transform:"translateZ(0)",backfaceVisibility:"hidden"}),document.body.appendChild(Ie),Ie)}function ec(){if(document.body.classList.remove("has-skin"),Ie){Ie.style.opacity="0";const n=Ie;setTimeout(()=>{fs===null&&n&&(n.style.backgroundImage="")},400)}}function Ty(n,e){let t=0;const s=()=>{if(t>=n.length){e(null);return}const i=n[t++],r=new Image;r.decoding="async",r.onload=()=>e(i),r.onerror=s,r.src=i};s()}function Ry(n){const e=n||null;if(e===fs)return;if(fs=e,!e){ec();return}const t=["webp","jpg","png"].map(s=>`${ky}${e}.${s}`);Ty(t,s=>{if(fs!==e)return;if(!s){ec();return}const i=Sy();i.style.backgroundImage=`radial-gradient(120% 90% at 50% 12%, rgba(10,12,20,0.30) 0%, rgba(8,10,16,0.52) 55%, rgba(6,7,12,0.74) 100%), url("${s}")`,i.style.opacity="1",document.body.classList.add("has-skin")})}const Ny="yaV8N60yIiUggaWNpNF2VhkCwxb2",Ay="tomem@naver.com",yi="MAIN",f={uid:null,email:null,nickname:localStorage.getItem("mb_nickname")||localStorage.getItem("stonk:lastNickname")||"",roomCode:null,roomData:null,selectedStockId:null,tickTimer:null,isDriver:!1,tickLeaseRenewAt:0,driverWatch:null,liveState:pv(),catchupDoneFor:null,clockTimer:null,roomRef:null,lastStatus:null,histRef:null,histStockId:null,selectedHistory:null,renderQueued:!1,joinReqRef:null,joinReqId:null,isDbAdmin:!1,bank:0,bankRef:null},zs=.05,Py=15e3,My=5e3,Oy=4e3;function xy(){return f.uid===Ny||(f.email||"").toLowerCase()===Ay}!cu||!yo||!L?_u("src/firebase.js 에 본인의 Firebase 설정(firebaseConfig)을 붙여넣은 뒤 새로고침하세요."):Dy();function Dy(){let n=!1;const e=setTimeout(()=>{n||_u("Firebase에 연결할 수 없습니다. 설정값과 네트워크, Database Rules를 확인하세요.")},5e3);ln($(L,".info/connected"),t=>{t.val()===!0&&(n=!0,clearTimeout(e),document.getElementById("fbError").classList.add("hidden"))}),Ly()}let ss=null;function Ly(){ln($(L,`rooms/${yi}/broadcast/reloadAt`),n=>{const e=Number(n.val())||0;if(ss===null){ss=e;return}if(e>ss){ss=e;try{O==null||O("새 버전이 배포되어 새로고침합니다…","up")}catch{}setTimeout(()=>location.reload(),400)}}),pf(yo,n=>{if(n)Cy(),f.uid=n.uid,f.email=n.email||null,localStorage.setItem("mb_playerId",n.uid),$y(),Fy();else{f.uid=null,f.email=null,f.isDbAdmin=!1;const e=document.getElementById("navAdmin");e&&(e.hidden=!0),Iy({message:"로그인은 STONK Home에서 진행합니다. Home에서 입장하면 자동으로 연결됩니다."})}})}async function $y(){const n=document.getElementById("navAdmin");if(!n)return;let e=xy();if(!e&&f.uid&&L)try{e=(await vo($(L,"admins/"+f.uid))).val()===!0}catch{e=!1}f.isDbAdmin=e,n.hidden=!e}async function Fy(){if(!f.nickname){Eo("screen-auth");return}Wu(yi)}let ji=!1;async function Uy(n){var s;if(!f.uid)return!1;if(n.players&&n.players[f.uid])return!0;if(ji)return!1;ji=!0;const e=Number((s=n.settings)==null?void 0:s.initialCash)||Ht,t=Date.now();try{await It($(L,`rooms/${yi}/players/${f.uid}`),{nickname:f.nickname&&f.nickname.trim()||"플레이어-"+String(f.uid).slice(-4),cash:e,holdings:null,totalAsset:e,joinedAt:t,connected:!0})}catch(i){return console.warn("[join] 자동 등록 실패:",i),!1}finally{ji=!1}return!0}function Hu(){f.joinReqId=null}function Wu(n){Hu(),f.roomCode=n,localStorage.setItem("mb_roomCode",n),Du(n),e0(n);const e=$(L,`rooms/${n}/players/${f.uid}/connected`);cn(e,!0).catch(()=>{}),A_(e).set(!1).catch(()=>{}),f.roomRef&&pi(f.roomRef),f.roomRef=$(L,`rooms/${n}`),ln(f.roomRef,t=>qy(Hy(t)),t=>{console.error("[room] 구독 오류:",t)}),By()}function By(){f.uid&&(f.bankRef&&pi(f.bankRef),f.bankRef=$(L,`accounts/${f.uid}/balance`),ln(f.bankRef,n=>{f.bank=Number(n.val()||0),zv(f.bank),de()},()=>{}))}function Hy(n){if(!n||!n.exists())return null;const e={};return n.forEach(t=>{if(t.key==="stocks"){const s={};t.forEach(i=>{const r={};i.forEach(o=>{o.key!=="history"&&(r[o.key]=o.val())}),s[i.key]=r}),e.stocks=s}else e[t.key]=t.val()}),e}function Wy(n){const e=f.selectedHistory;e&&e.id&&n&&n.stocks&&n.stocks[e.id]&&(n.stocks[e.id].history=e.data||null)}function qs(n){n!==f.histStockId&&(f.histRef&&(pi(f.histRef),f.histRef=null),f.histStockId=n||null,f.selectedHistory=n?{id:n,data:null}:null,!(!n||!f.roomCode)&&(f.histRef=$(L,`rooms/${f.roomCode}/stocks/${n}/history`),ln(f.histRef,e=>{f.histStockId===n&&(f.selectedHistory={id:n,data:e.val()||null},f.roomData&&f.roomData.stocks&&f.roomData.stocks[n]&&(f.roomData.stocks[n].history=f.selectedHistory.data),de())},e=>console.error("[history] 구독 오류:",e))))}function de(){f.renderQueued||(f.renderQueued=!0,requestAnimationFrame(()=>{f.renderQueued=!1,f.roomData&&f.roomData.status==="playing"&&Tv(f)}))}function Vu(n){const e=n==="dark"?"dark":"light";document.documentElement.dataset.theme=e;try{localStorage.setItem("stonk:theme",e)}catch{}const t=document.getElementById("themeToggle");t&&(t.textContent=e==="dark"?"☀️":"🌙")}function Vy(){let n="light";try{n=localStorage.getItem("stonk:theme")||"light"}catch{}Vu(n)}function jy(){Vu(document.documentElement.dataset.theme==="dark"?"light":"dark")}function vn(n){const e=document.getElementById("screen-game");e&&(e.dataset.tab=n,document.querySelectorAll(".tnav-tab").forEach(t=>t.classList.toggle("is-active",t.dataset.tab===n)),document.querySelectorAll(".tab-view").forEach(t=>t.classList.toggle("hidden",t.dataset.view!==n)),n==="detail"&&Io(),f.roomData&&de())}function Gy(n){n&&(Co(),f.selectedStockId=n,qs(n),t0(n),vn("detail"))}let Gi=null,ps=null;function zy(n){const e=document.getElementById("stockHover");if(!e)return;const t=e.offsetWidth||300,s=e.offsetHeight||240;let i=n.right+12;i+t>window.innerWidth-8&&(i=n.left-t-12),i<8&&(i=8);let r=n.top;r+s>window.innerHeight-8&&(r=window.innerHeight-s-8),r<8&&(r=8),e.style.left=i+"px",e.style.top=r+"px"}function tc(n){const e=document.getElementById(n);e&&(e.addEventListener("mouseover",t=>{const s=t.target.closest(".rank-item");if(!s||!f.roomData)return;const i=s.dataset.id;i!==ps&&(clearTimeout(Gi),Gi=setTimeout(()=>{ps=i,ly(f.roomData,i),zy(s.getBoundingClientRect())},90))}),e.addEventListener("mouseleave",()=>{clearTimeout(Gi),ps=null,Co()}))}function qy(n){if(!n){xe(),br(),Ys(),f.roomData=null,f.lastStatus=null,nc();return}if(f.roomData=n,Wy(n),Ry(n.players&&f.uid&&n.players[f.uid]?n.players[f.uid].equippedBackground:null),n.status==="playing"){if(f.uid&&!(n.players&&n.players[f.uid])){Uy(n);return}if(f.lastStatus!=="playing"){Eo("screen-game"),vu(),Zy();const e=Object.keys(n.stocks||{});!f.selectedStockId&&e.length&&(f.selectedStockId=e[0])}f.selectedStockId!==f.histStockId&&qs(f.selectedStockId),de(),Ky(n),Gu(n),Xy()}else xe(),br(),Ys(),qs(null),Io(),nc();f.lastStatus=n.status}function nc(){Eo("screen-wait");const n=document.getElementById("waitNickname");n&&(n.textContent=f.nickname?`${f.nickname} 님`:"")}async function Ky(n){if(!n||n.status!=="playing"||!f.uid||f.catchupDoneFor===f.roomCode)return;if(!wi(n)){f.catchupDoneFor=f.roomCode;return}const e=n.market&&n.market.lastTickAt||n.marketTick||0;if(e&&e<Yy(n)){f.catchupDoneFor=f.roomCode;try{await cn($(L,`rooms/${f.roomCode}/market/lastTickAt`),Date.now())}catch{}return}if(!hv(n)){f.catchupDoneFor=f.roomCode;return}f.catchupDoneFor=f.roomCode;try{const t=await fv(f.roomCode,n,f.uid);t.applied&&(vu(),O(`시장 경과 보정 완료 (${Math.round(t.elapsed/6e4)}분, 캔들 ${t.candlesWritten}개)`,"up"))}catch(t){console.warn("[catchup] 보정 실패:",t)}}async function ju(){if(!f.roomCode||!f.uid)return!1;const n=Date.now();try{return(await le($(L,`rooms/${f.roomCode}/market/tickLease`),t=>{if(!(t&&t.by!==f.uid&&(t.expiresAt||0)>n))return{by:f.uid,at:n,expiresAt:n+Py}})).committed}catch{return!1}}function Ks(n){const e=n&&n.market||{};let t=Number.isFinite(e.openHour)?Math.round(e.openHour):18,s=Number.isFinite(e.closeHour)?Math.round(e.closeHour):24;return t=Math.max(0,Math.min(24,t)),s=Math.max(0,Math.min(24,s)),{oh:t,ch:s}}function wi(n){const{oh:e,ch:t}=Ks(n);if(e===t)return!0;const s=new Date().getHours();return t>e?s>=e&&s<t:s>=e||s<t}function Yy(n){const{oh:e,ch:t}=Ks(n),s=new Date,i=new Date(s.getFullYear(),s.getMonth(),s.getDate(),e,0,0,0).getTime();return t>=e?i:s.getHours()<t?i-864e5:i}async function Gu(n){var a,c;if(n=n||f.roomData,!n||n.status!=="playing"){xe();return}if(!wi(n)){xe();return}if(!f.uid)return;const e=Date.now(),t=n.market&&n.market.tickLease,s=t&&t.by!==f.uid&&(t.expiresAt||0)>e;if(f.isDriver){s&&xe();return}const i=n.hostId===f.uid,r=n.hostId&&((c=(a=n.players)==null?void 0:a[n.hostId])==null?void 0:c.connected)!==!1;if(s||!i&&r)return;await ju()&&Qy()}function Qy(){f.tickTimer||(f.isDriver=!0,f.tickLeaseRenewAt=Date.now(),f.tickTimer=setInterval(async()=>{const n=f.roomData;if(!n||n.status!=="playing"){xe();return}if(!wi(n)){xe();return}try{if(Date.now()-f.tickLeaseRenewAt>=My){if(!await ju()){xe();return}f.tickLeaseRenewAt=Date.now()}await X_(f.roomCode,n),await Z_(f.roomCode,n),await sv(f.roomCode,n),await mv(f.roomCode,n,f.liveState)}catch(e){console.error("[tick] 시장 틱 오류:",e)}},mr))}function xe(){f.tickTimer&&(clearInterval(f.tickTimer),f.tickTimer=null),f.isDriver=!1}async function Jy(){if(!f.roomCode||!f.uid)return;const n=f.roomCode;try{await le($(L,`rooms/${n}/market/tickLease`),e=>e&&e.by===f.uid?null:e)}catch{}}function Xy(){f.driverWatch||(f.driverWatch=setInterval(()=>{Gu(f.roomData)},Oy))}function br(){f.driverWatch&&(clearInterval(f.driverWatch),f.driverWatch=null)}function Zy(){Ys(),f.clockTimer=setInterval(()=>{const n=f.roomData;if(!n||n.status!=="playing")return;const e=!wi(n),t=document.getElementById("marketClosed");t&&(t.classList.toggle("hidden",!e),e&&(t.textContent=`🌙 장 마감 — 매일 ${String(Ks(n).oh).padStart(2,"0")}:00 개장 (${String(Ks(n).ch%24).padStart(2,"0")}:00 마감)`)),!e&&(ey(Date.now()-(n.startedAt||Date.now())),wu(),Zv(n))},250)}function Ys(){f.clockTimer&&(clearInterval(f.clockTimer),f.clockTimer=null)}function is(){Jy(),xe(),br(),Ys(),Hu(),Io(),f.roomRef&&(pi(f.roomRef),f.roomRef=null),qs(null),location.href=$u()}function e0(n){const e="",t=(s,i)=>{const r=document.getElementById(s);r&&(r.href=i)};t("navBoard",Fu(n)),t("navWiki",Uu(n,e)),t("navAdmin",Bu(n))}async function sc(){if(!f.roomCode||!f.roomData){O("복사할 시장 데이터가 없습니다","err");return}const n={roomCode:f.roomCode,status:f.roomData.status,startedAt:f.roomData.startedAt||null,marketTick:f.roomData.marketTick||Date.now(),latestNews:f.roomData.latestNews||null,botFeed:f.roomData.botFeed||[],stocks:f.roomData.stocks||{},players:f.roomData.players||{},logs:f.roomData.logs||{}},e=JSON.stringify(n,null,2);try{await navigator.clipboard.writeText(e),O("STONK Board에 가져올 시장 데이터를 복사했습니다")}catch{prompt("STONK Board 관리자 화면에 붙여넣을 시장 데이터입니다:",e)}}function Un(){return Math.max(1,Math.floor(Number(document.getElementById("qtyInput").value)||1))}async function zi(n){var a,c;const{roomCode:e,roomData:t,uid:s,nickname:i,selectedStockId:r}=f;if(!t||t.status!=="playing")return;if(!r){O("종목을 먼저 선택하세요","err");return}const o=((c=(a=t.stocks)==null?void 0:a[r])==null?void 0:c.name)||"";try{n==="buy"?(await wo(e,s,i,r,Un(),t),O(`${o} 매수 체결!`,"up")):n==="sell"?(await vi(e,s,i,r,Un(),t),O(`${o} 매도 체결!`,"down")):n==="sellAll"&&(await hu(e,s,i,r,t),O(`${o} 전량 매도 체결!`,"down")),vv("tradeMsg","",!1)}catch(l){O(l.message,"err")}}function Qs(n){return Math.floor(Number(document.getElementById(n).value)||0)}function t0(n){var s,i,r;const e=(r=(i=(s=f.roomData)==null?void 0:s.stocks)==null?void 0:i[n])==null?void 0:r.price;if(!e)return;const t=(o,a)=>{const c=document.getElementById(o);c&&(c.value=a)};t("limitPrice",e),t("stopLoss",Math.round(e*.95)),t("takeProfit",Math.round(e*1.1))}async function ic(n){var l,d;const{roomCode:e,roomData:t,uid:s,nickname:i,selectedStockId:r}=f;if(!t||t.status!=="playing")return;if(!r)return O("종목을 먼저 선택하세요","err");const o=Qs("limitPrice");if(!o)return O("지정가를 입력하세요","err");const a=document.getElementById("limitTif").value,c=((d=(l=t.stocks)==null?void 0:l[r])==null?void 0:d.name)||"";try{await Bs(e,s,i,r,{side:n,trigger:n==="buy"?"below":"above",tif:a,label:"지정가"},Un(),o,t),O(`${c} 지정가 ${n==="buy"?"매수":"매도"} 등록!`,n==="buy"?"up":"down")}catch(u){O(u.message,"err")}}async function n0(){var l,d,u,h,p;const{roomCode:n,roomData:e,uid:t,nickname:s,selectedStockId:i}=f;if(!e||e.status!=="playing")return;if(!i)return O("종목을 먼저 선택하세요","err");const r=((u=(d=(l=e.players)==null?void 0:l[t])==null?void 0:d.holdings)==null?void 0:u[i])||0;if(r<1)return O("보유한 종목에만 설정할 수 있어요","err");const o=Qs("stopLoss"),a=Qs("takeProfit");if(!o&&!a)return O("손절가 또는 익절가를 입력하세요","err");const c=((p=(h=e.stocks)==null?void 0:h[i])==null?void 0:p.name)||"";try{o&&await Bs(n,t,s,i,{side:"sell",trigger:"below",tif:"gtc",label:"손절"},r,o,e),a&&await Bs(n,t,s,i,{side:"sell",trigger:"above",tif:"gtc",label:"익절"},r,a,e),O(`${c} 손절·익절 설정 완료 (보유 ${r}주)`,"down")}catch(m){O(m.message,"err")}}async function s0(){var d,u,h,p;const{roomCode:n,roomData:e,uid:t,nickname:s,selectedStockId:i}=f;if(!e||e.status!=="playing")return;if(!i)return O("종목을 먼저 선택하세요","err");const r=Un(),o=Math.max(2,Math.min(10,Qs("splitCount")||3)),a=((u=(d=e.stocks)==null?void 0:d[i])==null?void 0:u.price)||0;if(!a)return;const c=Math.floor(r/o);if(c<1)return O(`분할하려면 수량이 최소 ${o}주 이상이어야 해요`,"err");const l=((p=(h=e.stocks)==null?void 0:h[i])==null?void 0:p.name)||"";try{for(let m=0;m<o;m++){const v=Math.round(a*(1-m*.015));await Bs(n,t,s,i,{side:"buy",trigger:"below",tif:"gtc",label:`분할${m+1}`},c,v,e)}O(`${l} ${o}회 분할매수 등록! (회당 ${c}주)`,"up")}catch(m){O(m.message,"err")}}async function i0(n){try{await nv(f.roomCode,n),O("예약 주문 취소됨")}catch(e){O(e.message,"err")}}async function r0(){const{roomCode:n,roomData:e,uid:t}=f,s=e==null?void 0:e.ipo;if(!s||s.status!=="subscribing"){O("청약 가능한 공모주가 없습니다","err");return}const i=Math.max(1,Math.floor(Number(document.getElementById("ipoQty").value)||0));try{await ev(n,t,i,e),O(`${s.name} ${i.toLocaleString("ko-KR")}주 청약 완료!`,"up")}catch(r){O(r.message,"err")}}async function o0(){const n=f.nickname||"",e=prompt("사용할 닉네임을 입력하세요 (최대 10자)",n);if(e===null)return;const t=e.trim().slice(0,10);if(!t){O("닉네임을 입력하세요","err");return}f.nickname=t;try{localStorage.setItem("mb_nickname",t),localStorage.setItem("stonk:lastNickname",t)}catch{}try{f.uid&&f.roomCode&&await cn($(L,`rooms/${f.roomCode}/players/${f.uid}/nickname`),t)}catch(s){console.warn("[nickname] 저장 실패:",s)}O(`닉네임을 '${t}'(으)로 변경했습니다`,"up")}async function a0(n,e,t){var c,l;const{roomCode:s,roomData:i,uid:r,nickname:o}=f;if(!i||i.status!=="playing")return;const a=((l=(c=i.stocks)==null?void 0:c[n])==null?void 0:l.name)||"";try{e==="buy"?(await wo(s,r,o,n,t,i),O(`${a} ${t}주 매수 체결!`,"up")):e==="sell"?(await vi(s,r,o,n,t,i),O(`${a} ${t}주 매도 체결!`,"down")):e==="all"&&(await hu(s,r,o,n,i),O(`${a} 전량 매도 체결!`,"down"))}catch(d){O(d.message,"err")}}const Wt=n=>Math.round(Number(n)||0).toLocaleString("ko-KR");async function c0(){var o,a;const{roomCode:n,roomData:e,uid:t}=f;if(!e||!t)return;const s=((a=(o=e.players)==null?void 0:o[t])==null?void 0:a.cash)||0;if(s<1){O("환전할 현금이 없습니다","err");return}const i=prompt(`환전(빼오기): 시장 현금을 금고로 옮깁니다. 수수료 ${zs*100}%
보유 현금 ${Wt(s)}원
옮길 금액을 입력하세요:`,String(s));if(i===null)return;const r=Math.floor(Number(i)||0);if(!r||r<1){O("금액을 확인하세요","err");return}try{if(!(await le($(L,`rooms/${n}/players/${t}/cash`),d=>{if(d=Number(d)||0,!(d<r))return d-r})).committed){O("현금이 부족합니다","err");return}const l=Math.floor(r*(1-zs));await le($(L,`accounts/${t}/balance`),d=>(Number(d)||0)+l),O(`금고로 ${Wt(l)}원 환전 완료 (수수료 ${Wt(r-l)}원)`,"up")}catch(c){O("환전 실패: "+c.message,"err")}}async function l0(){const{roomCode:n,uid:e}=f;if(!e)return;const t=f.bank||0;if(t<1){O("금고 잔액이 없습니다. 먼저 환전(빼오기) 하세요","err");return}const s=prompt(`채우기: 금고 잔액을 시장 현금으로 넣습니다. 수수료 ${zs*100}%
금고 잔액 ${Wt(t)}원
넣을 금액을 입력하세요:`,String(t));if(s===null)return;const i=Math.floor(Number(s)||0);if(!i||i<1){O("금액을 확인하세요","err");return}try{if(!(await le($(L,`accounts/${e}/balance`),a=>{if(a=Number(a)||0,!(a<i))return a-i})).committed){O("금고 잔액이 부족합니다","err");return}const o=Math.floor(i*(1-zs));await le($(L,`rooms/${n}/players/${e}/cash`),a=>(Number(a)||0)+o),O(`시장 현금 ${Wt(o)}원 충전 완료 (수수료 ${Wt(i-o)}원)`,"up")}catch(r){O("채우기 실패: "+r.message,"err")}}function u0(){var o,a,c,l,d,u,h,p,m,v,I,E,_,y,T,w,C,M,N;(o=document.querySelector(".tnav-acct"))==null||o.addEventListener("click",o0);const n=document.getElementById("holdingsList");n&&(n.addEventListener("click",g=>{var pe,ge,Rt,at,un,So;const k=g.target.closest("[data-holdtoggle]");if(k){Yv(k.dataset.holdtoggle),de();return}const S=g.target.closest(".hold-trade");if(!S)return;const H=S.dataset.trade,A=S.querySelector(".ht-input"),q=g.target.closest("[data-htq]");if(q){const Xn=q.dataset.htq;if(Xn==="max"){const dn=(Rt=(ge=(pe=f.roomData)==null?void 0:pe.stocks)==null?void 0:ge[H])==null?void 0:Rt.price,zu=((So=(un=(at=f.roomData)==null?void 0:at.players)==null?void 0:un[f.uid])==null?void 0:So.cash)||0;if(dn){const To=Math.max(1,Math.floor(zu/(dn*1.0002)));Hi(To),A&&(A.value=To)}}else{const dn=Math.max(1,Math.floor(Number(A==null?void 0:A.value)||1)+Number(Xn));Hi(dn),A&&(A.value=dn)}return}const Z=g.target.closest("[data-ht]");if(Z){const Xn=Math.max(1,Math.floor(Number(A==null?void 0:A.value)||1));a0(H,Z.dataset.ht,Xn)}}),n.addEventListener("input",g=>{g.target.classList.contains("ht-input")&&Hi(g.target.value)})),(a=document.getElementById("btnNickname"))==null||a.addEventListener("click",()=>{const g=document.getElementById("nicknameInput").value.trim();g&&(f.nickname=g,localStorage.setItem("mb_nickname",g),Wu(yi))}),(c=document.getElementById("nicknameInput"))==null||c.addEventListener("keydown",g=>{g.key==="Enter"&&document.getElementById("btnNickname").click()}),(l=document.getElementById("btnWaitHome"))==null||l.addEventListener("click",is),(d=document.getElementById("btnCopyCode2"))==null||d.addEventListener("click",sc),(u=document.getElementById("btnCopyMarketBoard"))==null||u.addEventListener("click",sc),(h=document.getElementById("btnLeaveGame"))==null||h.addEventListener("click",is);const e=g=>{const k=g.target.closest("[data-star]");if(k){g.stopPropagation(),Iv(k.dataset.star),de();return}const S=g.target.closest(".rank-item");S&&Gy(S.dataset.id)};(p=document.getElementById("stockList"))==null||p.addEventListener("click",e),(m=document.getElementById("screenerList"))==null||m.addEventListener("click",e),tc("stockList"),tc("screenerList"),window.addEventListener("scroll",()=>{ps=null,Co()},!0),Vy(),(v=document.getElementById("themeToggle"))==null||v.addEventListener("click",jy),(I=document.querySelector(".tnav-brand"))==null||I.addEventListener("click",()=>vn("home")),(E=document.getElementById("tnavTabs"))==null||E.addEventListener("click",g=>{const k=g.target.closest(".tnav-tab");k&&vn(k.dataset.tab)}),(_=document.getElementById("btnDetailBack"))==null||_.addEventListener("click",()=>vn("home"));const t=document.getElementById("globalSearch");t&&t.addEventListener("input",()=>{Ui(t.value);const g=document.getElementById("screen-game");g&&g.dataset.tab!=="home"&&vn("home"),de()}),document.addEventListener("keydown",g=>{var S;if(g.key!=="/")return;const k=document.activeElement;k&&/^(input|textarea|select)$/i.test(k.tagName)||(S=document.getElementById("screen-game"))!=null&&S.classList.contains("hidden")||(g.preventDefault(),t==null||t.focus())}),(y=document.getElementById("homeSeg"))==null||y.addEventListener("click",g=>{const k=g.target.closest(".seg-btn");k&&(document.querySelectorAll("#homeSeg .seg-btn").forEach(S=>S.classList.toggle("is-active",S===k)),Wa(k.dataset.home==="sectors"?"up":"value"),de())}),(T=document.getElementById("homeFilters"))==null||T.addEventListener("click",g=>{const k=g.target.closest(".fchip");k&&(k.dataset.filter&&(document.querySelectorAll("#homeFilters [data-filter]").forEach(S=>S.classList.toggle("is-active",S===k)),Pv(k.dataset.filter)),k.dataset.sort&&(document.querySelectorAll("#homeFilters [data-sort]").forEach(S=>S.classList.toggle("is-active",S===k)),Wa(k.dataset.sort)),de())}),(w=document.getElementById("screenerPresets"))==null||w.addEventListener("click",g=>{const k=g.target.closest("[data-preset]");k&&(Mv(k.dataset.preset),de())}),(C=document.getElementById("accountView"))==null||C.addEventListener("click",g=>{const k=g.target.closest("[data-acctact]");if(k){const H=k.dataset.acctact;H==="fill"?l0():H==="exchange"?c0():H==="send"&&is();return}const S=g.target.closest("[data-acct]");S&&(Ov(S.dataset.acct),de())}),(M=document.getElementById("feedView"))==null||M.addEventListener("click",g=>{if(g.target.closest("#feedBoardLink")){const k=document.getElementById("navBoard");k&&k.href&&window.open(k.href,"_blank","noopener")}}),document.querySelectorAll(".qty-btn[data-qty]").forEach(g=>{g.addEventListener("click",()=>{const k=document.getElementById("qtyInput");k.value=Math.max(1,Un()+Number(g.dataset.qty))})}),document.getElementById("btnMaxQty").addEventListener("click",()=>{var q,Z,pe,ge;const{roomData:g,uid:k,selectedStockId:S}=f,H=(Z=(q=g==null?void 0:g.stocks)==null?void 0:q[S])==null?void 0:Z.price,A=((ge=(pe=g==null?void 0:g.players)==null?void 0:pe[k])==null?void 0:ge.cash)||0;H&&(document.getElementById("qtyInput").value=Math.max(1,Math.floor(A/(H*1.0002))))}),document.getElementById("btnBuy").addEventListener("click",()=>zi("buy")),document.getElementById("btnSell").addEventListener("click",()=>zi("sell")),document.getElementById("btnSellAll").addEventListener("click",()=>zi("sellAll")),document.getElementById("orderTabs").addEventListener("click",g=>{const k=g.target.closest(".order-tab");if(!k)return;const S=k.dataset.tab;document.querySelectorAll(".order-tab").forEach(H=>H.classList.toggle("is-active",H===k)),document.querySelectorAll(".order-pane").forEach(H=>H.classList.toggle("hidden",H.dataset.pane!==S))}),document.getElementById("btnLimitBuy").addEventListener("click",()=>ic("buy")),document.getElementById("btnLimitSell").addEventListener("click",()=>ic("sell")),document.getElementById("btnSetStop").addEventListener("click",n0),document.getElementById("btnSplitBuy").addEventListener("click",s0),document.getElementById("orderList").addEventListener("click",g=>{const k=g.target.closest("[data-cancel]");k&&i0(k.dataset.cancel)}),document.getElementById("btnAlert").addEventListener("click",()=>{var Z;const{roomData:g,selectedStockId:k}=f,S=(Z=g==null?void 0:g.stocks)==null?void 0:Z[k];if(!S)return O("종목을 먼저 선택하세요","err");try{window.Notification&&Notification.permission==="default"&&Notification.requestPermission()}catch{}const H=kv(S.name),A=prompt(`${S.name} 가격 알림 설정
현재가 ${S.price.toLocaleString("ko-KR")}원
알림받을 가격을 입력하세요 (0 또는 빈칸 = 해제):`,H||S.price);if(A===null)return;const q=Math.floor(Number(A)||0);Cv(S.name,q),O(q?`${S.name} ${q.toLocaleString("ko-KR")}원 알림 설정됨`:`${S.name} 알림 해제됨`),de()}),document.getElementById("btnApplyIpo").addEventListener("click",r0);const s=document.getElementById("stockSearch"),i=document.getElementById("stockSearchClear");s&&s.addEventListener("input",()=>{Ui(s.value),i&&(i.hidden=!s.value),de()}),i&&i.addEventListener("click",()=>{s.value="",Ui(""),i.hidden=!0,s.focus(),de()});const r=document.getElementById("marketStatusChip");r&&r.addEventListener("click",()=>{const g=document.getElementById("marketStatusPanel");if(!g)return;const k=g.classList.toggle("hidden");r.setAttribute("aria-expanded",k?"false":"true"),!k&&f.roomData&&yu(f)}),(N=document.getElementById("btnBackHome"))==null||N.addEventListener("click",is)}u0();
