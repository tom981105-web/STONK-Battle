 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bt{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){P(e.idToken,"internal-error"),P(typeof e.idToken<"u","internal-error"),P(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):Go(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){P(e.length!==0,"internal-error");const t=Go(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(P(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:s,refreshToken:i,expiresIn:r}=await Xh(e,t);this.updateTokensAndExpiration(s,i,Number(r))}updateTokensAndExpiration(e,t,s){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+s*1e3}static fromJSON(e,t){const{refreshToken:s,accessToken:i,expirationTime:r}=t,o=new Bt;return s&&(P(typeof s=="string","internal-error",{appName:e}),o.refreshToken=s),i&&(P(typeof i=="string","internal-error",{appName:e}),o.accessToken=i),r&&(P(typeof r=="number","internal-error",{appName:e}),o.expirationTime=r),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Bt,this.toJSON())}_performRefresh(){return Oe("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mf(n,e){const t=Mr(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),r=t.getOptions();if(Ss(r,e??{}))return i;Ie(i,"already-initialized")}return t.initialize({options:e})}function gf(n,e){const t=(e==null?void 0:e.persistence)||[],s=(Array.isArray(t)?t:[t]).map(Le);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function _f(n,e,t){const s=At(n);P(s._canInitEmulator,s,"emulator-config-failed"),P(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const i=!1,r=qc(e),{host:o,port:a}=vf(e),c=a===null?"":`:${a}`;s.config.emulator={url:`${r}//${o}${c}/`},s.settings.appVerificationDisabledForTesting=!0,s.emulatorConfig=Object.freeze({host:o,port:a,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:i})}),yf()}function qc(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function vf(n){const e=qc(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(s);if(i){const r=i[1];return{host:r,port:Jo(s.substr(r.length+1))}}else{const[r,o]=s.split(":");return{host:r,port:Jo(o)}}}function Jo(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function yf(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kf(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Sf(n){const e=vn(yn(n)).link,t=e?vn(yn(e)).deep_link_id:null,s=vn(yn(n)).deep_link_id;return(s?vn(yn(s)).link:null)||s||t||e||n}class Br{constructor(e){var t,s,i,r,o,a;const c=vn(yn(e)),l=(t=c.apiKey)!==null&&t!==void 0?t:null,d=(s=c.oobCode)!==null&&s!==void 0?s:null,u=kf((i=c.mode)!==null&&i!==void 0?i:null);P(l&&d&&u,"argument-error"),this.apiKey=l,this.operation=u,this.code=d,this.continueUrl=(r=c.continueUrl)!==null&&r!==void 0?r:null,this.languageCode=(o=c.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=c.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const t=Sf(e);try{return new Br(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class on{constructor(){this.providerId=on.PROVIDER_ID}static credential(e,t){return Mn._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const s=Br.parseLink(t);return P(s,"argument-error"),Mn._fromEmailAndCode(e,s.code,s.tenantId)}}on.PROVIDER_ID="password";on.EMAIL_PASSWORD_SIGN_IN_METHOD="password";on.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xf(n,e){return e?Le(e):(P(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ep=new qn(5e3,15e3),bp="__/auth/iframe",Ip="emulator/auth/iframe",Cp={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},kp=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Sp(n){const e=n.config;P(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?xr(e,Ip):`https://${n.config.authDomain}/${bp}`,s={apiKey:e.apiKey,appName:n.name,v:rn},i=kp.get(n.config.apiHost);i&&(s.eid=i);const r=n._getFrameworks();return r.length&&(s.fw=r.join(",")),`${t}?${sn(s).slice(1)}`}async function Tp(n){const e=await wp(n),t=Ae().gapi;return P(t,n,"internal-error"),e.open({where:document.body,url:Sp(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Cp,dontclear:!0},s=>new Promise(async(i,r)=>{await s.restyle({setHideOnLeave:!1});const o=Re(n,"network-request-failed"),a=Ae().setTimeout(()=>{r(o)},Ep.get());function c(){Ae().clearTimeout(a),i(s)}s.ping(c).then(c,()=>{r(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dp="__/auth/handler",xp="emulator/auth/handler",$p=encodeURIComponent("fac");async function ia(n,e,t,s,i,r){P(n.config.authDomain,n,"auth-domain-config-required"),P(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:s,v:rn,eventId:i};if(e instanceof Kc){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Cs(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[d,u]of Object.entries({}))o[d]=u}if(e instanceof zn){const d=e.getScopes().filter(u=>u!=="");d.length>0&&(o.scopes=d.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const d of Object.keys(a))a[d]===void 0&&delete a[d];const c=await n._getAppCheckToken(),l=c?`#${$p}=${encodeURIComponent(c)}`:"";return`${Fp(n)}?${sn(a).slice(1)}${l}`}function Fp({config:n}){return n.emulator?xr(n,xp):`https://${n.authDomain}/${Dp}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Di="webStorageSupport";class Up{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=el,this._completeRedirectFn=lp,this._overrideRedirectResult=op}async _openPopup(e,t,s,i){var r;Ue((r=this.eventManagers[e._key()])===null||r===void 0?void 0:r.manager,"_initialize() not called before _openPopup()");const o=await ia(e,t,s,sr(),i);return Mp(e,o,Wr())}async _openRedirect(e,t,s,i){await this._originValidation(e);const r=await ia(e,t,s,sr(),i);return Hf(r),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:i,promise:r}=this.eventManagers[t];return i?Promise.resolve(i):(Ue(r,"If manager is not set, promise should be"),r)}const s=this.initAndGetManager(e);return this.eventManagers[t]={promise:s},s.catch(()=>{delete this.eventManagers[t]}),s}async initAndGetManager(e){const t=await Tp(e),s=new dp(e);return t.register("authEvent",i=>(P(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:s.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=t,s}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Di,{type:Di},i=>{var r;const o=(r=i==null?void 0:i[0])===null||r===void 0?void 0:r[Di];o!==void 0&&t(!!o),Ie(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=gp(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return jc()||$c()||Fr()}}const Bp=Up;var ra="@firebase/auth",oa="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class li{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const s=new $(zt,e),i=new $(zt,t);return this.compare(s,i)!==0}minPost(){return $.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ui;const Dt={};class De{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return b(Dt&&Y,"ChildrenNode.ts has not been loaded"),Ui=Ui||new De({".priority":Dt},{".priority":Y}),Ui}get(e){const t=yt(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof de?t:null}hasIndex(e){return Ce(this.indexSet_,e.toString())}addIndex(e,t){b(e!==Vt,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=t.getIterator($.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let a;i?a=Ds(s,e.getCompare()):a=Dt;const c=e.toString(),l=Object.assign({},this.indexSet_);l[c]=e;const d=Object.assign({},this.indexes_);return d[c]=a,new De(d,l)}addToIndexes(e,t){const s=ks(this.indexes_,(i,r)=>{const o=yt(this.indexSet_,r);if(b(o,"Missing index implementation for "+r),i===Dt)if(o.isDefinedOn(e.node)){const a=[],c=t.getIterator($.Wrap);let l=c.getNext();for(;l;)l.name!==e.name&&a.push(l),l=c.getNext();return a.push(e),Ds(a,o.getCompare())}else return Dt;else{const a=t.get(e.name);let c=i;return a&&(c=c.remove(new $(e.name,a))),c.insert(e,e.node)}});return new De(s,this.indexSet_)}removeFromIndexes(e,t){const s=ks(this.indexes_,i=>{if(i===Dt)return i;{const r=t.get(e.name);return r?i.remove(new $(e.name,r)):i}});return new De(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let gn;class R{constructor(e,t,s){this.children_=e,this.priorityNode_=t,this.indexMap_=s,this.lazyHash_=null,this.priorityNode_&&Dl(this.priorityNode_),this.children_.isEmpty()&&b(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}static get EMPTY_NODE(){return gn||(gn=new R(new de(Qr),null,De.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||gn}updatePriority(e){return this.children_.isEmpty()?this:new R(this.children_,e,this.indexMap_)}getImmediateChild(e){if(e===".priority")return this.getPriority();{const t=this.children_.get(e);return t===null?gn:t}}getChild(e){const t=D(e);return t===null?this:this.getImmediateChild(t).getChild(G(e))}hasChild(e){return this.children_.get(e)!==null}updateImmediateChild(e,t){if(b(t,"We should always be passing snapshot nodes"),e===".priority")return this.updatePriority(t);{const s=new $(e,t);let i,r;t.isEmpty()?(i=this.children_.remove(e),r=this.indexMap_.removeFromIndexes(s,this.children_)):(i=this.children_.insert(e,t),r=this.indexMap_.addToIndexes(s,this.children_));const o=i.isEmpty()?gn:this.priorityNode_;return new R(i,o,r)}}updateChild(e,t){const s=D(e);if(s===null)return t;{b(D(e)!==".priority"||st(e)===1,".priority must be the last token in a path");const i=this.getImmediateChild(s).updateChild(G(e),t);return this.updateImmediateChild(s,i)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let s=0,i=0,r=!0;if(this.forEachChild(Y,(o,a)=>{t[o]=a.val(e),s++,r&&R.INTEGER_REGEXP_.test(o)?i=Math.max(i,Number(o)):r=!1}),!e&&r&&i<2*s){const o=[];for(const a in t)o[a]=t[a];return o}else return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(this.lazyHash_===null){let e="";this.getPriority().isEmpty()||(e+="priority:"+Ll(this.getPriority().val())+":"),this.forEachChild(Y,(t,s)=>{const i=s.hash();i!==""&&(e+=":"+t+":"+i)}),this.lazyHash_=e===""?"":ul(e)}return this.lazyHash_}getPredecessorChildName(e,t,s){const i=this.resolveIndex_(s);if(i){const r=i.getPredecessorKey(new $(e,t));return r?r.name:null}else return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const s=t.minKey();return s&&s.name}else return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new $(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const s=t.maxKey();return s&&s.name}else return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new $(t,this.children_.get(t)):null}forEachChild(e,t){const s=this.resolveIndex_(e);return s?s.inorderTraversal(i=>t(i.name,i.node)):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const s=this.resolveIndex_(t);if(s)return s.getIteratorFrom(e,i=>i);{const i=this.children_.getIteratorFrom(e.name,$.Wrap);let r=i.peek();for(;r!=null&&t.compare(r,e)<0;)i.getNext(),r=i.peek();return i}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const s=this.resolveIndex_(t);if(s)return s.getReverseIteratorFrom(e,i=>i);{const i=this.children_.getReverseIteratorFrom(e.name,$.Wrap);let r=i.peek();for(;r!=null&&t.compare(r,e)>0;)i.getNext(),r=i.peek();return i}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===Xn?-1:0}withIndex(e){if(e===Vt||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new R(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===Vt||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority()))if(this.children_.count()===t.children_.count()){const s=this.getIterator(Y),i=t.getIterator(Y);let r=s.getNext(),o=i.getNext();for(;r&&o;){if(r.name!==o.name||!r.node.equals(o.node))return!1;r=s.getNext(),o=i.getNext()}return r===null&&o===null}else return!1;else return!1}}resolveIndex_(e){return e===Vt?null:this.indexMap_.get(e.toString())}}R.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;class eg extends R{constructor(){super(new de(Qr),R.EMPTY_NODE,De.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return R.EMPTY_NODE}isEmpty(){return!1}}const Xn=new eg;Object.defineProperties($,{MIN:{value:new $(zt,R.EMPTY_NODE)},MAX:{value:new $(It,Xn)}});Ml.__EMPTY_NODE=R.EMPTY_NODE;Z.__childrenNodeConstructor=R;zm(Xn);Qm(Xn);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ng extends li{constructor(e){super(),this.indexPath_=e,b(!x(e)&&D(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const s=this.extractChild(e.node),i=this.extractChild(t.node),r=s.compareTo(i);return r===0?Nt(e.name,t.name):r}makePost(e,t){const s=Q(e),i=R.EMPTY_NODE.updateChild(this.indexPath_,s);return new $(t,i)}maxPost(){const e=R.EMPTY_NODE.updateChild(this.indexPath_,Xn);return new $(It,e)}toString(){return Dn(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sg extends li{compare(e,t){const s=e.node.compareTo(t.node);return s===0?Nt(e.name,t.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return $.MIN}maxPost(){return $.MAX}makePost(e,t){const s=Q(e);return new $(t,s)}toString(){return".value"}}const ig=new sg;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fn{constructor(e){this.indexedFilter_=new Jr(e.getIndex()),this.index_=e.getIndex(),this.startPost_=Fn.getStartPost_(e),this.endPost_=Fn.getEndPost_(e),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}getStartPost(){return this.startPost_}getEndPost(){return this.endPost_}matches(e){const t=this.startIsInclusive_?this.index_.compare(this.getStartPost(),e)<=0:this.index_.compare(this.getStartPost(),e)<0,s=this.endIsInclusive_?this.index_.compare(e,this.getEndPost())<=0:this.index_.compare(e,this.getEndPost())<0;return t&&s}updateChild(e,t,s,i,r,o){return this.matches(new $(t,s))||(s=R.EMPTY_NODE),this.indexedFilter_.updateChild(e,t,s,i,r,o)}updateFullNode(e,t,s){t.isLeafNode()&&(t=R.EMPTY_NODE);let i=t.withIndex(this.index_);i=i.updatePriority(R.EMPTY_NODE);const r=this;return t.forEachChild(Y,(o,a)=>{r.matches(new $(o,a))||(i=i.updateImmediateChild(o,R.EMPTY_NODE))}),this.indexedFilter_.updateFullNode(e,i,s)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.indexedFilter_}getIndex(){return this.index_}static getStartPost_(e){if(e.hasStart()){const t=e.getIndexStartName();return e.getIndex().makePost(e.getIndexStartValue(),t)}else return e.getIndex().minPost()}static getEndPost_(e){if(e.hasEnd()){const t=e.getIndexEndName();return e.getIndex().makePost(e.getIndexEndValue(),t)}else return e.getIndex().maxPost()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class og{constructor(e){this.withinDirectionalStart=t=>this.reverse_?this.withinEndPost(t):this.withinStartPost(t),this.withinDirectionalEnd=t=>this.reverse_?this.withinStartPost(t):this.withinEndPost(t),this.withinStartPost=t=>{const s=this.index_.compare(this.rangedFilter_.getStartPost(),t);return this.startIsInclusive_?s<=0:s<0},this.withinEndPost=t=>{const s=this.index_.compare(t,this.rangedFilter_.getEndPost());return this.endIsInclusive_?s<=0:s<0},this.rangedFilter_=new Fn(e),this.index_=e.getIndex(),this.limit_=e.getLimit(),this.reverse_=!e.isViewFromLeft(),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}updateChild(e,t,s,i,r,o){return this.rangedFilter_.matches(new $(t,s))||(s=R.EMPTY_NODE),e.getImmediateChild(t).equals(s)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,t,s,i,r,o):this.fullLimitUpdateChild_(e,t,s,r,o)}updateFullNode(e,t,s){let i;if(t.isLeafNode()||t.isEmpty())i=R.EMPTY_NODE.withIndex(this.index_);else if(this.limit_*2<t.numChildren()&&t.isIndexed(this.index_)){i=R.EMPTY_NODE.withIndex(this.index_);let r;this.reverse_?r=t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):r=t.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);let o=0;for(;r.hasNext()&&o<this.limit_;){const a=r.getNext();if(this.withinDirectionalStart(a))if(this.withinDirectionalEnd(a))i=i.updateImmediateChild(a.name,a.node),o++;else break;else continue}}else{i=t.withIndex(this.index_),i=i.updatePriority(R.EMPTY_NODE);let r;this.reverse_?r=i.getReverseIterator(this.index_):r=i.getIterator(this.index_);let o=0;for(;r.hasNext();){const a=r.getNext();o<this.limit_&&this.withinDirectionalStart(a)&&this.withinDirectionalEnd(a)?o++:i=i.updateImmediateChild(a.name,R.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,i,s)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.rangedFilter_.getIndexedFilter()}getIndex(){return this.index_}fullLimitUpdateChild_(e,t,s,i,r){let o;if(this.reverse_){const u=this.index_.getCompare();o=(h,p)=>u(p,h)}else o=this.index_.getCompare();const a=e;b(a.numChildren()===this.limit_,"");const c=new $(t,s),l=this.reverse_?a.getFirstChild(this.index_):a.getLastChild(this.index_),d=this.rangedFilter_.matches(c);if(a.hasChild(t)){const u=a.getImmediateChild(t);let h=i.getChildAfterChild(this.index_,l,this.reverse_);for(;h!=null&&(h.name===t||a.hasChild(h.name));)h=i.getChildAfterChild(this.index_,h,this.reverse_);const p=h==null?1:o(h,c);if(d&&!s.isEmpty()&&p>=0)return r!=null&&r.trackChildChange($n(t,s,u)),a.updateImmediateChild(t,s);{r!=null&&r.trackChildChange(xn(t,u));const E=a.updateImmediateChild(t,R.EMPTY_NODE);return h!=null&&this.rangedFilter_.matches(h)?(r!=null&&r.trackChildChange(Yt(h.name,h.node)),E.updateImmediateChild(h.name,h.node)):E}}else return s.isEmpty()?e:d&&o(l,c)>=0?(r!=null&&(r.trackChildChange(xn(l.name,l.node)),r.trackChildChange(Yt(t,s))),a.updateImmediateChild(t,s).updateImmediateChild(l.name,R.EMPTY_NODE)):e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $s(){return{value:null,children:new Map}}function cn(n,e,t){if(x(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const s=D(e);n.children.has(s)||n.children.set(s,$s());const i=n.children.get(s);e=G(e),cn(i,e,t)}}function ur(n,e){if(x(e))return n.value=null,n.children.clear(),!0;if(n.value!==null){if(n.value.isLeafNode())return!1;{const t=n.value;return n.value=null,t.forEachChild(Y,(s,i)=>{cn(n,new H(s),i)}),ur(n,e)}}else if(n.children.size>0){const t=D(e);return e=G(e),n.children.has(t)&&ur(n.children.get(t),e)&&n.children.delete(t),n.children.size===0}else return!0}function dr(n,e,t){n.value!==null?t(e,n.value):lg(n,(s,i)=>{const r=new H(e.toString()+"/"+s);dr(i,r,t)})}function lg(n,e){n.children.forEach((t,s)=>{e(s,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Un{constructor(e,t){this.source=e,this.path=t,this.type=we.LISTEN_COMPLETE}operationForChild(e){return x(this.path)?new Un(this.source,B()):new Un(this.source,G(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ct{constructor(e,t,s){this.source=e,this.path=t,this.snap=s,this.type=we.OVERWRITE}operationForChild(e){return x(this.path)?new Ct(this.source,B(),this.snap.getImmediateChild(e)):new Ct(this.source,G(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qt{constructor(e,t,s){this.source=e,this.path=t,this.children=s,this.type=we.MERGE}operationForChild(e){if(x(this.path)){const t=this.children.subtree(new H(e));return t.isEmpty()?null:t.value?new Ct(this.source,B(),t.value):new Qt(this.source,B(),t)}else return b(D(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Qt(this.source,G(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Bi;const vg=()=>(Bi||(Bi=new de(nm)),Bi);class z{constructor(e,t=vg()){this.value=e,this.children=t}static fromObject(e){let t=new z(null);return ne(e,(s,i)=>{t=t.set(new H(s),i)}),t}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(this.value!=null&&t(this.value))return{path:B(),value:this.value};if(x(e))return null;{const s=D(e),i=this.children.get(s);if(i!==null){const r=i.findRootMostMatchingPathAndValue(G(e),t);return r!=null?{path:J(new H(s),r.path),value:r.value}:null}else return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,()=>!0)}subtree(e){if(x(e))return this;{const t=D(e),s=this.children.get(t);return s!==null?s.subtree(G(e)):new z(null)}}set(e,t){if(x(e))return new z(t,this.children);{const s=D(e),r=(this.children.get(s)||new z(null)).set(G(e),t),o=this.children.insert(s,r);return new z(this.value,o)}}remove(e){if(x(e))return this.children.isEmpty()?new z(null):new z(null,this.children);{const t=D(e),s=this.children.get(t);if(s){const i=s.remove(G(e));let r;return i.isEmpty()?r=this.children.remove(t):r=this.children.insert(t,i),this.value===null&&r.isEmpty()?new z(null):new z(this.value,r)}else return this}}get(e){if(x(e))return this.value;{const t=D(e),s=this.children.get(t);return s?s.get(G(e)):null}}setTree(e,t){if(x(e))return t;{const s=D(e),r=(this.children.get(s)||new z(null)).setTree(G(e),t);let o;return r.isEmpty()?o=this.children.remove(s):o=this.children.insert(s,r),new z(this.value,o)}}fold(e){return this.fold_(B(),e)}fold_(e,t){const s={};return this.children.inorderTraversal((i,r)=>{s[i]=r.fold_(J(e,i),t)}),t(e,this.value,s)}findOnPath(e,t){return this.findOnPath_(e,B(),t)}findOnPath_(e,t,s){const i=this.value?s(t,this.value):!1;if(i)return i;if(x(e))return null;{const r=D(e),o=this.children.get(r);return o?o.findOnPath_(G(e),J(t,r),s):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,B(),t)}foreachOnPath_(e,t,s){if(x(e))return this;{this.value&&s(t,this.value);const i=D(e),r=this.children.get(i);return r?r.foreachOnPath_(G(e),J(t,i),s):new z(null)}}foreach(e){this.foreach_(B(),e)}foreach_(e,t){this.children.inorderTraversal((s,i)=>{i.foreach_(J(e,s),t)}),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal((t,s)=>{s.value&&e(t,s.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dv{constructor(e,t){this.committed=e,this.snapshot=t}toJSON(){return{committed:this.committed,snapshot:this.snapshot.toJSON()}}}function _e(n,e,t){var s;if(n=se(n),Qe("Reference.transaction",n._path),n.key===".length"||n.key===".keys")throw"Reference.transaction failed: "+n.key+" is a read-only object.";const i=(s=void 0)!==null&&s!==void 0?s:!0,r=new ve,o=(c,l,d)=>{let u=null;c?r.reject(c):(u=new Zt(d,new Ne(n._repo,n._path),Y),r.resolve(new dv(l,u)))},a=ss(n,()=>{});return H_(n._repo,n._path,e,o,a,i),r.promise}$e.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};$e.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};lv();const wn={apiKey:"AIzaSyARFa-vzKVmIdxP5xDRXVzasL2ui94eZ-w",authDomain:"market-6e66a.firebaseapp.com",databaseURL:"https://market-6e66a-default-rtdb.firebaseio.com",projectId:"market-6e66a",storageBucket:"market-6e66a.firebasestorage.app",messagingSenderId:"402312269082",appId:"1:402312269082:web:cf304afc54057ea162b0a3"},_u=!!wn.apiKey&&!wn.apiKey.startsWith("여기에")&&!!wn.databaseURL&&!wn.databaseURL.startsWith("여기에");let ji=null,en=null,A=null;try{_u&&(ji=Ic(wn),en=Kp(ji),A=av(ji))}catch(n){console.error("[firebase] 초기화 실패:",n)}const be=1e7,He=10,Er=6,ja=1,br=4e3,hv=.018,fv=.008,Va=3e4,vu=15e-5,pv=.0018,mv=3*60*1e3,gv=["달빛전자","구름소프트","번개모빌리티","바다식품","별빛바이오","한입게임즈","초록에너지","솜사탕유통","무지개항공","도토리금융","은하반도체","포근화학","두근로보틱스","새벽엔터","고래물산","민들레제약"],_v=["떡상테크","유니콘소프트","미래모빌","첫걸음바이오","샛별에너지","루키게임즈","신화엔터","퀀텀반도체"],vv=[{key:"semi",name:"반도체",leader:"은하반도체",suffixes:["반도체","전자","소자","머티리얼즈","시스템","테크","세미콘"]},{key:"bio",name:"바이오",leader:"별빛바이오",suffixes:["바이오","제약","파마","셀","진단","메디","테라퓨틱스"]},{key:"battery",name:"2차전지",leader:"번개배터리",suffixes:["배터리","에너지","케미칼","머티리얼","파워","솔라","ESS"]},{key:"net",name:"인터넷·게임",leader:"구름소프트",suffixes:["소프트","게임즈","엔터","네트웍스","스튜디오","플랫폼","미디어"]}],ls=["별빛","달빛","은하","구름","번개","바다","초록","솜사탕","무지개","도토리","한입","포근","두근","새벽","고래","민들레","노을","단비","햇살","모래","안개","서리","물결","바람","이슬","구슬","파도","돌담","오름","나래","미르","해솔","가람","마루","아라","여울","보라","수풀","겨울","봄날"],Ga=["개미부대","왕개미","큰손","수상한세력","외국인","기관","전설의단타","스캘퍼","장기투자자","물타기달인"],qa=[{text:"{name}, 신제품 공개에 기대감 폭발",effect:[.05,.15]},{text:"{name}, 대형 계약 체결 소식",effect:[.08,.18]},{text:"{name}, 깜짝 실적 발표 소문 확산",effect:[.04,.12]},{text:"{name}, 신사업 진출 선언",effect:[.03,.1]},{text:"{name}, 해외 진출 성공 소식",effect:[.06,.14]},{text:"{name}, 핵심 인력 대거 이탈설",effect:[-.15,-.05]},{text:"{name}, 서비스 대규모 장애 발생",effect:[-.12,-.04]},{text:"{name}, 규제 이슈로 불확실성 확대",effect:[-.18,-.08]},{text:"{name}, 자금난 우려 제기",effect:[-.14,-.06]},{text:"{name}, 경쟁사 등장으로 점유율 하락 전망",effect:[-.1,-.03]}];function re(n,e){return Math.floor(Math.random()*(e-n+1))+n}function K(n,e){return Math.random()*(e-n)+n}function he(n,e,t){return Math.max(e,Math.min(t,n))}function yv(n){const e=[...n];for(let t=e.length-1;t>0;t--){const s=Math.floor(Math.random()*(t+1));[e[t],e[s]]=[e[s],e[t]]}return e}function yu(n,e,t={}){const s=t.type||"stock",i=t.role||null;e=Te(Math.max(He,e));let r=1,o=1;return s==="stock"?i==="leader"?(r=K(.8,1.4),o=K(2,3)):i==="sub"?(r=K(.9,1.6),o=K(1.2,2.2)):i==="related"?(r=K(.7,2),o=K(.6,1.8)):(r=K(.5,2.4),o=K(.3,1.2)):s==="preferred"?(r=K(.4,.8),o=K(.5,1.1)):s==="etf"?(r=K(.5,.8),o=K(1.5,2.5)):s==="reit"?(r=K(.35,.7),o=K(.6,1.2)):s==="bond"?(r=K(.2,.45),o=K(.8,1.4)):s==="spac"?(r=K(.2,.5),o=K(.4,.9)):s==="commodity"?(r=K(.9,1.8),o=K(1,2)):(s==="inverse"||s==="leverage")&&(r=1,o=K(1.5,2.5)),{name:n,type:s,role:i||"",sector:t.sector||"",link:t.link||"",price:e,previousPrice:e,basePrice:e,open:e,high:e,low:e,changeRate:0,volume:0,value:0,pressure:0,trend:0,volat:+r.toFixed(2),activ:+o.toFixed(2),heat:0,news:""}}function wv(){const n={},e=new Set,t=r=>{for(let o=0;o<50;o++){const a=ls[re(0,ls.length-1)]+r;if(!e.has(a))return e.add(a),a}return ls[re(0,ls.length-1)]+r+re(1,99)};let s=0;const i=(r,o)=>{const a="s"+s++;return n[a]=yu(o.name,r,o),a};return vv.forEach(r=>{e.add(r.leader);const o=()=>r.suffixes[re(0,r.suffixes.length-1)],a=i(re(6e4,13e4),{name:r.leader,type:"stock",role:"leader",sector:r.name});for(let c=0;c<2;c++)i(re(25e3,7e4),{name:t(r.suffixes[0]),type:"stock",role:"sub",sector:r.name});for(let c=0;c<7;c++)i(re(4e3,45e3),{name:t(o()),type:"stock",role:"related",sector:r.name});for(let c=0;c<3;c++)i(re(1500,22e3),{name:t(o()),type:"stock",role:"normal",sector:r.name});i(Math.round(n[a].price*.82),{name:r.leader+"우",type:"preferred",sector:r.name,link:a})}),i(1e4,{name:"조스피 지수 ETF",type:"etf",link:"index"}),i(1e4,{name:"마켓 인버스 ETF",type:"inverse",link:"index"}),i(1e4,{name:"마켓 레버리지2X ETF",type:"leverage",link:"index"}),i(1e4,{name:"국채 3년 채권 ETF",type:"bond"}),i(2e4,{name:"골드 원자재 ETF",type:"commodity"}),i(15e3,{name:"원유 원자재 ETF",type:"commodity"}),i(5e3,{name:"도심 리츠 REITs",type:"reit"}),i(5e3,{name:"물류 리츠 REITs",type:"reit"}),i(2e3,{name:"미래합병1호 SPAC",type:"spac"}),i(2e3,{name:"성장합병2호 SPAC",type:"spac"}),n}function bi(n){return{preferred:"우선주",etf:"ETF",reit:"리츠",spac:"SPAC",inverse:"인버스",leverage:"레버리지",bond:"채권ETF",commodity:"원자재"}[n]||""}function wu(n){return{leader:"대장주",sub:"부대장주",related:"관련주",normal:"일반주"}[n]||""}function us(n){return!n||n==="stock"}function Ii(n){return Math.round(n*1.3)}function Ci(n){return Math.max(He,Math.round(n*.7))}function Eu(n){return n<2e3?1:n<5e3?5:n<2e4?10:n<5e4?50:n<2e5?100:500}function Te(n){const e=Eu(n);return Math.round(n/e)*e}async function Ev(n,e){const t=e.stocks||{},s=Object.keys(t);if(s.length===0)return;let i=null,r=0,o="";if(Math.random()<hv){const v=s.filter(S=>us(t[S].type)),_=v.length?v:s,y=_.map(S=>1+(t[S].activ||1)+(t[S].heat||0)*2),C=y.reduce((S,T)=>S+T,0);let w=Math.random()*C;i=_[_.length-1];for(let S=0;S<_.length;S++)if(w-=y[S],w<=0){i=_[S];break}const I=qa[re(0,qa.length-1)];r=K(I.effect[0],I.effect[1])*.3,o=I.text.replace("{name}",t[i].name)}const a=Date.now(),c={},l=[];function d(v){const _=(v.activ||1)*(1+(v.heat||0));let y=0,C=0;const w=he(.35+_*.2,.25,.97);if(Math.random()<w){const I=re(1,Math.max(2,Math.round(1+_*3)));for(let S=0;S<I;S++){const T=re(10,Math.round(60+_*220)),N=.5+he((v.trend||0)*15,-.3,.3),q=Math.random()<N;y+=q?T:-T,C+=T,l.push({nickname:Ga[re(0,Ga.length-1)],type:q?"buy":"sell",stockName:v.name,qty:T,price:v.price,time:a})}}return C+=Math.round(re(300,2500)*_),{botNet:y,botVolume:C}}function u(v,_,y,C,w={}){const I=_.basePrice||_.price,S=I?(_.price-I)/I:0;y+=he(-S*.01,-.006,.006);let T=Te(_.price*(1+y));T=he(T,Ci(I),Ii(I)),T=Math.max(He,T);const N=`stocks/${v}/`;return c[N+"previousPrice"]=_.price,c[N+"price"]=T,c[N+"changeRate"]=+((T-I)/I*100).toFixed(2),c[N+"volume"]=(_.volume||0)+C,c[N+"value"]=(_.value||0)+C*T,T>(_.high||_.price)&&(c[N+"high"]=T),T<(_.low||_.price)&&(c[N+"low"]=T),(_.pressure||0)!==0&&(c[N+"pressure"]=0),w.trend!=null&&(c[N+"trend"]=+w.trend.toFixed(5)),w.heat!=null&&(w.heat>.001||(_.heat||0)>.001)&&(c[N+"heat"]=+w.heat.toFixed(3)),w.news!=null&&(c[N+"news"]=w.news),T/_.price-1}function h(v){const _=v.volat||1;let y=(v.heat||0)*.92;Math.random()<.006&&(y=he(y+K(.3,1),0,1.6));const C=_*(1+y*.5),w=he((v.trend||0)*.96+(Math.random()-.5)*8e-4*C,-.0025*(1+y*.5),.0025*(1+y*.5));let I=(Math.random()-.5)*.0016*C+w;return Math.random()<.005&&(I+=(Math.random()-.5)*.012*(1+y*.4)),{own:I,trend:w,heat:y}}const p={},g={},E=[];for(const v of s){const _=t[v];if(!us(_.type)||_.role!=="leader")continue;const{own:y,trend:C,heat:w}=h(_),{botNet:I,botVolume:S}=d({..._,heat:w});let T=y+he((_.pressure||0)*.002,-.02,.02)+he(I*2e-4,-.008,.008);v===i&&(T+=r);const N=u(v,_,T,S,{trend:C,heat:w,news:v===i?o:null});p[v]=N,g[_.sector]=N,E.push(N)}for(const v of s){const _=t[v];if(!us(_.type)||_.role==="leader")continue;const y=_.role==="related"?.7:_.role==="sub"?.45:.2,C=g[_.sector]||0,{own:w,trend:I,heat:S}=h(_),{botNet:T,botVolume:N}=d({..._,heat:S});let q=C*y+w*(1-y*.5);q+=he((_.pressure||0)*.002,-.02,.02)+he(T*2e-4,-.008,.008),v===i&&(q+=r);const L=u(v,_,q,N,{trend:I,heat:S,news:v===i?o:null});p[v]=L,E.push(L)}const m=E.length?E.reduce((v,_)=>v+_,0)/E.length:0;for(const v of s){const _=t[v];if(us(_.type))continue;const{botNet:y,botVolume:C}=d(_),w=Math.random()-.5;let I=0;switch(_.type){case"etf":I=m+w*.0015;break;case"inverse":I=-m+w*.0015;break;case"leverage":I=2*m+w*.002;break;case"bond":I=-.25*m+2e-4+w*.0012;break;case"reit":I=.2*m+2e-4+w*.004*(_.volat||1);break;case"commodity":I=w*.011*(_.volat||1)+(Math.random()<.01?(Math.random()-.5)*.05:0);break;case"preferred":I=(g[_.sector]||p[_.link]||0)*.85+w*.002;break;case"spac":I=w*.003+(Math.random()<.008?(Math.random()<.7?1:-1)*K(.06,.2):0);break;default:I=w*.005}I+=he((_.pressure||0)*.002,-.02,.02)+he(y*3e-4,-.01,.01),u(v,_,I,C,{})}c.marketTick=a,yv(l),c.botFeed=l.slice(0,4),o&&!c.latestNews&&(c.latestNews={text:o,time:a}),await We(O(A,`rooms/${n}`),c)}function Vi(n){return Math.round(n||0).toLocaleString("ko-KR")}async function bv(n,e){const t=Date.now(),s=e.stocks||{},i=e.ipo;if(i&&i.status==="subscribing"){if(t<i.endsAt)return;const h=i.applies||{},p=Object.values(h).reduce((C,w)=>C+(w||0),0),g=(i.botDemand||0)+p,E=Math.max(1,g/i.totalShares),m=he(.92+(E-1)*.1+K(-.1,.15),.9,2.3),v=Math.max(He,Te(i.offerPrice*m)),_=yu(i.name,v,{type:"stock",role:"normal",sector:"신규상장"});_.ipo=!0;const y=((v-i.offerPrice)/i.offerPrice*100).toFixed(1);await We(O(A,`rooms/${n}`),{[`stocks/${i.stockId}`]:_,ipo:null,latestNews:{text:`🎉 ${i.name} 상장! 공모가 ${Vi(i.offerPrice)} → 시초가 ${Vi(v)} (${y>=0?"+":""}${y}%) · 경쟁률 ${E.toFixed(1)}:1`,time:t}});for(const[C,w]of Object.entries(h)){const I=w||0,S=Math.floor(I/E),T=i.offerPrice*(I-S);await _e(O(A,`rooms/${n}/players/${C}`),N=>N&&(T>0&&(N.cash=(N.cash||0)+T),S>0&&(N.holdings=N.holdings||{},N.holdings[i.stockId]=(N.holdings[i.stockId]||0)+S),N))}return}if(i||Object.keys(s).length>=90||Math.random()>=fv)return;const r=Object.values(s).map(h=>h.name),o=[...gv,..._v].filter(h=>!r.includes(h));if(!o.length)return;const a=o[re(0,o.length-1)],c=Te(re(5e3,6e4)),l=re(5e4,2e5),d=Math.floor(l*K(.4,9)),u="ipo"+t.toString(36);await We(O(A,`rooms/${n}`),{ipo:{stockId:u,name:a,offerPrice:c,totalShares:l,botDemand:d,status:"subscribing",startedAt:t,endsAt:t+Va},latestNews:{text:`공모주 청약 시작! '${a}' 공모가 ${Vi(c)}원 · ${Math.round(Va/1e3)}초 후 마감`,time:t}})}async function Iv(n,e,t,s){const i=s.ipo;if(!i||i.status!=="subscribing")throw new Error("청약 가능한 공모주가 없습니다.");if(Date.now()>=i.endsAt)throw new Error("청약이 마감되었습니다.");if(t=Math.floor(t),!t||t<1)throw new Error("청약 수량을 확인하세요.");const r=i.offerPrice*t;if(!(await _e(O(A,`rooms/${n}/players/${e}/cash`),a=>{if(a==null)return a;if(!(a<r))return a-r})).committed)throw new Error("청약 증거금(현금)이 부족합니다.");await _e(O(A,`rooms/${n}/ipo/applies/${e}`),a=>(a||0)+t)}function Cv(n){if(!n)return 0;const e=Object.values(n.applies||{}).reduce((t,s)=>t+(s||0),0);return((n.botDemand||0)+e)/n.totalShares}async function Ks(n,e,t,s,i,r,o,a){var E;const c=(E=a.stocks)==null?void 0:E[s];if(!c)throw new Error("종목을 선택하세요.");const l=i.side;if(l!=="buy"&&l!=="sell")throw new Error("주문 유형 오류");const d=i.trigger==="above"?"above":"below",u=["gtc","day","ioc"].includes(i.tif)?i.tif:"gtc";if(r=Math.floor(r),!r||r<1)throw new Error("수량을 확인하세요.");if(o=Te(Number(o)),!o||o<He)throw new Error("주문 가격을 확인하세요.");const h=Date.now(),p={uid:e,nickname:t,stockId:s,stockName:c.name,side:l,trigger:d,tif:u,label:i.label||"지정가",qty:r,target:o,createdAt:h,expiresAt:u==="day"?h+mv:null},g=Io(O(A,`rooms/${n}/orders`)).key;return await dn(O(A,`rooms/${n}/orders/${g}`),p),g}async function kv(n,e){await Je(O(A,`rooms/${n}/orders/${e}`))}async function Sv(n,e){var i;const t=e.orders;if(!t)return;const s=Date.now();for(const[r,o]of Object.entries(t)){const a=(i=e.stocks)==null?void 0:i[o.stockId];if(!a){await Je(O(A,`rooms/${n}/orders/${r}`));continue}const c=a.price;if((o.trigger||(o.side==="buy"?"below":"above"))==="below"?c<=o.target:c>=o.target){try{o.side==="buy"?await bu(n,o.uid,o.nickname,o.stockId,o.qty,e):await Co(n,o.uid,o.nickname,o.stockId,o.qty,e)}catch(u){console.warn("[order] 예약 체결 실패, 취소:",o,u==null?void 0:u.message)}await Je(O(A,`rooms/${n}/orders/${r}`));continue}o.tif==="ioc"?await Je(O(A,`rooms/${n}/orders/${r}`)):o.expiresAt&&s>o.expiresAt&&await Je(O(A,`rooms/${n}/orders/${r}`))}}function Tv(n,e){const t=n.orders||{};return Object.entries(t).filter(([,s])=>s.uid===e).map(([s,i])=>({id:s,...i})).sort((s,i)=>(i.createdAt||0)-(s.createdAt||0))}async function bu(n,e,t,s,i,r){var d;const o=(d=r.stocks)==null?void 0:d[s];if(!o)throw new Error("종목을 선택하세요.");if(i=Math.floor(i),!i||i<1)throw new Error("수량을 확인하세요.");const a=o.price,c=Math.ceil(a*i*(1+vu));if(!(await _e(O(A,`rooms/${n}/players/${e}`),u=>{if(!u)return u;if((u.cash||0)<c)return;u.cash=(u.cash||0)-c,u.holdings=u.holdings||{};const h=u.holdings[s]||0;u.avgCost=u.avgCost||{};const p=u.avgCost[s]||0;return u.avgCost[s]=Math.round((h*p+i*a)/(h+i)),u.holdings[s]=h+i,u})).committed)throw new Error("현금(수수료 포함)이 부족합니다.");await Iu(n,s,i,+i,{type:"buy",nickname:t,stockName:o.name,qty:i,price:a,time:Date.now()})}async function Co(n,e,t,s,i,r){var d;const o=(d=r.stocks)==null?void 0:d[s];if(!o)throw new Error("종목을 선택하세요.");if(i=Math.floor(i),!i||i<1)throw new Error("수량을 확인하세요.");const a=o.price,c=Math.floor(a*i*(1-vu-pv));if(!(await _e(O(A,`rooms/${n}/players/${e}`),u=>{var p;if(!u)return u;const h=((p=u.holdings)==null?void 0:p[s])||0;if(!(h<i))return u.cash=(u.cash||0)+c,u.holdings[s]=h-i,u.holdings[s]===0&&(delete u.holdings[s],u.avgCost&&delete u.avgCost[s]),u})).committed)throw new Error("보유 수량이 부족합니다.");await Iu(n,s,i,-i,{type:"sell",nickname:t,stockName:o.name,qty:i,price:a,time:Date.now()})}async function Rv(n,e,t,s,i){var o,a,c;const r=((c=(a=(o=i.players)==null?void 0:o[e])==null?void 0:a.holdings)==null?void 0:c[s])||0;if(r<1)throw new Error("보유 수량이 없습니다.");return Co(n,e,t,s,r,i)}async function Iu(n,e,t,s,i){await Promise.all([_e(O(A,`rooms/${n}/stocks/${e}/volume`),r=>(r||0)+t),_e(O(A,`rooms/${n}/stocks/${e}/value`),r=>(r||0)+t*i.price),_e(O(A,`rooms/${n}/stocks/${e}/pressure`),r=>(r||0)+s),Io(O(A,`rooms/${n}/logs`),i)])}function ki(n,e){var i;let t=(n==null?void 0:n.cash)||0;const s=(n==null?void 0:n.holdings)||{};for(const[r,o]of Object.entries(s)){const a=((i=e==null?void 0:e[r])==null?void 0:i.price)||0;t+=a*o}return t}function ko(n,e){return Object.entries(n||{}).map(([t,s])=>({uid:t,nickname:s.nickname,connected:s.connected!==!1,total:ki(s,e)})).sort((t,s)=>s.total-t.total)}async function Av(n,e){const t=e.players||{},s=Object.keys(t).length;if(s<ja)throw new Error(`최소 ${ja}명이 필요합니다.`);if(s>Er)throw new Error(`최대 ${Er}명까지 가능합니다.`);const i=Date.now(),r={status:"playing",startedAt:i,endsAt:null,stocks:wv(),logs:null,latestNews:null,botFeed:null,orders:null,ipo:null,marketTick:i};for(const o of Object.keys(t))r[`players/${o}/cash`]=be,r[`players/${o}/holdings`]=null,r[`players/${o}/totalAsset`]=be;await We(O(A,`rooms/${n}`),r)}async function Nv(n,e){const t={status:"ended",endedAt:Date.now()},s=e.players||{};for(const[i,r]of Object.entries(s))t[`players/${i}/totalAsset`]=ki(r,e.stocks);await We(O(A,`rooms/${n}`),t)}async function Pv(){const n=await Mt(O(A,"rooms"));if(!n.exists())return 0;const e=n.val();let t=0;for(const[s,i]of Object.entries(e))i.status==="ended"&&(await Je(O(A,`rooms/${s}`)),t++);return t}const Ov=1,zs=[{key:"candles1m",win:6e4,cap:240},{key:"candles5m",win:3e5,cap:288},{key:"candles15m",win:9e5,cap:192},{key:"candles1h",win:36e5,cap:168}],Cu=2*6e4,Mv=6e4,Lv=4500;function Ir(n,e){return Math.floor(n/e)*e}function gs(n,e,t){return Math.max(e,Math.min(t,n))}function Ka(){let n=0,e=0;for(;n===0;)n=Math.random();for(;e===0;)e=Math.random();return Math.sqrt(-2*Math.log(n))*Math.cos(2*Math.PI*e)}function za(n,e){const t=n&&n[e]||null;return t?Object.values(t).filter(s=>s&&typeof s.t=="number").sort((s,i)=>s.t-i.t):[]}function Dv(n,e,t,s){const i=(t-e)/s,r=Math.max(1,i/4e3),o=n.volat||1,a=n.activ||1,c=n.basePrice||n.price||He;let l=n.price||c,d=n.trend||0,u=n.heat||0;const h=!n.type||n.type==="stock",p=.0011*o*(h?1:.7),g=5,E=[];for(let m=0;m<s;m++){const v=e+i*m,_=l,y=r/g;let C=_,w=_,I=_;for(let L=0;L<g;L++){d=gs(d*Math.pow(.99,y)+Ka()*18e-5*o*Math.sqrt(y),-.0016,.0016),Math.random()<.005*y&&(u=gs(u+(.3+Math.random()*.7),0,1.6)),u*=Math.pow(.94,y);const ae=p*(1+u*.5);let U=d*y+Ka()*ae*Math.sqrt(y);Math.random()<.0025*y&&(U+=(Math.random()<.5?1:-1)*(.006+Math.random()*.018)*(h?1:.6)),I=I*(1+U),I=c+(I-c)*Math.exp(-.01*y),I=gs(I,Ci(c),Ii(c)),I=Math.max(He,I),C=Math.max(C,I),w=Math.min(w,I)}const S=Te(I),T=_?Math.abs((S-_)/_):0,N=(400+Math.random()*1800)*a*(1+u*.8),q=Math.round(N*r*(1+T*8));E.push({t:v,o:Te(_),h:Te(C),l:Te(w),c:S,v:q}),l=S}return{candles:E,finalPrice:l,finalBase:c}}function xv(n){const e={};for(const t of zs)e[t.key]={};for(const t of n)for(const s of zs){const i=Ir(t.t,s.win),r=e[s.key],o=r[i];o?(o.h=Math.max(o.h,t.h),o.l=Math.min(o.l,t.l),o.c=t.c,o.v+=t.v):r[i]={t:i,o:t.o,h:t.h,l:t.l,c:t.c,v:t.v}}return e}async function $v(n,e){const t=Date.now();return(await _e(O(A,`rooms/${n}/market/catchupLock`),i=>{if(!(i&&i.expiresAt&&i.expiresAt>t))return{by:e||"anon",at:t,expiresAt:t+Mv}})).committed}async function Fv(n){try{await We(O(A,`rooms/${n}/market`),{catchupLock:null})}catch{}}function Uv(n){if(!n||n.status!=="playing")return!1;const e=n.market&&n.market.lastTickAt||n.marketTick||0;return e?Date.now()-e>=Cu:!1}async function Bv(n,e,t,s={}){if(!e||!e.stocks)return{applied:!1,reason:"no-stocks"};if(e.status!=="playing")return{applied:!1,reason:"not-playing"};const i=Date.now(),r=e.market&&e.market.lastTickAt||e.marketTick||0,o=i-r;if(!s.force&&o<Cu)return{applied:!1,reason:"fresh",elapsed:o};if(!await $v(n,t)&&!s.force)return{applied:!1,reason:"locked"};try{let c=e.stocks||{};try{const E=await Mt(O(A,`rooms/${n}/stocks`));E.exists()&&(c=E.val())}catch{}const l=Object.keys(c);if(!l.length)return{applied:!1,reason:"no-stocks"};const d=gs(Math.round(Lv/l.length),30,480),u=Math.max(1,Math.round(o/6e4)),h=Math.min(d,u,480),p={};let g=0;for(const E of l){const m=c[E];if(!m||typeof m.price!="number")continue;const v=Dv(m,r,i,h),_=xv(v.candles),y=`stocks/${E}/`,C=m.history||{};for(const T of zs){const q={...C[T.key]||{}};for(const[U,ie]of Object.entries(_[T.key])){const pe=q[U];q[U]=pe?{t:ie.t,o:pe.o,h:Math.max(pe.h,ie.h),l:Math.min(pe.l,ie.l),c:ie.c,v:(pe.v||0)+ie.v}:ie}const L=Object.keys(q).map(Number).sort((U,ie)=>U-ie),ae=L.length-T.cap;if(ae>0)for(let U=0;U<ae;U++)p[y+`history/${T.key}/${L[U]}`]=null;for(const[U,ie]of Object.entries(_[T.key]))Number(U)<L[Math.max(0,ae)]||(p[y+`history/${T.key}/${U}`]=q[U],g++)}const w=v.finalBase,I=Math.max(He,Te(v.finalPrice)),S=v.candles.reduce((T,N)=>T+(N.v||0),0);p[y+"previousPrice"]=m.price,p[y+"price"]=I,p[y+"currentPrice"]=I,p[y+"changeRate"]=+((I-w)/w*100).toFixed(2),p[y+"volume"]=(m.volume||0)+S,p[y+"value"]=(m.value||0)+S*I,I>(m.high||m.price)&&(p[y+"high"]=I),I<(m.low||m.price)&&(p[y+"low"]=I),m.heat&&(p[y+"heat"]=0),m.pressure&&(p[y+"pressure"]=0)}return p["market/tickMs"]=4e3,p["market/lastTickAt"]=i,p["market/lastHistoryAt"]=i,p["market/lastCatchupAt"]=i,p["market/catchupVersion"]=Ov,p["market/catchupBy"]=t||"anon",p["market/catchupLock"]=null,p.marketTick=i,await We(O(A,`rooms/${n}`),p),{applied:!0,elapsed:o,numSteps:h,candlesWritten:g,stocks:l.length}}catch(c){return await Fv(n),console.error("[catchup] 실패:",c),{applied:!1,reason:"error",error:c==null?void 0:c.message}}}function ku(){return{cur:{},lastBucket:0,seeded:!1}}async function Wv(n,e,t){const s=e.stocks||{},i=Date.now(),r=Ir(i,6e4);t.lastBucket||(t.lastBucket=r);for(const[d,u]of Object.entries(s)){if(!u||typeof u.price!="number")continue;let h=t.cur[d];(!h||h.t!==r)&&(h={t:r,o:u.price,h:u.price,l:u.price,c:u.price,v:0,_lastVol:u.volume||0},t.cur[d]=h),h.c=u.price,h.h=Math.max(h.h,u.price),h.l=Math.min(h.l,u.price);const p=Math.max(0,(u.volume||0)-(h._lastVol||0));h.v+=p,h._lastVol=u.volume||0}if(r===t.lastBucket)return;const o=t.lastBucket;let a=s;try{const d=await Mt(O(A,`rooms/${n}/stocks`));d.exists()&&(a=d.val())}catch{}const c={};let l=!1;for(const d of Object.keys(s)){const u=t.cur[d];if(!u)continue;const h={o:u.o,h:u.h,l:u.l,c:u.c,v:u.v},p=`stocks/${d}/`,g=a[d]&&a[d].history||{};for(const E of zs){const m=Ir(o,E.win),v=g[E.key]&&g[E.key][m]||null,_=v?{t:m,o:v.o,h:Math.max(v.h,h.h),l:Math.min(v.l,h.l),c:h.c,v:(v.v||0)+h.v}:{t:m,o:h.o,h:h.h,l:h.l,c:h.c,v:h.v};c[p+`history/${E.key}/${m}`]=_;const y=g[E.key]?Object.keys(g[E.key]).map(Number).sort((C,w)=>C-w):[];y.length>E.cap&&y[0]!==m&&(c[p+`history/${E.key}/${y[0]}`]=null)}l=!0}if(t.lastBucket=r,!!l){c["market/lastTickAt"]=i,c["market/lastHistoryAt"]=i,c["market/tickMs"]=4e3;try{await We(O(A,`rooms/${n}`),c)}catch(d){console.warn("[history] 라이브 캔들 저장 실패:",d==null?void 0:d.message)}}}function Su(n,e){if(n&&String(n).startsWith("ipo"))return'<span class="tag tag-new">NEW</span>';const t=bi(e.type);return t?`<span class="tag ${e.type==="inverse"?"tag-inv":e.type==="leverage"?"tag-lev":"tag-etf"}">${t}</span>`:e.role==="leader"?'<span class="tag tag-leader">대장주</span>':e.role==="sub"?'<span class="tag tag-sub">부대장</span>':""}function k(n){return document.getElementById(n)}function Gt(n){return Math.round(n??0).toLocaleString("ko-KR")+"원"}function M(n){return Math.round(n??0).toLocaleString("ko-KR")}function St(n){return n=n||0,n>=1e12?(n/1e12).toFixed(2)+"조":n>=1e8?(n/1e8).toFixed(1)+"억":n>=1e4?Math.round(n/1e4).toLocaleString("ko-KR")+"만":M(n)}function Hv(n){return M(n)+"주"}const jv=["screen-login","screen-auth","screen-home","screen-lobby","screen-game","screen-result"];function gt(n){jv.forEach(e=>k(e).classList.toggle("hidden",e!==n))}function V(n,e,t=!0){const s=k(n);s&&(s.textContent=e||"",s.classList.toggle("error",t))}function Tu(n){k("fbError").classList.remove("hidden"),n&&(k("fbErrorMsg").textContent=n)}const Vv=3,Gv=120,Ya=60;let Pe={},Rn=[],Ve={},Ft=0,Hn=null,Cr={};function Ru(){Pe={},Rn=[],Ve={},Ft=0,Hn=null,Cr={},Xs="";for(const n in Js)delete Js[n]}function qv(){if(Hn)try{localStorage.setItem(Hn,JSON.stringify({candles:Pe,lastVol:Ve,tick:Ft}))}catch{}}function Kv(n,e){const t=n.stocks||{},s=n.marketTick||0,i=`mb_candles_${e||"x"}_${n.startedAt||0}`;if(i!==Hn){Hn=i,Pe={},Ve={},Ft=0;try{const r=JSON.parse(localStorage.getItem(i)||"null");r&&r.candles&&(Pe=r.candles,Ve=r.lastVol||{},Ft=r.tick||0)}catch{}}for(const[r,o]of Object.entries(t))Pe[r]||(Pe[r]=[{t:Date.now(),o:o.price,h:o.price,l:o.price,c:o.price,v:0,_n:0}]),Ve[r]==null&&(Ve[r]=o.volume||0);if(s!==Ft){Ft=s;for(const[o,a]of Object.entries(t)){const c=Pe[o]||(Pe[o]=[]);let l=c[c.length-1];(!l||l._n>=Vv)&&(l={t:Date.now(),o:a.price,h:a.price,l:a.price,c:a.price,v:0,_n:0},c.push(l)),l.c=a.price,l.h=Math.max(l.h,a.price),l.l=Math.min(l.l,a.price);const d=Math.max(0,(a.volume||0)-(Ve[o]||0));l.v+=d,Ve[o]=a.volume||0,l._n++,c.length>Gv&&c.shift()}const r=n.botFeed?Object.values(n.botFeed):[];for(const o of r)Rn.unshift({...o,bot:!0});Rn.length>Ya&&(Rn.length=Ya),Jv(t),Sy(t),qv()}}let Ut=new Set(JSON.parse(localStorage.getItem("mb_watch")||"[]")),_t=JSON.parse(localStorage.getItem("mb_alerts")||"{}");function zv(n){Ut.has(n)?Ut.delete(n):Ut.add(n),localStorage.setItem("mb_watch",JSON.stringify([...Ut]))}function Yv(n,e){e>0?_t[n]=e:delete _t[n],localStorage.setItem("mb_alerts",JSON.stringify(_t))}function Qv(n){return _t[n]||0}function Jv(n){for(const e of Object.values(n)){const t=_t[e.name],s=Cr[e.name];if(t&&s!=null){const i=s<t&&e.price>=t,r=s>t&&e.price<=t;if(i||r){F(`🔔 ${e.name} 알림가 ${M(t)}원 ${i?"돌파":"하향"}!`,i?"up":"down"),delete _t[e.name],localStorage.setItem("mb_alerts",JSON.stringify(_t));try{window.Notification&&Notification.permission==="granted"&&new Notification("STONK Battle",{body:`${e.name} ${M(t)}원 도달`})}catch{}}}Cr[e.name]=e.price}}function Xv(n,e,t){k("lobbyRoomCode").textContent=n;const s=e.players||{},i=k("lobbyPlayers");i.innerHTML="",Object.entries(s).forEach(([a,c])=>{const l=document.createElement("li"),d=a===e.hostId,u=c.connected===!1;l.textContent=`${c.nickname}${d?" (방장)":""}${a===t?" - 나":""}${u?" [오프라인]":""}`,u&&l.classList.add("muted"),i.appendChild(l)});const r=t===e.hostId,o=Object.keys(s).length;k("btnStartGame").classList.toggle("hidden",!r),k("lobbyWait").classList.toggle("hidden",r),k("btnStartGame").disabled=o<1,V("lobbyMsg",o<2?"혼자서도 테스트 시작이 가능합니다. (정식 대전은 친구를 초대하세요)":`${o}명 입장 완료`,!1)}function Zv(n){const{roomCode:e,roomData:t,uid:s,selectedStockId:i}=n,r=k("gameRoomCode");r&&(r.textContent=e),Kv(t,e),ey(t,s),vy(t,s),yy(t,s),Ey(t),ny(t,s),Au(n),wy(t);const o=oy();o==="home"?(Ry(t),ly(t)):o==="detail"?(uy(t,i),_y(t,i),ty(t,s)):o==="feed"?Ny(t):o==="screener"?Py(t):o==="account"&&Oy(t,s)}function ey(n,e){var o;const t=(o=n.players)==null?void 0:o[e],s=t&&t.nickname||"나",i=k("navNick");i&&(i.textContent=s);const r=k("navAvatar");r&&(r.textContent=(s||"U").slice(0,1).toUpperCase())}function Au(n){const e=n.roomData,t=k("marketStatusChip"),s=k("msDot"),i=k("msLabel"),r=k("marketStatusPanel");if(!e||!t||!s||!i||!r)return;const o=e.market||{},a=o.lastTickAt||e.marketTick||0,c=o.lastCatchupAt||0,l=a?Math.max(0,Math.round((Date.now()-a)/6e4)):null,d=e.hostId===n.uid;let u=0,h=0,p=0,g=0;for(const y of Object.values(e.stocks||{})){const C=y.history;C&&(C.candles1m&&(u+=Object.keys(C.candles1m).length),C.candles5m&&(h+=Object.keys(C.candles5m).length),C.candles15m&&(p+=Object.keys(C.candles15m).length),C.candles1h&&(g+=Object.keys(C.candles1h).length))}const E=u+h+p+g>0,m=l!=null&&l<2;if(s.className="status-dot "+(m?"ok":l==null?"muted":"warn"),i.textContent=m?"시장 최신":l==null?"대기":`${l}분 전`,r.classList.contains("hidden"))return;const v=y=>y?`${vt(new Date(y).getHours())}:${vt(new Date(y).getMinutes())}`:"-",_=(y,C,w)=>`<div class="ms-row"><span>${y}</span><b class="${w||""}">${C}</b></div>`;r.innerHTML=_("방 코드",W(n.roomCode||"-"))+_("연결","연결됨","up")+_("권한",d?"보정 주체 (방장)":"읽기 전용",d?"":"muted")+_("마지막 tick",v(a))+_("마지막 보정",c?v(c):"없음")+_("시장",m?"최신 상태":l==null?"tick 기록 없음":`${l}분 전 데이터 · ${d?"재접속 시 자동 보정":"방장/관리자가 보정"}`,m?"up":"down")+_("캔들",E?`1m ${u} · 5m ${h} · 15m ${p} · 1h ${g}`:"아직 없음")}function ty(n,e){const t=k("orderList");if(!t)return;const s=Tv(n,e);if(!s.length){t.innerHTML="";return}t.innerHTML=s.map(i=>{const r=i.side==="buy"?"up":"down",o=i.tif==="day"?" · 당일":i.tif==="ioc"?" · IOC":"",a=i.label||(i.side==="buy"?"매수":"매도");return`<li class="order-item">
  ...
  </li>`}function ly(n){const e=k("stockList");if(!e)return;const t=e.scrollTop,s=n.stocks||{};let i=Object.entries(s).filter(([r,o])=>ay(r,o));if(Pu==="watch"&&(i=i.filter(([,r])=>Ut.has(r.name))),i=Lu(i,Ou),!i.length){e.innerHTML=`<li class="stock-empty">${Qs?"검색 결과 없음":"종목이 없습니다"}</li>`;return}e.innerHTML=i.map(([r,o],a)=>Du(a+1,r,o)).join(""),e.scrollTop=t}function uy(n,e){const s=(n.stocks||{})[e];if(!s){k("chartStockName").textContent="-",k("selStockPrice").textContent="-",k("selStockChange").textContent="";return}const i=s.basePrice||s.price,r=s.price-i,o=Lt(s.changeRate),a=s.changeRate>0?"+":"";k("chartStockName").textContent=s.name;const c=k("detailTag");if(c){const h=bi(s.type),p=wu(s.role);let g,E="virtual-tag";h?(g=h,E+=s.type==="inverse"?" tag-inv":s.type==="leverage"?" tag-lev":" tag-etf"):String(e).startsWith("ipo")?(g="신규상장",E+=" tag-new"):s.sector?(g=p?`${s.sector}·${p}`:s.sector,s.role==="leader"&&(E+=" tag-leader")):g="가상",c.textContent=g,c.className=E}const l=k("selStockPrice"),d=Js[e];if(l.textContent=M(s.price),l.className="big-price "+o,d!=null&&s.price!==d){const h=s.price>d?"flash-up":"flash-down";l.classList.remove("flash-up","flash-down"),l.offsetWidth,l.classList.add(h)}Js[e]=s.price,k("selStockChange").className="change "+o,k("selStockChange").textContent=`${Si(s.changeRate)} ${a}${M(r)} (${a}${(s.changeRate??0).toFixed(2)}%)`,qi("ohlcOpen",s.open,i),qi("ohlcHigh",s.high,i),qi("ohlcLow",s.low,i),k("ohlcUpper").textContent=M(Ii(i)),k("ohlcLower").textContent=M(Ci(i)),k("ohlcVol").textContent=Hv(s.volume),k("ohlcValue").textContent=St(s.value)+"원";const u=k("selStockNews");u.textContent=s.news?`📰 ${s.news}`:"",u.className="news-line"+(s.news?" "+o:" muted"),$u(n,e,i,s)}const Js={};function qi(n,e,t){const s=k(n);s.textContent=M(e),s.className="ohlc-v "+Lt((e||0)-t)}function mt(n){return getComputedStyle(document.body).getPropertyValue(n).trim()||"#000"}const Sr={tick:{win:30*6e4,tiers:["candles1m","candles5m"],count:16},"1d":{win:864e5,tiers:["candles5m","candles1m"],count:288},"3d":{win:2592e5,tiers:["candles1h","candles15m","candles5m"],count:216},"1w":{win:6048e5,tiers:["candles1h","candles15m"],count:224},"1m":{win:2592e6,tiers:["candles1h","candles15m","candles5m","candles1m"],count:360},all:{win:1/0,tiers:["candles1h","candles15m","candles5m","candles1m"],count:500}},dy={tick:"1틱","1d":"1일","3d":"3일","1w":"1주","1m":"1달",all:"전체"};function Ja(n){if(n<=0)return"0분";const e=Math.round(n/6e4);if(e<60)return e+"분";const t=Math.floor(e/60),s=e%60;if(t<24)return s?`${t}시간 ${s}분`:`${t}시간`;const i=Math.floor(t/24),r=t%24;return r?`${i}일 ${r}시간`:`${i}일`}function hy(n,e){const t=dy[n]||n;if(!e||!e.length)return t+" · 데이터 없음";if(n==="tick")return"1틱 · 최근 흐름";const s=e[0].t,i=e[e.length-1].t;if(!(s>1e11)||!(i>1e11))return t+" · 최근 흐름";const r=i-s,o=(Sr[n]||{}).win;return o&&o!==1/0&&r<o*.9?`${t} · 아직 ${Ja(r)} 데이터만 있음`:`${t} · 누적 ${Ja(r)} 데이터`}function vt(n){return(n<10?"0":"")+n}function fy(n,e){if(!(n>1e11))return"";const t=new Date(n),s=vt(t.getHours())+":"+vt(t.getMinutes()),i=t.getMonth()+1+"/"+t.getDate();return e==="tick"||e==="1d"?s:e==="3d"||e==="1w"?i+" "+s:i}function py(n){if(!(n>1e11))return"";const e=new Date(n);return e.getMonth()+1+"/"+vt(e.getDate())+" "+vt(e.getHours())+":"+vt(e.getMinutes())}let An="1d",vs=-1,oe=null,ft=null,Xa=!1,Xs="";function Za(n,e){if(n.length&&e.price!=null&&n[n.length-1].c!==e.price){const t=n[n.length-1],s=t.t>1e11?t.t+1e3:t.t+1;n.push({t:s,o:t.c,h:Math.max(t.c,e.price),l:Math.min(t.c,e.price),c:e.price,v:0,_live:!0})}return n}function xu(n,e,t){const s=Sr[t]||Sr["1d"],i=n.history||null,r=Pe[e]||[],o=Date.now(),a=s.win===1/0?-1/0:o-s.win;if(t==="tick"){let l=r.slice(-12).map((d,u)=>({t:d.t||o-(12-u)*6e3,o:d.o,h:d.h,l:d.l,c:d.c,v:d.v||0}));if(l.length<2&&i){const d=za(i,"candles1m");d.length&&(l=d.slice(-s.count).map(u=>({...u})))}return Za(l,n)}let c=[];if(i)for(const l of s.tiers){let d=za(i,l);if(d.length){if(d=d.filter(u=>u.t>=a),d.length>=2){c=d.map(u=>({...u}));break}!c.length&&d.length&&(c=d.map(u=>({...u})))}}return!c.length&&r.length&&(c=r.map((l,d)=>({t:l.t||o-(r.length-d)*6e3,o:l.o,h:l.h,l:l.l,c:l.c,v:l.v||0})).filter(l=>l.t>=a)),c=Za(c,n),c.length>s.count&&(c=c.slice(c.length-s.count)),c}function $u(n,e,t,s){ft={room:n,id:e,base:t};const i=xu(s,e,An),r=i.length?i[i.length-1]:null,o=`${e}|${An}|${i.length}|${r?r.c+":"+r.v:""}|${t}`;if(o===Xs){ec();return}Xs=o,vs=-1,Fu(),Tr(k("priceChart"),i,t,-1);const a=k("chartRangeNote");a&&(a.textContent=hy(An,i)),ec()}function ec(){if(Xa)return;Xa=!0;const n=k("chartPeriods");n&&n.addEventListener("click",t=>{var i;const s=t.target.closest(".cp-btn");if(s&&(An=s.dataset.period,n.querySelectorAll(".cp-btn").forEach(r=>r.classList.toggle("is-active",r===s)),ft)){const r=(i=ft.room.stocks)==null?void 0:i[ft.id];r&&$u(ft.room,ft.id,ft.base,r)}});const e=k("priceChart");if(e){const t=i=>{if(!oe)return;const r=e.getBoundingClientRect(),o=(i.touches?i.touches[0].clientX:i.clientX)-r.left,a=Math.max(0,Math.min(oe.candles.length-1,Math.floor(o/oe.cw)));a!==vs&&(vs=a,Tr(e,oe.candles,oe.base,a),my(a))},s=()=>{vs=-1,oe&&Tr(e,oe.candles,oe.base,-1),Fu()};e.addEventListener("mousemove",t),e.addEventListener("mouseleave",s),e.addEventListener("touchstart",t,{passive:!0}),e.addEventListener("touchmove",t,{passive:!0}),e.addEventListener("touchend",s)}}function my(n){const e=k("chartTip");if(!e||!oe)return;const t=oe.candles[n];if(!t)return;const s=t.o?(t.c-t.o)/t.o*100:0,i=s>0?"up":s<0?"down":"flat",r=py(t.t)||`구간 ${n+1}`;e.innerHTML=`
    ...
    <div class="tip-row"><span>등락률</span><b class="${i}">${s>=0?"+":""}${s.toFixed(2)}%</b></div>`,e.classList.remove("hidden");const o=n*oe.cw+oe.cw/2,a=o>oe.plotW*.6?"left":"right";e.style.left=a==="right"?`${o+10}px`:"",e.style.right=a==="left"?`${oe.cssW-o+10}px`:"",e.style.top="8px"}function Fu(){const n=k("chartTip");n&&n.classList.add("hidden")}function Tr(n,e,t,s){if(!n)return;const i=window.devicePixelRatio||1,r=n.clientWidth||600,o=n.clientHeight||260;n.width=Math.round(r*i),n.height=Math.round(o*i);const a=n.getContext("2d");if(a.setTransform(i,0,0,i,0,0),a.clearRect(0,0,r,o),!e.length){oe=null;return}const c=56,l=r-c,d=o*.18,u=o*.06,h=o-d-u;let p=-1/0,g=1/0,E=0;for(const L of e)p=Math.max(p,L.h),g=Math.min(g,L.l),E=Math.max(E,L.v||0);p===g&&(p+=1,g-=1);const m=(p-g)*.14;p+=m,g-=m;const v=mt("--up"),_=mt("--down"),y="rgba(255,255,255,0.07)",C=mt("--muted"),w=L=>h*(1-(L-g)/(p-g)),I=Math.max(e.length,14),S=l/I,T=Math.max(2.5,Math.min(14,S*.64));oe={cw:S,plotW:l,priceH:h,volH:d,cssW:r,cssH:o,candles:e,base:t,lo:g,hi:p},a.font="11px Pretendard, sans-serif",a.textBaseline="middle";const N=4;for(let L=0;L<=N;L++){const ae=h/N*L,U=p-(p-g)/N*L;a.strokeStyle=y,a.lineWidth=1,a.beginPath(),a.moveTo(0,Math.round(ae)+.5),a.lineTo(l,Math.round(ae)+.5),a.stroke(),a.fillStyle=C,a.textAlign="left",a.fillText(M(U),l+6,Math.min(h-6,Math.max(8,ae)))}if(s>=0&&s<e.length){const L=s*S+S/2;a.strokeStyle="rgba(120,140,180,0.55)",a.lineWidth=1,a.setLineDash([3,3]),a.beginPath(),a.moveTo(Math.round(L)+.5,0),a.lineTo(Math.round(L)+.5,o),a.stroke(),a.setLineDash([])}e.forEach((L,ae)=>{const U=ae*S+S/2,pe=L.c>=L.o?v:_;a.strokeStyle=pe,a.fillStyle=pe,a.lineWidth=1,a.beginPath(),a.moveTo(Math.round(U)+.5,w(L.h)),a.lineTo(Math.round(U)+.5,w(L.l)),a.stroke();const hn=w(L.o),fn=w(L.c),Ri=Math.min(hn,fn),rs=Math.max(1.5,Math.abs(fn-hn));if(a.fillRect(U-T/2,Ri,T,rs),E>0){const Oo=(d-4)*((L.v||0)/E);a.globalAlpha=.4,a.fillRect(U-T/2,o-Oo,T,Oo),a.globalAlpha=1}});const q=e[e.length-1].c;if(q<=p&&q>=g){const L=w(q),U=q>=(t||q)?v:_;a.strokeStyle=U,a.lineWidth=1,a.setLineDash([4,3]),a.beginPath(),a.moveTo(0,Math.round(L)+.5),a.lineTo(l,Math.round(L)+.5),a.stroke(),a.setLineDash([]);const ie=M(q);a.font="bold 11px Pretendard, sans-serif";const pe=a.measureText(ie).width,hn=Math.min(h-9,Math.max(9,L));a.fillStyle=U,a.beginPath();const fn=l+2,Ri=Math.min(c-4,pe+10),rs=17;gy(a,fn,hn-rs/2,Ri,rs,4),a.fill(),a.fillStyle="#fff",a.textAlign="left",a.fillText(ie,fn+5,hn)}if(e.length>=2){a.font="10px Pretendard, sans-serif",a.fillStyle=C;const L=[0,Math.floor((e.length-1)/2),e.length-1],ae={};L.forEach(U=>{if(ae[U])return;ae[U]=1;const ie=fy(e[U].t,An);if(!ie)return;a.textAlign=U===0?"left":U===e.length-1?"right":"center";const pe=U===0?2:U===e.length-1?l-2:U*S+S/2;a.fillText(ie,pe,o-2)})}}function gy(n,e,t,s,i,r){n.beginPath(),n.moveTo(e+r,t),n.arcTo(e+s,t,e+s,t+i,r),n.arcTo(e+s,t+i,e,t+i,r),n.arcTo(e,t+i,e,t,r),n.arcTo(e,t,e+s,t,r),n.closePath()}function So(){Xs="";const n=k("priceChart");if(n){const e=n.getContext("2d");e&&e.clearRect(0,0,n.width,n.height)}}function _y(n,e){var l;const t=k("orderbook");if(!t)return;const s=(l=n.stocks)==null?void 0:l[e];if(!s){t.innerHTML="";return}const i=Eu(s.price),r=s.basePrice||s.price,o=5e4,a=()=>Math.floor((Math.random()*.9+.1)*12e3),c=[];for(let d=5;d>=1;d--){const u=tc(s.price+d*i,r);c.push(nc(u,a(),"ask",o,r))}c.push(`<div class="ob-current ${Lt(s.changeRate)}">${M(s.price)}</div>`);for(let d=1;d<=5;d++){const u=tc(s.price-d*i,r);c.push(nc(u,a(),"bid",o,r))}t.innerHTML=c.join("")}function tc(n,e){return Math.max(Ci(e),Math.min(Ii(e),Math.max(He,n)))}function nc(n,e,t,s,i){const r=Lt(n-i),o=Math.min(100,e/s*100);return t==="ask"?`<div class="ob-row ask">
  ...
  </div>`}function vy(n,e){var p;const t=(p=n.players)==null?void 0:p[e],s=n.stocks||{};if(!t)return;const i=ki(t,s);k("myCash").textContent=Gt(t.cash),k("myAsset").textContent=Gt(i);const r=k("myAssetTop");r&&(r.textContent=St(i)+"원");const o=t.avgCost||{},a=t.holdings||{},c=Object.entries(a).filter(([,g])=>g>0);let l=0,d=0;c.forEach(([g,E])=>{const m=s[g];if(!m)return;const v=(o[g]||m.price)*E;l+=m.price*E-v,d+=v});const u=k("myPnl");if(u)if(c.length){const g=d?l/d*100:0,E=l>0?"up":l<0?"down":"flat";u.className="asset-pnl "+E,u.textContent=`평가손익 ${l>=0?"+":""}${M(l)}원 (${g>=0?"+":""}${g.toFixed(2)}%)`}else u.className="asset-pnl muted",u.textContent="평가손익 —";const h=k("holdingsList");if(h.innerHTML="",c.length===0){const g=document.createElement("li");g.className="muted",g.textContent="보유 종목이 없습니다",h.appendChild(g);return}for(const[g,E]of c){const m=s[g];if(!m)continue;const v=o[g]||0,_=v?(m.price-v)*E:0,y=v?(m.price-v)/v*100:0,C=_>0?"up":_<0?"down":"flat",w=document.createElement("li");w.className="holding-item",w.innerHTML=`
      <div class="hold-row1"><span class="hold-name">${W(m.name)}</span><b>${M(E)}주</b></div>
      <div class="hold-row2 muted">평단 ${v?M(v):"-"} · 평가 ${St(m.price*E)}원</div>
      <div class="hold-row2 ${C}">${_>=0?"+":""}${M(_)}원 (${y>=0?"+":""}${y.toFixed(2)}%)</div>`,h.appendChild(w)}}let sc=null;function F(n,e=""){const t=k("toast");t&&(t.textContent=n,t.className="toast show"+(e?" toast-"+e:""),clearTimeout(sc),sc=setTimeout(()=>{t.className="toast"+(e?" toast-"+e:"")},1800))}function yy(n,e){const t=k("rankingList");t.innerHTML="",ko(n.players,n.stocks).forEach(i=>{const r=document.createElement("li"),o=((i.total-be)/be*100).toFixed(2),a=i.total>=be?"up":"down";r.innerHTML=`<span>${W(i.nickname)}${i.uid===e?" (나)":""}</span> <b>${St(i.total)}원</b> <span class="${a}">${o>=0?"+":""}${o}%</span>`,i.connected||r.classList.add("muted"),t.appendChild(r)})}function wy(n){const e=k("logList");e.innerHTML="";const s=[...Object.values(n.logs||{}),...Rn].sort((i,r)=>r.time-i.time).slice(0,40);for(const i of s){const r=document.createElement("li"),o=i.type==="buy"?"매수":"매도",a=i.type==="buy"?"up":"down",c=new Date(i.time).toLocaleTimeString("ko-KR",{hour12:!1}),l=i.bot?`<b class="bot-name">${W(i.nickname)}</b>`:`<b>${W(i.nickname)}</b>`;r.innerHTML=`<span class="muted">${c}</span> ${l} <span class="${a}">${o}</span> ${W(i.stockName)} ${M(i.qty)}주 @ ${M(i.price)}`,e.appendChild(r)}}function Ey(n){const e=k("newsBar"),t=n.latestNews;if(!t||Date.now()-t.time>12e3){e.classList.add("hidden");return}e.classList.remove("hidden"),e.textContent=`📢 ${t.text}`}function by(n){const e=[k("tickBar"),k("tickBarHome")],t=[k("tickCountdown"),k("tickCountdownHome")],s=n&&(n.marketTick||n.market&&n.market.lastTickAt)||0;if(!s){e.forEach(l=>{l&&(l.style.width="0%")}),t.forEach(l=>{l&&(l.textContent="")});return}const i=Date.now()-s,o=(Math.max(0,Math.min(1,i/br))*100).toFixed(1)+"%";e.forEach(l=>{l&&(l.style.width=o)});const a=Math.max(0,Math.ceil((br-i)/1e3)),c=a>0?a+"s":"곧";t.forEach(l=>{l&&(l.textContent=c)})}function Iy(n){const e=Math.max(0,Math.floor(n/1e3)),t=String(Math.floor(e/60)).padStart(2,"0"),s=String(e%60).padStart(2,"0");k("gameTimer").textContent=`${t}:${s}`}function Cy(n,e){const t=k("resultList");t.innerHTML="",ko(n.players,n.stocks).forEach((i,r)=>{const o=document.createElement("li"),c=["🥇","🥈","🥉"][r]||`${r+1}.`,l=((i.total-be)/be*100).toFixed(2),d=i.total>=be?"up":"down";o.innerHTML=`<span class="rank-mark">${c}</span> <span>${W(i.nickname)}${i.uid===e?" (나)":""}</span> <b>${Gt(i.total)}</b> <span class="${d}">${l>=0?"+":""}${l}%</span>`,t.appendChild(o)})}function W(n){return String(n??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}let Zs={};const ky=60;function Uu(n){let e=0,t=0;const s={};for(const o of Object.values(n||{})){const a=(o.value||0)+1;e+=a,t+=a*(o.changeRate||0);const c=o.sector||"기타",l=s[c]||(s[c]={w:0,r:0});l.w+=a,l.r+=a*(o.changeRate||0)}const i=e?t/e:0,r=Object.entries(s).map(([o,a])=>({name:o,rate:a.w?a.r/a.w:0,w:a.w})).sort((o,a)=>a.w-o.w);return{comp:i,sectors:r}}function ic(n,e){const t=Zs[n]||(Zs[n]=[]);t.push(e),t.length>ky&&t.shift()}function Sy(n){const{comp:e,sectors:t}=Uu(n);ic("__comp__",1e3*(1+e/100)),t.forEach(s=>ic("sec:"+s.name,1e3*(1+s.rate/100)))}function Ty(n,e){if(!n||n.length<2)return"";const t=140,s=28,i=Math.min(...n),r=Math.max(...n),o=r-i||1,a=n.map((l,d)=>`${(d/(n.length-1)*t).toFixed(1)},${(s-(l-i)/o*s).toFixed(1)}`).join(" "),c=e>=0?"var(--up)":"var(--down)";return`<svg viewBox="0 0 ${t} ${s}" preserveAspectRatio="none"><polyline points="${a}" fill="none" stroke="${c}" stroke-width="1.6" stroke-linejoin="round"/></svg>`}function rc(n,e,t,s){const i=Lt(t),r=t>0?"+":"";return`<div class="index-card"><span class="ix-name">${W(n)}</span><span class="ix-val">${e.toFixed(2)}</span><span class="ix-rate ${i}">${Si(t)} ${r}${t.toFixed(2)}%</span><div class="ix-spark">${Ty(s,t)}</div></div>`}function Ry(n){const e=k("indexStrip");if(!e)return;const{comp:t,sectors:s}=Uu(n.stocks||{}),i=[rc("STONK 종합",1e3*(1+t/100),t,Zs.__comp__)];s.slice(0,6).forEach(r=>i.push(rc(r.name,1e3*(1+r.rate/100),r.rate,Zs["sec:"+r.name]))),e.innerHTML=i.join("")}function Ay(n){const e=new Date(n.when).toLocaleTimeString("ko-KR",{hour:"2-digit",minute:"2-digit"});return`<div class="feed-card"><div class="feed-card-head"><span class="feed-ava">${W((n.who||"S").slice(0,1))}</span><div><div class="feed-who">${W(n.who)}</div><div class="feed-when">${e}</div></div></div>${n.title?`<div class="feed-title">${W(n.title)}</div>`:""}<div class="feed-body">${W(n.body)}</div></div>`}function Ny(n,e){const t=k("feedView");if(!t)return;const s=[],i=n.latestNews;i&&(i.text||i.title)&&s.push({who:"STONK 뉴스",when:i.time||Date.now(),title:i.title||"📢 시장 속보",body:i.text||i.body||""}),Object.values(n.botFeed||{}).slice(-10).reverse().forEach(c=>s.push({who:c.nickname||"트레이더",when:c.time||Date.now(),title:"",body:`${c.type==="buy"?"매수":"매도"} · ${c.stockName||"종목"} ${M(c.qty||0)}주 @ ${M(c.price||0)}`}));const r=ko(n.players,n.stocks).slice(0,5),o=[...new Set(Object.values(n.stocks||{}).map(c=>c.sector).filter(Boolean))].slice(0,8),a=r.map((c,l)=>{const d=(c.total-be)/be*100;return`<li><span class="fr-no">${l+1}</span><span class="fr-name">${W(c.nickname)}</span><span class="fr-val ${d>=0?"up":"down"}">${d>=0?"+":""}${d.toFixed(1)}%</span></li>`}).join("");t.innerHTML=`
    ...
    </aside>`}const Ki=[{key:"rising",label:"연속 상승세",badge:"인기",fn:(n,e)=>(e.changeRate||0)>0,sort:"up"},{key:"value",label:"거래대금 상위",fn:()=>!0,sort:"value"},{key:"surge",label:"급등주",fn:(n,e)=>(e.changeRate||0)>=5,sort:"up"},{key:"plunge",label:"급락주",fn:(n,e)=>(e.changeRate||0)<=-5,sort:"down"},{key:"cheap",label:"저가주",fn:(n,e)=>(e.price||0)<2e3,sort:"value"},{key:"pricey",label:"고가주",fn:(n,e)=>(e.price||0)>=1e5,sort:"value"},{key:"lev",label:"레버리지·인버스",fn:(n,e)=>e.type==="leverage"||e.type==="inverse",sort:"value"},{key:"etf",label:"ETF·리츠",fn:(n,e)=>e.type==="etf"||e.type==="reit",sort:"value"},{key:"leader",label:"대장주",fn:(n,e)=>e.role==="leader",sort:"value"}];function Py(n){const e=k("screenerPresets"),t=k("screenerHead"),s=k("screenerList");if(!e||!s)return;e.innerHTML='<div class="sa-title">주식 골라보기 목록</div>'+Ki.map(o=>`<button data-preset="${o.key}" class="${o.key===kr?"is-active":""}">${W(o.label)}${o.badge?` <span class="sa-badge">${o.badge}</span>`:""}</button>`).join("");const i=Ki.find(o=>o.key===kr)||Ki[0];t&&(t.innerHTML=`<h2>${W(i.label)}</h2><p>조건에 맞는 종목을 모았습니다 · 모두 가상 데이터</p>`);let r=Object.entries(n.stocks||{}).filter(([o,a])=>i.fn(o,a));r=Lu(r,i.sort),s.innerHTML=r.length?r.map(([o,a],c)=>Du(c+1,o,a)).join(""):'<li class="stock-empty">조건에 맞는 종목이 없습니다</li>'}function Oy(n,e){var _,y;const t=k("accountView");if(!t)return;const s=(_=n.players)==null?void 0:_[e];if(!s){t.innerHTML='<div class="acct-main"><div class="acct-section muted">계좌 정보를 불러오는 중…</div></div>';return}const i=n.stocks||{},r=ki(s,i),o=s.avgCost||{},a=Object.entries(s.holdings||{}).filter(([,C])=>C>0);let c=0,l=0,d=0;a.forEach(([C,w])=>{const I=i[C];if(!I)return;const S=(o[C]||I.price)*w;c+=I.price*w,l+=I.price*w-S,d+=S});const u=d?l/d*100:0,h=l>0?"up":l<0?"down":"flat",p=((y=k("gameRoomCode"))==null?void 0:y.textContent)||"-",g=Object.values(n.logs||{}).filter(C=>C.uid===e).sort((C,w)=>w.time-C.time).slice(0,20),E=Object.values(n.orders||{}).filter(C=>C.uid===e),m=["asset","tx","orders"].map(C=>{const w={asset:"자산",tx:"거래내역",orders:"주문내역"}[C];return`<button data-acct="${C}" class="${C===_s?"is-active":""}">${w}</button>`}).join("");let v="";if(_s==="asset"){const C=a.length?a.map(([w,I])=>{const S=i[w];if(!S)return"";const T=o[w]||0,N=T?(S.price-T)*I:0,q=T?(S.price-T)/T*100:0,L=N>0?"up":N<0?"down":"flat";return`<div class="acct-row"><div><div class="ar-name">${W(S.name)}</div><div class="ar-sub">${M(I)}주 · 평단 ${T?M(T):"-"}</div></div><div class="ar-val ${L}">${M(S.price*I)}원<br><small>${N>=0?"+":""}${q.toFixed(2)}%</small></div></div>`}).join(""):'<div class="acct-row muted">보유 종목이 없습니다</div>';v=`
      <div class="acct-hero">
